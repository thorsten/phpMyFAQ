...
if ($faqConfig->get('main.enableRewriteRules')) {
    ...
    $tplNavigation = [
        ...
        'allCategories' => '<a class="pmf-nav-link" href="index.php?' . $sids . 'action=show">' .
            Translation::get('msgShowAllCategories') . '</a>',
        'msgAddContent' => '<a class="pmf-nav-link" href="index.php?' . $sids . 'action=add&cat=' . $cat . '">' .
            Translation::get('msgAddContent') . '</a>',
        'msgQuestion' => $faqConfig->get('main.enableAskQuestions')
            ?
            '<a class="pmf-nav-link" href="index.php?' . $sids . 'action=ask&category_id=' . $cat . '">' .
            Translation::get('msgQuestion') . '</a>'
            :
            '',
        'msgOpenQuestions' => $faqConfig->get('main.enableAskQuestions')
            ?
            '<a class="pmf-nav-link" href="index.php?' . $sids . 'action=open-questions">' .
            Translation::get('msgOpenQuestions') . '</a>'
            :
            '',
        'msgSearch' => '<a class="pmf-nav-link" href="index.php?' . $sids . 'action=search">' .
            Translation::get('msgAdvancedSearch') . '</a>',
        'msgContact' => '<a class="pmf-nav-link-footer" href="index.php?' . $sids . 'action=contact">' .
            Translation::get('msgContact') . '</a>',
        'msgGlossary' => '<a class="pmf-nav-link-footer" href="index.php?' . $sids . 'action=glossary">' .
            Translation::get('ad_menu_glossary') . '</a>',
        'privacyLink' => sprintf(
            '<a class="pmf-nav-link-footer" target="_blank" href="%s">%s</a>',
            Strings::htmlentities($faqConfig->get('main.privacyURL')),
        ...
        'faqOverview' => '<a class="pmf-nav-link-footer" href="index.php?' . $sids . 'action=overview">' .
            Translation::get('faqOverview') . '</a>',
        'showSitemap' => '<a class="pmf-nav-link-footer" href="index.php?' . $sids . 'action=sitemap&amp;lang=' .
            $faqLangCode . '">' .
            Translation::get('msgSitemap') . '</a>',
