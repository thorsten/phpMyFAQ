...
$PMF_LANG['msgVoteUsability'] = 'Oceń ten wpis:';
...
$PMF_LANG['ad_news_link_url'] = 'Łącze: (<strong>bez https://</strong>)!';
...
$PMF_LANG['permission::edit_user'] = 'edytuj użytkownika';
$PMF_LANG['permission::delete_user'] = 'usuń użytkownika';
$PMF_LANG['permission::add_faq'] = 'dodaj wpis';
$PMF_LANG['permission::edit_faq'] = 'edytuj wpis';
$PMF_LANG['permission::delete_faq'] = 'usuń wpis';
$PMF_LANG['permission::viewlog'] = 'pokaż dziennik';
$PMF_LANG['permission::adminlog'] = 'pokaż dziennik admina';
$PMF_LANG['permission::delcomment'] = 'usuń komentarz';
$PMF_LANG['permission::addnews'] = 'dodaj newsa';
$PMF_LANG['permission::editnews'] = 'edytuj newsa';
$PMF_LANG['permission::delnews'] = 'usuń newsa';
$PMF_LANG['permission::addcateg'] = 'dodaj kategorię';
$PMF_LANG['permission::editcateg'] = 'edytuj kategorię';
$PMF_LANG['permission::delcateg'] = 'usuń kategorię';
$PMF_LANG['permission::passwd'] = 'zmień hasło';
...
$PMF_LANG['permission::backup'] = 'utwórz kopię bezpieczeństwa';
$PMF_LANG['permission::restore'] = 'odtwórz z kopii';
$PMF_LANG['permission::delquestion'] = 'usuń pytania otwarte';
...
$LANG_CONF['main.language'] = array("select", "Plik językowy");
$LANG_CONF['main.languageDetection'] = array("checkbox", "Włącz automatyczną negocjację treści");
$LANG_CONF['main.titleFAQ'] = array("input", "Tytuł FAQ");
$LANG_CONF['main.currentVersion'] = array("print", "Wersja FAQ");
$LANG_CONF['main.metaDescription'] = array("input", "Opis strony");
$LANG_CONF['main.metaKeywords'] = array("input", "Słowa kluczowe dla wyszukiwarek");
$LANG_CONF['main.metaPublisher'] = array("input", "Imię autora");
$LANG_CONF['main.administrationMail'] = array("input", "Adres e-mail administraotra");
$LANG_CONF['main.contactInformation'] = array("area", "Informacje kontaktowe");
$LANG_CONF['main.send2friendText'] = array("area", "Tekst na stronie \"Wyślij do znajomego\"");
$LANG_CONF['records.maxAttachmentSize'] = array("input", "maksymalny rozmiar załącznika w bajtach (maks. %sbajtów)");
$LANG_CONF['records.disableAttachments'] = array("checkbox", "Linkować załaczniki pod wpisami?");
$LANG_CONF['main.enableUserTracking'] = array("checkbox", "Używać statystyk?");
$LANG_CONF['main.enableAdminLog'] = array("checkbox", "Używać logowania działań administratora?");
$LANG_CONF['security.ipCheck'] = array("checkbox", "Sprawdzać IP podczas kontroli UIN-ów w admin.php?");
...
$LANG_CONF['security.permLevel'] = array("select", "Poziom uprawnień");
$LANG_CONF['main.referenceURL'] = array("input", "URL bazowy dla weryfikacji linku (e.g.: https://www.example.org/faq/)");
$LANG_CONF['main.urlValidateInterval'] = array("input", "Interwał weryfikacji linku dla AJAX-a (w sekundach)");
$LANG_CONF['records.defaultActivation'] = array("checkbox", "Aktywuj nowe rekordy (domyślnie nieaktywne)");
$LANG_CONF['records.defaultAllowComments'] = array("checkbox", "Zezwól na komentarze do nowych rekordów (domyślnie zabronione)");
$LANG_CONF['records.enableVisibilityQuestions'] = array("checkbox", "Czy wyłączyć widoczność nowych pytań?");
$LANG_CONF['records.numberOfRelatedArticles'] = array("input", "Ilość wpisów powiązanych");
$LANG_CONF['records.orderby'] = array("select", "Sortowanie rekordów (stosownie do własności)");
$LANG_CONF['records.sortby'] = array("select", "Kierunek sortowania rekordów (malejąco lub rosnąco)");
$LANG_CONF['spam.checkBannedWords'] = array("checkbox", "Sprawdzaj formularze publiczne na występowanie słów zabronionych (domyślnie włączone).");
$LANG_CONF['spam.enableCaptchaCode'] = array("checkbox", "Używaj captcha do zatwierdzania publicznych formularzy (domyślnie włączone).");
$LANG_CONF['spam.enableSafeEmail'] = array("checkbox", "Wyświetlaj adres e-mail użytkownika w sposób bezpieczny (domyślnie włączone).");
$PMF_LANG['permission::addglossary'] = 'dodaj do glosariusza';
$PMF_LANG['permission::editglossary'] = 'edytuj w glosariuszu';
$PMF_LANG['permission::delglossary'] = 'usuń z glosariusza';
$PMF_LANG['permission::addgroup'] = 'dodaj grupę kont';
$PMF_LANG['permission::editgroup'] = 'edytuj grupę kont';
$PMF_LANG['permission::delgroup'] = 'usuń grupę kont';
...
$PMF_LANG['permission::approverec'] = 'zatwierdź rekordy';
$PMF_LANG['ad_menu_upgrade'] = 'phpMyFAQ Ulepsz';
...
$LANG_CONF['main.templateSet'] = array("select", "Zestaw szablonów do wykorzystania");
$LANG_CONF['records.enableAttachmentEncryption'] = array("checkbox", "Włącz szyfrowanie <br><small>Ignorowane jest wyłączone</small>");
$LANG_CONF['records.defaultAttachmentEncKey'] = array("input", 'Domyślny klucz szyfrowania załączników<br><small>Ignored if attachment encryption is disabled</small><br><small><font color="red"> OSTRZEŻENIE: Nie należy zmieniać to raz ustawić na włączone szyfrowanie plików!</font></small>');
$LANG_CONF['security.useSslForLogins'] = array('checkbox', "Pozwalaj tylko na bezpieczne połączenie logowania? (Domyślnie: wyłączone)");
