...
$PMF_LANG['msgVoteUsability'] = 'Vurder venligst dette indlæg';
...
$PMF_LANG['msgShareFAQ'] = 'Send til en ven';
...
$PMF_LANG['msgAskThx4Mail'] = 'Tak for din e-mail!';
...
$PMF_LANG['msgHelpText'] = 'Strukturen af denne FAQ (Frequently Asked Questions) er rimelig simpel. Du kan enten navigere i <a href="?action=show">kategorierne</a> eller lade <a href="?action=search">FAQ maskinen</a> søge efter nøgleord.';
...
$PMF_LANG['err_SaveEntries'] = 'Nødvendige felter: dit navn, din e-mail-adresse, kategori, overskrift og dit indlæg!  <a href="javascript:history.back();">Gå tilbage</a>  ';
$PMF_LANG['err_SaveComment'] = 'Nødvendige felter: dit navn, din e-mail-adresse og dine kommentarer!  <a href="javascript:history.back();">En side tilbage</a>  ';
$PMF_LANG['err_VoteTooMuch'] = 'Vi tæller ikke dobbelt stemmer. Klik her, for at gå tilbage.';
$PMF_LANG['err_noVote'] = 'Du vurderede ikke spørgsmålet! <a href="javascript:history.back();">Klik venligst her</a>, for at stemme.';
$PMF_LANG['err_noMailAdress'] = 'din e-mail-adresse er ikke korrekt. <a href="javascript:history.back();">tilbage</a>';
$PMF_LANG['err_sendMail'] = 'Nødvendige felter: dit navn, din e-mail-adresse og dit spørgsmål!  <a href="javascript:history.back();">En side tilbage</a>  ';
$PMF_LANG['help_search'] = 'Fundne indlæg: ';
...
$PMF_LANG['ad_msg_mysqlerr'] = 'grundet database fejl, kunne profilen ikke gemmes.';
...
$PMF_LANG['ad_entry_savedsuc'] = 'ændringerne blev gemt.';
$PMF_LANG['ad_entry_savedfail'] = 'Desværre opstod en database fejl.';
...
$PMF_LANG['ad_news_link_url'] = 'Link: (uden https://)!';
...
$PMF_LANG['ad_categ_nya'] = 'Ikke klar endnu!';
...
$PMF_LANG['msgCategoryRemark'] = 'Vær opmærksom på at de eksisterende data ikke vil være tilgængelige mere, hvis du sletter en kategori. Du må tildele en ny kategori for artiklen eller slette artiklen.';
...
$PMF_LANG['ad_cookie_cookiesuc'] = 'En Cookie blev sat.';
...
$PMF_LANG['ad_passwd_remark'] = 'SE HER: Cookie skal sættes igen!';
$PMF_LANG['ad_passwd_fail'] = 'Den gamle adgangskode skal angives korrekt og begge adgangskoder skal være ens.';
...
$PMF_LANG['ad_adus_suc'] = 'Bruger oprettet.';
$PMF_LANG['ad_adus_edit'] = 'Ret profil';
$PMF_LANG['ad_adus_dberr'] = 'database fejl!';
$PMF_LANG['ad_adus_exerr'] = 'Brugernavn eksisterer i forvejen.';
...
$PMF_LANG['msgAddAttachment'] = 'Vedhæft fil';
$PMF_LANG['ad_entryins_suc'] = 'Indlæg gemt.';
$PMF_LANG['msgErrorOccurred'] = 'En fejl opstod.';
...
$PMF_LANG['msgAddFAQ'] = 'Opret FAQ-indlæg';
...
$PMF_LANG['msgAddCategory'] = 'Tilføj Kategori';
...
$PMF_LANG['msgNoPermission'] = 'Du har ikke rettigheder.';
...
$PMF_LANG['permission::add_user'] = 'tilføj bruger';
$PMF_LANG['permission::edit_user'] = 'rediger bruger';
$PMF_LANG['permission::delete_user'] = 'slet bruger';
$PMF_LANG['permission::add_faq'] = 'tilføj indlæg';
$PMF_LANG['permission::edit_faq'] = 'rediger indlæg';
$PMF_LANG['permission::delete_faq'] = 'slet indlæg';
$PMF_LANG['permission::viewlog'] = 'se log';
$PMF_LANG['permission::adminlog'] = 'se admin log';
...
$PMF_LANG['permission::passwd'] = 'skift adgangskode';
...
$PMF_LANG['permission::backup'] = 'lav sikkerhedskopi';
$PMF_LANG['permission::restore'] = 'genskab sikkerhedskopi';
...
$PMF_LANG['err_SaveQuestion'] = 'Nødvendige felter: dit navn, din e-mail-adresse og dit spørgsmål.  <a href="javascript:history.back();">Ã©n side tilbage</a>  \n';
$PMF_LANG['ad_entry_fontcolor'] = 'Skrifttype farve: ';
$PMF_LANG['ad_entry_fontsize'] = 'Skrifttype størrelse: ';
$LANG_CONF['main.language'] = array("Vælg", "Sprog");
$LANG_CONF['main.languageDetection'] = array("checkbox", "Aktiver automatic content negotiation");
...
$LANG_CONF['main.send2friendText'] = array("area", "Tekst til send2friend siden");
$LANG_CONF['records.maxAttachmentSize'] = array("input", "maximum Størrelse for vedhæftning i bytes (maks. %sByte)");
$LANG_CONF['records.disableAttachments'] = array("checkbox", "Link the attachments below the entries?");
$LANG_CONF['main.enableUserTracking'] = array("checkbox", "benyt Tracking?");
$LANG_CONF['main.enableAdminLog'] = array("checkbox", "benyt administratorlog?");
$LANG_CONF['security.ipCheck'] = array("checkbox", "Do you want the IP to be checked when checking the UINs in admin.php?");
$LANG_CONF['records.numberOfRecordsPerPage'] = array("input", "Antal viste indlæg pr. side");
$LANG_CONF['records.numberOfShownNewsEntries'] = array("input", "Antal nyhedsartikler");
$LANG_CONF['security.bannedIPs'] = array("area", "Ban these IPs");
$LANG_CONF['ldap.ldapSupport'] = array("checkbox", "Aktiver underst&oslash;ttelse af LDAP? (standard: sl&aring;et fra)");
...
$PMF_LANG['msgButtonFetchLatestVersion'] = 'Hent versionsnummeret til nyeste udgave af phpMyFAQ';
...
$LANG_CONF['spam.enableSafeEmail'] = array("checkbox", "Print user email in a safe way (standard: enabled).");
$LANG_CONF['spam.checkBannedWords'] = array("checkbox", "Check public form content against banned words (standard: enabled).");
$LANG_CONF['spam.enableCaptchaCode'] = array("checkbox", "Use a catpcha code to allow public form submission (standard: enabled).");
...
$PMF_LANG['permission::addglossary'] = 'tilføj ordforklaring';
$PMF_LANG['permission::editglossary'] = 'rediger ordforklaring';
$PMF_LANG['permission::delglossary'] = 'slet ordforklaring';
...
$PMF_LANG['adminHeaderDashboard'] = 'Hjem';
...
$LANG_CONF['records.numberOfRelatedArticles'] = array("input", "Antal relaterede indl&aelig;g");
...
$PMF_LANG['msgCategoryMatrix'] = 'Overblik';
...
$PMF_LANG['msgGroupPermissions'] = 'Gruppe-rettigheder:';
...
$PMF_LANG['msgNewTranslationAddon'] = 'Your proposal will not be published right away, but will be released by the administrator upon receipt. Required  fields are your Name, your email address, your headline translation and your faq translation. Please separate the keywords with space only.';
...
$PMF_LANG['permission::addgroup'] = 'tilføj grupper';
$PMF_LANG['permission::editgroup'] = 'rediger grupper';
$PMF_LANG['permission::delgroup'] = 'slet grupper';
$PMF_LANG['ad_news_link_parent'] = 'Link &aring;bner i parent window';
$PMF_LANG['ad_menu_comments'] = 'Kommentarer';
$PMF_LANG['adminHeaderComments'] = 'Administration af kommentarer';
$PMF_LANG['msgAdminCommentFaqs'] = 'Kommentarer til FAQ-indl&aelig;g:';
$PMF_LANG['msgAdminCommentNews'] = 'Kommentarer til nyheder:';
$PMF_LANG['ad_groups'] = 'Grupper';
$LANG_CONF['records.orderby'] = array('select', 'Sortering af indl&aelig;g (afh&aelig;nger af egenskab)');
$LANG_CONF['records.sortby'] = array('select', 'Sortering af indl&aelig;g (faldende eller stigende)');
...
$LANG_CONF['records.defaultActivation'] = array('checkbox', "Activate a new records (standard: deactivated)");
$LANG_CONF['records.defaultAllowComments'] = array('checkbox', "Allow comments for new records (standard: disallowed)");
...
$PMF_LANG['msgOnlineVersionCheck'] = 'Online versionscheck';
