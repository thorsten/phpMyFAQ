...
$PMF_LANG['err_SaveEntries'] = 'Påkrevde felt: ditt navn, din e-postadresse, kategori, overskrift og ditt innlegg!<br><br><br><br>';
$PMF_LANG['err_SaveComment'] = 'Påkrevde felt: ditt navn, din e-postadresse og dine kommentarer!<br><br><br><br>';
...
$PMF_LANG['help_search'] = 'Søk etter spørsmål/svar:<br> Med en søketekst som <strong style="color: Red;">ord1 ord2 kan du gjøre et relevansesøk for to eller flere søkebetingelser.Merk: Din søkebetingelse må være minst 4 tegn langt hvis ikke vil søket ditt bli avvist.';
...
$PMF_LANG['ad_passwd_remark'] = 'SE HER:<br>Cookie skal lagres igjen!';
...
$PMF_LANG['err_SaveQuestion'] = 'Nødvendige felter: ditt navn, din e-postadresse og ditt spørsmål.<br><br>';
...
$LANG_CONF['records.attachmentsPath'] = array("input", "Sti til der vedleggene skal lagres.<br><small>(Relativ sti fra phpMyFaq rot)</small>");
