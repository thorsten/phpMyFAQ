...
$PMF_LANG['err_SaveEntries'] = 'Nödvändiga fält är ditt namn, din epostadress, kategori, rubrik och din fråga/svar!<br><br>\n<a href="nojavascript...history.back();">Backa</a><br><br>\n';
$PMF_LANG['err_SaveComment'] = 'Nödvändiga fält är ditt namn, din epostadress och din kommentar!<br><br>\n<a href="nojavascript...history.back();">Backa</a><br><br>\n';
...
$PMF_LANG['help_search'] = 'Sök efter inlägg:<br>Med ett innehåll likt: <strong style="color: Red;">ord1 ord2 du kan göra en relevanssökning (i fallande ordning), med två eller fler sökkriterier.Obs: Ditt sökkriterium måste vara minst 4 tecken långt.';
...
$PMF_LANG['ad_passwd_remark'] = 'OBS:<br>Kakan måste sparas på nytt!';
...
$PMF_LANG['err_SaveQuestion'] = 'Obligatoriska fält är ditt namn, din epostadress och din fråga.<br><br><a href="nojavascript...history.back();">tillbaka</a><br><br>\n';
...
$LANG_CONF['records.attachmentsPath'] = array("input", "Sökväg där bifogade filer ska sparas. <br><small>Relativ sökväg betyder en sökväg inom webbroten</small>");
