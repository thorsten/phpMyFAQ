...
$PMF_LANG['err_SaveEntries'] = 'Povinná pole jsou jméno, e-mailová adresa, kategorie, předmět a dotaz!<br><br>\n<a href=\"javascript:history.back();\">O stránku zpět</a><br><br>\n';
$PMF_LANG['err_SaveComment'] = 'Povinná pole jsou jméno, e-mailová adresa a komentář!<br><br>\n<a href=\"javascript:history.back();\">O stránku zpět</a><br><br>\n';
...
$PMF_LANG['ad_passwd_remark'] = 'POZOR:<br>Cookie musí být znovu nastaveno!';
...
$PMF_LANG['err_SaveQuestion'] = 'Povinná pole jsou jméno, e-mailová adresa a otázka.<br><br><a href="nojavascript...history.back();">předchozí stránka</a><br><br>\n';
...
$LANG_CONF['records.attachmentsPath'] = array("input", "Cesta kde budou ukládány přílohy.<br><small>Relativní cestou se myslí složka v rootu adresáře webu</small>");
