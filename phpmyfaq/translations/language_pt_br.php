...
$PMF_LANG['msgAskThx4Mail'] = 'Obrigado pelo seu e-mail!';
...
$PMF_LANG['err_SaveEntries'] = 'Campos obrigatórios são Nome, E-mail, Categoria, Título e Texto!  <a href="nojavascript...history.back();">voltar</a>  ';
$PMF_LANG['err_SaveComment'] = 'Campos obrigatórios são Nome, E-mail e Comentário!  <a href="nojavascript...history.back();">voltar</a>  ';
$PMF_LANG['err_VoteTooMuch'] = 'Já votou.';
$PMF_LANG['err_noVote'] = 'Não avaliou! <a href="nojavascript...history.back();">Clique aqui</a>, para votar.';
$PMF_LANG['err_noMailAdress'] = 'E-mail incorreto. <a href="nojavascript...history.back();">voltar</a>';
$PMF_LANG['err_sendMail'] = 'Campos obrigatórios são nome, e-mail e pergunta!';
$PMF_LANG['help_search'] = 'Pesquisar registros: ';
...
$PMF_LANG['ad_msg_mysqlerr'] = 'Devido a um erro de base de dados o perfil não foi salvo.';
...
$PMF_LANG['ad_news_link_url'] = 'Link: (Sem https://)!';
...
$PMF_LANG['ad_categ_nya'] = 'indisponível';
...
$PMF_LANG['msgCategoryRemark'] = 'Os registros existentes deixarão de ser visíveis se a categoria for removida. Especifique uma nova categoria para os artigos ou removas os artigos.';
...
$PMF_LANG['ad_cookie_cookiesuc'] = 'Cookie adicionado com sucesso.';
...
$PMF_LANG['ad_passwd_remark'] = 'ATENÇÃO: Você deve fazer o login novamente!';
$PMF_LANG['ad_passwd_fail'] = 'A senha antiga deve ser digitada corretamente e ambas as novas senhas devem ser iguais.';
...
$PMF_LANG['ad_adus_suc'] = 'Usuário adicionado com sucesso.';
...
$PMF_LANG['msgAddAttachment'] = 'Anexar arquivo';
...
$PMF_LANG['msgAddFAQ'] = 'Criar Registro';
...
$PMF_LANG['msgNoPermission'] = 'Sem autorização.';
...
$PMF_LANG['ad_group_suc'] = 'Grupo adicionado com sucesso.';
...
$PMF_LANG['categoryOwnerLabel'] = 'Categoria principal';
...
$PMF_LANG['msgAccessAllUsers'] = 'Acesso para todos usuários';
$PMF_LANG['ad_entry_restricted_users'] = 'Restringir acesso para';
$PMF_LANG['msgAccessAllGroups'] = 'Acesso para todos grupos';
...
$PMF_LANG['msgNewTranslationAddon'] = 'Sua proposta não será publicada imediatamente, mas será liberado pelo administrador após o recebimento. Os campos obrigatórios são Seu Nome, seu email, manchete tradução e sua faq tradução. Por favor separe as palavras-chave com espaço apenas.';
...
$PMF_LANG['msgAdminElasticsearchStats'] = 'Busca de Estatísticas';
...
$LANG_CONF['records.attachmentsPath'] = array('input', 'Caminho onde os anexos serão salvos. Caminho relativo significa uma pasta dentro da raiz da web');
$PMF_LANG['msgTransToolNoteFileSaving'] = 'Atenção: nenhum arquivo será gravado até que você clique no botão salvar';
$PMF_LANG['msgTransToolPageBufferRecorded'] = 'Buffer da página %d registrado com sucesso';
$PMF_LANG['msgTransToolErrorRecordingPageBuffer'] = 'Erro ao registrar o buffer da página %d';
$PMF_LANG['msgTransToolRecordingPageBuffer'] = 'Gravando o buffer da página %d';
...
$PMF_LANG['msgShowHelp'] = 'Separe as palavras com vírgulas.';
...
$LANG_CONF['layout.templateSet'] = array('select', 'Conjunto de templates a ser usado');
$LANG_CONF['records.enableAttachmentEncryption'] = array('checkbox', 'Habilitar criptografia dos anexos  Ignorado quando os anexos estão desativados');
$LANG_CONF['records.defaultAttachmentEncKey'] = array('input', 'Chave padrão para criptografia de anexos Ignorado quando os anexos estão desativados AVISO: Não altere esta chave depois de habilitar a opção de criptografia de anexos!!!');
$LANG_CONF['security.useSslForLogins'] = array('checkbox', 'Permitir logins apenas com conexão segura? (padrão: desativado)');
...
$PMF_LANG['msgAttachmentsDeleted'] = 'Anexo excluído com sucesso.';
...
$PMF_LANG['msgAboutFAQ'] = 'Sobre essa FAQ';
...
$LANG_CONF['search.enableRelevance'] = array('checkbox', 'Ativar suporte à relevância? (padrão: desativado)');
...
$PMF_LANG['msgAdminHeaderElasticsearch'] = 'Configuração do Elasticsearch';
$PMF_LANG['msgAdminElasticsearchCreateIndex'] = 'Criar índice';
$PMF_LANG['msgAdminElasticsearchDropIndex'] = 'Remover índice';
...
$PMF_LANG['msgAdminElasticsearchDropIndex_success'] = 'Índice removido com sucesso.';
...
$PMF_LANG['categoryImageLabel'] = 'Imagem de Categoria';
...
$PMF_LANG['msgUserRemovalText'] = 'Você pode solicitar a remoção de sua conta e de seus dados pessoais. Será enviado um email para a equipe de administradores. A equipe removerá sua conta, comentários e perguntas. Como esse é um processo manual, poderá levar até 24 horas para ser realizado. Quando terminar, você 
receberá um email confirmando sua remoção. ';
...
$PMF_LANG['msgFAQMetaData'] = 'Metadata da FAQ';
...
$PMF_LANG['msgPluginListing'] = 'Lista de plugins instalados e suas versões';
...
$PMF_LANG['msgReportABug'] = 'Reportar um erro';
$PMF_LANG['msgDashboard'] = 'Painel';
$PMF_LANG['msgOrphanedFAQs'] = 'FAQs órfãs';
$PMF_LANG['msgOrphanedFAQsDescription'] = 'Essas FAQs não estão atribuídas a nenhuma categoria. Você pode atribuí-las a uma categoria aqui.';
$PMF_LANG['msgPreview'] = 'Pré-visualização';
$PMF_LANG['msgInsertImage'] = 'Inserir imagem';
$PMF_LANG['msgImageUpload'] = 'Upload de imagem';
$PMF_LANG['msgImageCouldNotBeUploaded'] = 'A imagem não pôde ser enviada.';
$PMF_LANG['msgImageTooLarge'] = 'A imagem é muito grande.';
$PMF_LANG['msgNoImagesForUpload'] = 'Nenhuma imagem para upload.';
$PMF_LANG['msgFetchingHashes'] = 'Buscando hashes de verificação de api.phpmyfaq.de...';
$PMF_LANG['msgCheckHashes'] = 'Verificando hashes com os arquivos da instalação...';
$PMF_LANG['msgAuthenticationAborted'] = 'Autenticação cancelada pelo usuário.';
$LANG_CONF['security.enableAdminSessionTimeoutCounter'] = ['checkbox', 'Ativar contador de tempo limite da sessão de administração', 'Padrão: ativado'];
$LANG_CONF['search.enableOpenSearch'] = ['checkbox', 'Ativar suporte OpenSearch', 'Padrão: desativado'];
$LANG_CONF['search.popularSearchTimeWindow'] = ['input', 'Janela de tempo para pesquisas populares (dias)', 'Padrão: 180 dias'];
$PMF_LANG['msgAdminHeaderOpenSearch'] = 'Configuração do OpenSearch';
$PMF_LANG['msgAdminOpenSearchCreateIndex'] = 'Criar índice de pesquisa';
$PMF_LANG['msgAdminOpenSearchDropIndex'] = 'Excluir índice de pesquisa';
...
$PMF_LANG['ad_os_create_import_success'] = 'A importação do OpenSearch foi bem-sucedida.';
$PMF_LANG['msgAdminOpenSearchDropIndex_success'] = 'O índice de pesquisa OpenSearch foi excluído com sucesso.';
$PMF_LANG['permission::translate_faq'] = 'Traduzir FAQs';

// added v4.1.0-alpha.3 - 2025-08-02 by Thorsten
$PMF_LANG['msgTypeSearchCategories'] = 'Digite para pesquisar categorias';
$PMF_LANG['msgLoadingText'] = 'Carregando...';
$PMF_LANG['msgNoResultsText'] = 'Nenhum resultado encontrado';
$PMF_LANG['msgNoChoicesText'] = 'Nenhuma opção disponível';
$PMF_LANG['msgItemSelectText'] = 'Pressione para selecionar';
$PMF_LANG['msgUniqueItemText'] = 'Somente valores únicos podem ser adicionados';
$PMF_LANG['msgCustomAddItemText'] = 'Somente valores que atendam a condições específicas podem ser adicionados';
$PMF_LANG['msgDownloadYourData'] = 'Baixar seus dados';
$PMF_LANG['msgDataExportDescription'] = 'Baixe um arquivo ZIP contendo seus dados de usuário armazenados.';
...
$PMF_LANG['msgBackupGoTo'] = 'Ir para a página de Backup';
$PMF_LANG['msgNewestUsers'] = 'Usuários mais recentes';
$PMF_LANG['msgMemberSince'] = 'Membro desde';
$PMF_LANG['msgNumberRegisteredUsers'] = 'Usuários registrados';
$PMF_LANG['msgConfirmDeleteFAQ'] = 'Você realmente deseja excluir esta FAQ? Esta ação não pode ser desfeita.';
...
$PMF_LANG['msgMissingKeys'] = 'Chaves de tradução ausentes';
$PMF_LANG['msgCompletionPercentage'] = 'Percentual de conclusão';
$PMF_LANG['msgInstalledNewerThanAvailable'] = 'A versão instalada é mais recente do que a última versão disponível.';
$PMF_LANG['ad_quick_sub_category'] = 'Adicionar nova subcategoria';
$PMF_LANG['msgError403'] = 'Erro 403';
$PMF_LANG['msgError403Description'] = 'Você está autenticado, mas não tem permissão para acessar este recurso.';
$PMF_LANG['msgError403Hint'] = 'Se você acredita que isso é um erro, entre em contato com um administrador.';
...
$PMF_LANG['admin_mainmenu_imports_exports'] = 'Importar & Exportar';
$PMF_LANG['alertNightlyBuild'] = 'Você está usando uma versão de desenvolvimento do phpMyFAQ. Você pode atualizar para a última versão nightly.';
$PMF_LANG['buttonCheckHealth'] = 'Verificar saúde do sistema agora';
$PMF_LANG['buttonCheckUpdates'] = 'Verificar atualizações agora';
$PMF_LANG['buttonDownloadPackage'] = 'Baixar agora';
$PMF_LANG['buttonExtractPackage'] = 'Extrair pacote agora';
$PMF_LANG['cookiePreferences'] = 'Preferências de cookies';
$PMF_LANG['downloadFailure'] = 'Falha no download do pacote.';
$PMF_LANG['downloadSuccessful'] = 'O pacote foi baixado com sucesso.';
$PMF_LANG['extractFailure'] = 'Falha na extração do pacote.';
$PMF_LANG['extractSuccessful'] = 'O pacote foi extraído com sucesso.';
$PMF_LANG['headerCheckHealth'] = 'Verificação de saúde do sistema';
$PMF_LANG['headerCheckUpdates'] = 'Verificação de atualizações';
$PMF_LANG['headerDownloadPackage'] = 'Baixar pacote';
$PMF_LANG['headerExtractPackage'] = 'Extrair pacote';
$PMF_LANG['headerInstallDownloadedPackage'] = 'Instalar pacote baixado';
$PMF_LANG['healthCheckOkay'] = 'A verificação de saúde do sistema está OK.';
$PMF_LANG['layoutControlCenter'] = 'Layout';
$PMF_LANG['mail.sendTestEmail'] = 'Enviar e-mail de teste';
...
$PMF_LANG['msgAdminCleanupMissingAttachment'] = 'Limpar anexos ausentes';
$PMF_LANG['msgAdminWarningDebugMode'] = 'Atenção: O modo de depuração está ativado!';
$PMF_LANG['msgAdminWarningDevelopmentVersion'] = 'Atenção: Esta é uma versão de desenvolvimento!';
$PMF_LANG['msgAlreadyHaveAccount'] = 'Já tem uma conta?';
$PMF_LANG['msgAuthenticationSource'] = 'Fonte de autenticação';
$PMF_LANG['msgAuthor'] = 'Autor';
$PMF_LANG['msgBackupCurrentInstallation'] = 'Fazer backup da instalação atual';
...
$PMF_LANG['msgCSVFileNotValidated'] = 'O arquivo CSV não foi validado.';
$PMF_LANG['msgCSVImportTrueOrFalse'] = 'Use "true" ou "false" para campos booleanos.';
$PMF_LANG['msgCategoryDescription'] = 'Descrição da categoria';
$PMF_LANG['msgCategoryImageReset'] = 'Redefinir imagem da categoria';
$PMF_LANG['msgCategoryMetaDesc'] = 'Meta descrição da categoria';
$PMF_LANG['msgCategoryMissingButTranslationAvailable'] = 'A categoria está faltando, mas a tradução está disponível.';
$PMF_LANG['msgColumnStructure'] = 'Estrutura das colunas';
$PMF_LANG['msgConfirmTwofactorConfig'] = 'Confirmar configuração de dois fatores';
$PMF_LANG['msgContinue'] = 'Continuar';
$PMF_LANG['msgCopyLink'] = 'Copiar link';
$PMF_LANG['msgCreateDate'] = 'Data de criação';
$PMF_LANG['msgCurrentVersion'] = 'Versão atual';
$PMF_LANG['msgDatabaseUpdate'] = 'Atualização do banco de dados';
$PMF_LANG['msgDeleteAllVotings'] = 'Excluir todas as votações';
$PMF_LANG['msgDeleteAllVotingsError'] = 'Erro ao excluir todas as votações.';
$PMF_LANG['msgDeleteNews'] = 'Excluir notícia';
$PMF_LANG['msgDocumentation'] = 'Documentação';
$PMF_LANG['msgDownloadPackage'] = 'Baixar pacote';
$PMF_LANG['msgEditForms'] = 'Editar formulários';
$PMF_LANG['msgEditFormsSuccessful'] = 'Formulário editado com sucesso.';
$PMF_LANG['msgEnterTwofactorToken'] = 'Digite o token de dois fatores';
$PMF_LANG['msgError'] = 'Erro';
$PMF_LANG['msgError404'] = 'Erro 404';
$PMF_LANG['msgError404Description'] = 'A página solicitada não foi encontrada.';
$PMF_LANG['msgErrorEnterFullName'] = 'Por favor, insira seu nome completo.';
$PMF_LANG['msgErrorEnterLoginName'] = 'Por favor, insira seu nome de usuário.';
$PMF_LANG['msgErrorEnterMessage'] = 'Por favor, insira uma mensagem.';
$PMF_LANG['msgErrorEnterValidMail'] = 'Por favor, insira um endereço de e-mail válido.';
$PMF_LANG['msgExportSessions'] = 'Exportar sessões';
$PMF_LANG['msgExportSessionsAsCSV'] = 'Exportar sessões como CSV';
$PMF_LANG['msgExportSessionsFrom'] = 'Exportar sessões de';
$PMF_LANG['msgExportSessionsTo'] = 'Exportar sessões até';
$PMF_LANG['msgExportUsersAsCSV'] = 'Exportar usuários como CSV';
$PMF_LANG['msgExtractPackage'] = 'Extrair pacote';
$PMF_LANG['msgExtractToFileSystem'] = 'Extrair para o sistema de arquivos';
$PMF_LANG['msgFormDisabledDueToMissingCategories'] = 'Formulário desabilitado devido a categorias ausentes.';
$PMF_LANG['msgFormsAddTranslationSuccessful'] = 'Tradução adicionada com sucesso.';
$PMF_LANG['msgFormsDeleteTranslationSuccessful'] = 'Tradução excluída com sucesso.';
$PMF_LANG['msgFormsEditTranslationSuccessful'] = 'Tradução editada com sucesso.';
$PMF_LANG['msgFormsEditTranslations'] = 'Editar traduções';
$PMF_LANG['msgGenerateApiClientToken'] = 'Gerar token de cliente da API';
$PMF_LANG['msgGlossaryMetaDesc'] = 'Meta descrição do glossário';
$PMF_LANG['msgGoToCategory'] = 'Ir para categoria';
$PMF_LANG['msgGravatar'] = 'Gravatar';
$PMF_LANG['msgGravatarNotConnected'] = 'Gravatar não conectado';
$PMF_LANG['msgHealthCheck'] = 'Verificação de saúde';
$PMF_LANG['msgHintDeactivateForms'] = 'Dica: Desative formulários';
$PMF_LANG['msgImport'] = 'Importar';
$PMF_LANG['msgImportCSVFile'] = 'Importar arquivo CSV';
$PMF_LANG['msgImportCSVFileBody'] = 'Corpo do arquivo CSV para importação';
$PMF_LANG['msgImportRecords'] = 'Importar registros';
$PMF_LANG['msgImportRecordsColumnStructure'] = 'Estrutura das colunas para importação de registros';
$PMF_LANG['msgImportSuccessful'] = 'Importação bem-sucedida.';
$PMF_LANG['msgInputLabel'] = 'Rótulo do campo';
$PMF_LANG['msgInputType'] = 'Tipo de campo';
$PMF_LANG['msgInstallDownloadedPackage'] = 'Instalar pacote baixado';
$PMF_LANG['msgInstallationNewFiles'] = 'Novos arquivos da instalação';
$PMF_LANG['msgLanguageCode'] = 'Código do idioma';
$PMF_LANG['msgLastCheckDate'] = 'Data da última verificação';
$PMF_LANG['msgLastVersionAvailable'] = 'Última versão disponível';
$PMF_LANG['msgLinkCopied'] = 'Link copiado';
$PMF_LANG['msgLinkToFAQ'] = 'Link para a FAQ';
$PMF_LANG['msgMyBookmarks'] = 'Meus marcadores';
$PMF_LANG['msgNewQuestionAdded'] = 'Nova pergunta adicionada';
$PMF_LANG['msgNoHashAllowed'] = 'Caractere # não é permitido';
$PMF_LANG['msgNoLogMeOut'] = 'Não, desconectar-me';
$PMF_LANG['msgNoQuestionAndAnswer'] = 'Nenhuma pergunta e resposta disponível';
$PMF_LANG['msgNoStickyFaqs'] = 'Nenhuma FAQ fixada';
$PMF_LANG['msgNotInMaintenanceMode'] = 'Não está em modo de manutenção';
$PMF_LANG['msgNoteManualUpdate'] = 'Nota: Atualização manual necessária';
$PMF_LANG['msgOnlyInactiveFAQs'] = 'Apenas FAQs inativas';
$PMF_LANG['msgOnlyNewFAQs'] = 'Apenas FAQs novas';
$PMF_LANG['msgOpenQuestionsMetaDesc'] = 'Meta descrição de perguntas abertas';
$PMF_LANG['msgOrderStickyFaqsCustomDeactivated'] = 'Ordenação personalizada de FAQs fixadas desativada';
$PMF_LANG['msgOverviewMetaDesc'] = 'Meta descrição da visão geral';
$PMF_LANG['msgPasskeyRegistrationSuccess'] = 'Chave de acesso registrada com sucesso';
$PMF_LANG['msgPasswordTooShort'] = 'A senha é muito curta';
$PMF_LANG['msgPasswordsMustBeEqual'] = 'As senhas devem ser iguais';
$PMF_LANG['msgPrivateNotesOfEditor'] = 'Notas privadas do editor';
$PMF_LANG['msgQuestionMetaDesc'] = 'Meta descrição da pergunta';
$PMF_LANG['msgRedirect'] = 'Redirecionar';
$PMF_LANG['msgRegistrationWithPasskeys'] = 'Registro com chaves de acesso';
$PMF_LANG['msgReleaseEnvironment'] = 'Ambiente de lançamento';
$PMF_LANG['msgRemoveAll'] = 'Remover todos';
$PMF_LANG['msgRemoveTwofactorConfigSuccessful'] = 'Configuração de dois fatores removida com sucesso';
$PMF_LANG['msgRequiredInputField'] = 'Campo obrigatório';
$PMF_LANG['msgSelectLanguage'] = 'Selecione o idioma';
$PMF_LANG['msgSeparateKeywordsWithCommas'] = 'Separe as palavras-chave com vírgulas';
$PMF_LANG['msgSeparateWithCommas'] = 'Separe com vírgulas';
$PMF_LANG['msgSerp'] = 'SERP';
$PMF_LANG['msgSerpDescription'] = 'Descrição SERP';
$PMF_LANG['msgSerpTitle'] = 'Título SERP';
$PMF_LANG['msgSessionExpired'] = 'Sessão expirada';
$PMF_LANG['msgSessionExpiringSoon'] = 'Sessão expirando em breve';
$PMF_LANG['msgShareLinkVia'] = 'Compartilhar link via';
$PMF_LANG['msgShareText'] = 'Compartilhar texto';
$PMF_LANG['msgShareViaWhatsapp'] = 'Compartilhar via WhatsApp';
$PMF_LANG['msgSignInHere'] = 'Entre aqui';
$PMF_LANG['msgSignInWithMicrosoft'] = 'Entrar com Microsoft';
$PMF_LANG['msgSignInWithPasskey'] = 'Entrar com chave de acesso';
$PMF_LANG['msgSitemap'] = 'Mapa do site';
$PMF_LANG['msgSitemapMetaDesc'] = 'Meta descrição do mapa do site';
$PMF_LANG['msgSubCategoryContent'] = 'Conteúdo da subcategoria';
$PMF_LANG['msgSupportUs'] = 'Apoie-nos';
$PMF_LANG['msgTranslationText'] = 'Texto da tradução';
$PMF_LANG['msgTrendingFAQs'] = 'FAQs em tendência';
$PMF_LANG['msgTwofactorCheck'] = 'Verificação de dois fatores';
$PMF_LANG['msgTwofactorConfig'] = 'Configuração de dois fatores';
$PMF_LANG['msgTwofactorConfigModelTitle'] = 'Título do modelo de configuração de dois fatores';
$PMF_LANG['msgTwofactorEnabled'] = 'Dois fatores habilitado';
$PMF_LANG['msgTwofactorErrorToken'] = 'Erro no token de dois fatores';
$PMF_LANG['msgTwofactorNewSecret'] = 'Novo segredo de dois fatores';
$PMF_LANG['msgTwofactorTokenModelTitle'] = 'Título do modelo de token de dois fatores';
$PMF_LANG['msgUpdateCheck'] = 'Verificação de atualização';
$PMF_LANG['msgUpdateDate'] = 'Data de atualização';
$PMF_LANG['msgUserList'] = 'Lista de usuários';
$PMF_LANG['msgWarning'] = 'Aviso';
$PMF_LANG['msgYesKeepMeLoggedIn'] = 'Sim, mantenha-me conectado';
$PMF_LANG['noteNightlyBuild'] = 'Nota sobre versão nightly';
$PMF_LANG['permission::forms_edit'] = 'Editar formulários';
$PMF_LANG['qr_code_secret_alt'] = 'Código QR do segredo de autenticação';
$PMF_LANG['removeBookmark'] = 'Remover marcador';
$PMF_LANG['upgradeControlCenter'] = 'Atualização';
...
$PMF_LANG['ad_page_del'] = 'Tem certeza de que deseja excluir esta página personalizada?';
$PMF_LANG['ad_page_delete'] = 'Excluir';
$PMF_LANG['ad_page_delsuc'] = 'A página personalizada foi excluída com sucesso.';
...
$PMF_LANG['ad_page_no_available_languages'] = 'Todos os idiomas disponíveis já possuem traduções para esta página.';
$PMF_LANG['ad_page_nodata'] = 'Nenhuma página personalizada encontrada';
$PMF_LANG['ad_page_nodelete'] = 'Não';
$PMF_LANG['ad_page_original_language'] = 'Idioma original';
$PMF_LANG['ad_page_select_translation_language'] = 'Selecione o idioma da tradução';
...
$PMF_LANG['ad_page_slug'] = 'Slug da URL';
$PMF_LANG['ad_page_slug_exists'] = 'Este slug já existe para este idioma';
$PMF_LANG['ad_page_slug_help'] = 'Identificador amigável da URL para esta página (por exemplo, \'politica-de-privacidade\')';
$PMF_LANG['ad_page_tab_content'] = 'Conteúdo';
$PMF_LANG['ad_page_tab_seo'] = 'SEO';
$PMF_LANG['ad_page_tab_settings'] = 'Configurações';
...
$PMF_LANG['ad_page_yesdelete'] = 'Sim, excluir!';
$PMF_LANG['ad_pmf_news'] = 'Notícias do phpMyFAQ';
$PMF_LANG['keycloakControlCenter'] = 'Keycloak';
$PMF_LANG['msgAboutThisPage'] = 'Sobre esta página';
$PMF_LANG['msgAccessibilityStatement'] = 'Informações sobre a acessibilidade dos serviços';
$PMF_LANG['msgAdminHeaderLdap'] = 'Configuração do LDAP';
$PMF_LANG['msgAdminLdapGroupSettings'] = 'Configurações de grupo do LDAP';
$PMF_LANG['msgAdminLdapHealthCheck'] = 'Verificação de integridade do LDAP';
$PMF_LANG['msgAdminLdapMapping'] = 'Mapeamento de atributos do LDAP';
$PMF_LANG['msgAdminLdapOptions'] = 'Opções do LDAP';
$PMF_LANG['msgAdminLdapServers'] = 'Servidores LDAP';
$PMF_LANG['msgAdminLdapSettings'] = 'Configurações gerais do LDAP';
$PMF_LANG['msgAdminLogExportCsv'] = 'Exportar registros de administração como CSV';
$PMF_LANG['msgAdminLogVerifyIntegrity'] = 'Verificar integridade';
$PMF_LANG['msgAttention'] = 'Atenção!';
$PMF_LANG['msgChangeLanguageHint'] = 'Por favor, altere o idioma na administração para processar estas perguntas.';
...
$PMF_LANG['msgChatSearchUsers'] = 'Pesquisar usuários...';
$PMF_LANG['msgChatSelectConversation'] = 'Selecione uma conversa ou pesquise um usuário para começar a conversar';
$PMF_LANG['msgChatSend'] = 'Enviar';
$PMF_LANG['msgChatTypePlaceholder'] = 'Digite uma mensagem...';
$PMF_LANG['msgCommentEditorHint'] = 'Você pode usar o editor de texto para formatar seu comentário com negrito, itálico, listas e links.';
$PMF_LANG['msgConfirmAction'] = 'Confirmar ação';
$PMF_LANG['msgConfirmUnstick'] = 'Deseja realmente remover este registro da lista de FAQs importantes?';
$PMF_LANG['msgCookiePolicy'] = 'Política de cookies';
$PMF_LANG['msgCreated'] = 'Criado';
$PMF_LANG['msgDeletePage'] = 'Excluir página personalizada';
$PMF_LANG['msgEmailTo'] = 'E-mail para';
$PMF_LANG['msgFleschNotCalculated'] = 'Comece a digitar para calcular';
$PMF_LANG['msgFleschReadingEase'] = 'Índice de legibilidade';
...
$PMF_LANG['msgFleschTooltip'] = 'O índice de facilidade de leitura Flesch mede o quão fácil é ler seu texto. Pontuações mais altas significam leitura mais fácil. Procure atingir 60-70 para o público geral.';
$PMF_LANG['msgGenerateVapidKeys'] = 'Gerar chaves VAPID';
$PMF_LANG['msgImprint'] = 'Aviso legal';
$PMF_LANG['msgNoTranslationProvider'] = 'Nenhum provedor de tradução configurado';
$PMF_LANG['msgOpenQuestion'] = 'Pergunta em aberto';
$PMF_LANG['msgOtherQuestionDesc'] = 'Há mais uma pergunta em aberto em outro idioma:';
$PMF_LANG['msgOtherQuestionsDesc'] = 'Há um total de %d perguntas em aberto em outros idiomas:';
$PMF_LANG['msgPushNewFaq'] = 'Nova FAQ publicada';
$PMF_LANG['msgPushNewQuestion'] = 'Nova pergunta em aberto enviada';
$PMF_LANG['msgPushNotifications'] = 'Notificações push';
$PMF_LANG['msgPushNotificationsDescription'] = 'Receba notificações no navegador quando novas FAQs forem publicadas ou perguntas forem enviadas.';
...
$PMF_LANG['msgPushNotificationsNotSupported'] = 'As notificações push não são compatíveis com o seu navegador';
$PMF_LANG['msgPushNotificationsPermissionDenied'] = 'A permissão para notificações push foi negada';
$PMF_LANG['msgSignInWithKeycloak'] = 'Entrar com o Keycloak';
$PMF_LANG['msgStickyRemoved'] = 'O status "importante" foi removido com sucesso.';
$PMF_LANG['msgTermsOfService'] = 'Termos de serviço';
$PMF_LANG['msgThemeUploadNoZip'] = 'Por favor, selecione um arquivo ZIP para enviar.';
$PMF_LANG['msgToggleSidebar'] = 'Alternar barra lateral';
$PMF_LANG['msgTooltipUnstick'] = 'Remover status de importante';
$PMF_LANG['msgTranslateWithAI'] = 'Traduzir com AI';
$PMF_LANG['msgTranslating'] = 'Traduzindo...';
$PMF_LANG['msgTranslation'] = 'Tradução';
$PMF_LANG['msgTranslationError'] = 'Falha na tradução';
$PMF_LANG['msgTranslationSuccess'] = 'Tradução concluída com sucesso';
$PMF_LANG['msgUpdated'] = 'Atualizado';
$PMF_LANG['msgVapidKeysError'] = 'Falha ao gerar as chaves VAPID.';
...
$PMF_LANG['permission::delpage'] = 'Excluir páginas personalizadas';
$PMF_LANG['permission::editpage'] = 'Editar páginas personalizadas';
$PMF_LANG['pushControlCenter'] = 'Push';
$PMF_LANG['storage.testRedisConnection'] = 'Testar conexão com o Redis';
