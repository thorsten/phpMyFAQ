...
$PMF_LANG['err_SaveEntries'] = 'שדות נחוצים הם שמך, הדואל שלך, קטגוריה, כותרת ותוכן!<br><br><a href="javascript:history.back();">הקודם</a><br><br>';
$PMF_LANG['err_SaveComment'] = 'השדות הנחוצים הם שמך, כתובת הדואל שלך ותגובתך!<br><br><a href="javascript:history.back();">הקודם</a><br><br>';
...
$PMF_LANG['help_search'] = 'חפש ערכים:<br>עם ערך כמו <strong style="color: Red;">מילה 1 מילה 2 הנך יכול לבצע חיפוש לשניים או יותר קריטריונים.הערה: קריטריוני החיפוש חייבים להכיל 4 סימנים או יותר.';
...
$PMF_LANG['ad_passwd_remark'] = 'לתשומת לבך:<br>עוגיה צריכה להווצר שוב!';
...
$PMF_LANG['err_SaveQuestion'] = 'שדות נחוצים  שמך, כתובת אמייל והשאלה שלך.<br><br><a href=\"javascript:history.back();\">הקודם</a><br><br>';
