...
$PMF_LANG['msgEntriesIn'] = 'Contenido en ';
...
$PMF_LANG['msgHeaderCategoryOverview'] = 'Editar categoría';
...
$PMF_LANG['msgKeywords'] = 'Buscar palabras claves:';
$PMF_LANG['msgAuthor'] = 'Autor';
...
$PMF_LANG['msgCategoryRemark'] = 'Tenga en cuenta que si se elimina una categoría, las FAQs de la categoría eliminada ya no se mostrarán. A continuación, se debe asignar una nueva categoría a la FAQ o eliminarla.';
...
$PMF_LANG['ad_menu_stat'] = "Estadísticas";
$PMF_LANG['msgAddCategory'] = 'Añadir categoría principal';
...
$PMF_LANG['permission::add_user'] = 'Añadir usuario';
$PMF_LANG['permission::edit_user'] = 'Editar usuario';
$PMF_LANG['permission::delete_user'] = 'Eliminar usuario';
$PMF_LANG['permission::add_faq'] = 'Añadir FAQ';
$PMF_LANG['permission::edit_faq'] = 'Editar FAQ';
$PMF_LANG['permission::delete_faq'] = 'Eliminar FAQ';
$PMF_LANG['permission::viewlog'] = 'Ver log';
$PMF_LANG['permission::adminlog'] = 'Ver admin-log';
$PMF_LANG['permission::delcomment'] = 'Eliminar comentario';
$PMF_LANG['permission::addnews'] = 'Añadir noticias';
$PMF_LANG['permission::editnews'] = 'Editar noticias';
$PMF_LANG['permission::delnews'] = 'Eliminar noticias';
$PMF_LANG['permission::addcateg'] = 'Añadir categoría';
$PMF_LANG['permission::editcateg'] = 'Editar categoría';
$PMF_LANG['permission::delcateg'] = 'Eliminar categoría';
$PMF_LANG['permission::passwd'] = 'Cambiar contraseña';
$PMF_LANG['permission::editconfig'] = 'Editar configuración';
$PMF_LANG['permission::addatt'] = 'Añadir adjuntos';
$PMF_LANG['permission::delatt'] = 'Eliminar adjuntos';
$PMF_LANG['permission::backup'] = 'Crear backup';
$PMF_LANG['permission::restore'] = 'Restaurar backup';
$PMF_LANG['permission::delquestion'] = 'Eliminar preguntas abiertas';
$PMF_LANG['permission::changebtrevs'] = 'Editar revisiones';
...
$LANG_CONF['main.languageDetection'] = ["checkbox", "Habilitar reconocimiento automático de idioma"];
...
$LANG_CONF['main.enableAdminLog'] = ["checkbox", "¿Habilitar Adminlog?"];
$LANG_CONF["main.enableCategoryRestrictions"] = array("checkbox", "Habilitar las restricciones de categoría");
$LANG_CONF['security.ipCheck'] = ["checkbox", "¿Debería usarse la IP para el control en el área de administración?"];
...
$LANG_CONF['spam.EnableSafeEmail'] = array("checkbox", "Mostra email de usuario en modo seguro");
$LANG_CONF['spam.CheckBannedWords'] = array("checkbox", "Habilitar lista palabras censuradas");
$LANG_CONF['spam.EnableCatpchaCode'] = array("checkbox", "Mostrar gráfico Captcha");
...
$PMF_LANG['permission::addglossary'] = 'Añadir entradas del diccionario';
$PMF_LANG['permission::editglossary'] = 'Editar entradas del diccionario';
$PMF_LANG['permission::delglossary'] = 'Eliminar entradas del diccionario';
...
$LANG_CONF['records.numberOfRelatedArticles'] = array("input", "Número de FAQs relacionadas");
...
$PMF_LANG['msgCategoryMatrix'] = 'Resumen';
...
$PMF_LANG['permission::addgroup'] = 'Añadir grupos';
$PMF_LANG['permission::editgroup'] = 'Editar grupos';
$PMF_LANG['permission::delgroup'] = 'Eliminar grupos';
...
$LANG_CONF['records.orderby'] = array('select', 'Ordenar (por propiedad)');
$LANG_CONF['records.sortby'] = array('select', 'Ordenar (descendente/ascendente)');
$PMF_LANG['ad_conf_order_id'] = 'ID (Estándar)';
...
$LANG_CONF['records.defaultActivation'] = array("checkbox", "¿Las nuevas FAQs son visibles de inmediato?");
$LANG_CONF['records.defaultAllowComments'] = array("checkbox", "¿Se permiten comentarios en las FAQs?");
...
$PMF_LANG['permission::addtranslation'] = 'Añadir traducción';
$PMF_LANG['permission::edittranslation'] = 'Editar traducción';
$PMF_LANG['permission::deltranslation'] = 'Eliminar traducción';
$PMF_LANG['permission::approverec'] = 'Aprobar registros';
...
$LANG_CONF['search.numberSearchTerms'] = array('input', 'Número de términos de búsqueda más populares');
$LANG_CONF['records.orderingPopularFaqs'] = array('select', 'Orden de FAQs más populares');
...
$LANG_CONF['search.enableRelevance'] = array('checkbox', '¿Activar soporte para la relevancia');
...
$LANG_CONF['security.ssoSupport'] = array('checkbox', 'Soporte Single Sign On ');
$LANG_CONF['security.ssoLogoutRedirect'] = array('input', 'URL del servicio de redirección de Single Sign On al cerrar sesión');
$LANG_CONF['main.dateFormat'] = array('input', 'Formato de fecha (por defecto: Y-m-d H:i)');
$LANG_CONF['security.enableLoginOnly'] = array('checkbox', 'FAQ con seguridad completa');
...
$LANG_CONF['records.enableDeleteQuestion'] = array('checkbox', '¿Eliminar pregunta abierta después de la respuesta?');
...
$PMF_LANG['permission::addattachment'] = "Agregar adjuntos";
$PMF_LANG['permission::editattachment'] = "Editar adjuntos";
$PMF_LANG['permission::delattachment'] = "Eliminar adjuntos";
$PMF_LANG['permission::dlattachment'] = "Descargar adjuntos";
$PMF_LANG['permission::reports'] = "Crear informes";
$PMF_LANG['permission::addfaq'] = "Añadir FAQs en el frontend";
$PMF_LANG['permission::addquestion'] = "Añadir preguntas en el frontend";
$PMF_LANG['permission::addcomment'] = "Añadir comentarios en el frontend";
$PMF_LANG['permission::editinstances'] = "Editar multi-sitio";
$PMF_LANG['permission::addinstances'] = "Añadir multi-site";
$PMF_LANG['permission::delinstances'] = "Eliminar multisitios";
...
$LANG_CONF['main.enableWysiwygEditorFrontend'] = ['checkbox', 'Habilitar editor WYSIWYG incluido en el frontend '];

// added v2.8.0-beta3 - 2013-01-15 by Thorsten
$LANG_CONF['main.enableGravatarSupport'] = ['checkbox', 'Soporte para Gravatar'];
...
$LANG_CONF['search.enableHighlighting'] = ["checkbox", "Destacar las palabras encontradas"];
$LANG_CONF['records.allowComentariosPara Invitados'] = ["checkbox", "Permitir comentarios de invitados "];
$LANG_CONF['records.allowQuestionsForGuests'] = ["checkbox", "Permitir preguntas de invitados "];
$LANG_CONF['records.allowNewFaqsForGuests'] = ["checkbox", "Permitir nuevas FAQs de invitados "];
...
$LANG_CONF['seo.metaTagsPages'] = ["select", "Meta Tags HTML para páginas estáticas"];
...
$LANG_CONF['mail.remoteSMTP'] = ['checkbox', 'Usar servidor SMTP externo'];
$LANG_CONF['mail.remoteSMTPServer'] = ['input', 'Servidor SMTP'];
$LANG_CONF['mail.remoteSMTPNombre de usuario'] = ['input', 'Nombre de usuario SMTP'];
$LANG_CONF['mail.remoteSMTPContraseña'] = ['password', 'Contraseña SMTP'];
...
$LANG_CONF['ldap.ldap_mapping.name'] = ['input', 'Mapeo LDAP para Nombre, "cn" cuando se usa un ADS'];
$LANG_CONF['ldap.ldap_mapping.username'] = ['input', 'Mapeo LDAP para Nombre de Usuario, "samAccountName" cuando se usa un ADS'];
$LANG_CONF['ldap.ldap_mapping.mail'] = ['input', 'Mapeo LDAP para e-mail, "mail" cuando se usa un ADS'];
$LANG_CONF['ldap.ldap_mapping.memberOf'] = ['input', 'mapeo LDAP para "Miembro de" cuando se usan grupos LDAP'];
$LANG_CONF['ldap.ldap_use_domain_prefix'] = ['checkbox', 'Prefijo de dominio LDAP, p.ej. "DOMAIN\username"'];
$LANG_CONF['ldap.ldap_options.LDAP_OPT_PROTOCOL_VERSION'] = ['input', 'versión del protocolo LDAP (por defecto: 3)'];
$LANG_CONF['ldap.ldap_options.LDAP_OPT_REFERRALS'] = ['input', 'Referencias LDAP (por defecto: 0)'];
...
$PMF_LANG['msgOrphanedFAQs'] = 'FAQ huérfanas';
$PMF_LANG['msgOrphanedFAQsDescription'] = 'Las siguientes FAQs no están asignadas a ninguna categoría. Puede asignarlas a una categoría existente o crear una nueva categoría.';
$PMF_LANG['msgPreview'] = 'Vista previa';
$PMF_LANG['msgInsertImage'] = 'Insertar imagen';
$PMF_LANG['msgImageUpload'] = 'Subir imagen';
...
$PMF_LANG['ad_layout_mode_auto'] = 'Automático (seguir la preferencia del sistema del visitante)';
$PMF_LANG['ad_layout_mode_dark'] = 'Oscuro';
$PMF_LANG['ad_layout_mode_highContrast'] = 'Alto contraste';
$PMF_LANG['ad_layout_mode_light'] = 'Claro';
$PMF_LANG['ad_menu_pages'] = 'Páginas personalizadas';
$PMF_LANG['ad_page_add'] = 'Añadir página personalizada';
$PMF_LANG['ad_page_add_translation'] = 'Añadir traducción';
$PMF_LANG['ad_page_author_email'] = 'Correo electrónico del autor';
$PMF_LANG['ad_page_author_name'] = 'Nombre del autor';
$PMF_LANG['ad_page_content'] = 'Contenido de la página';
$PMF_LANG['ad_page_created'] = 'Creada';
$PMF_LANG['ad_page_del'] = '¿Estás seguro de que quieres eliminar esta página personalizada?';
$PMF_LANG['ad_page_delete'] = 'Eliminar';
$PMF_LANG['ad_page_delsuc'] = 'La página personalizada se ha eliminado correctamente.';
$PMF_LANG['ad_page_edit'] = 'Editar página personalizada';
$PMF_LANG['ad_page_existing_translations'] = 'Traducciones existentes';
$PMF_LANG['ad_page_insertfail'] = 'Se ha producido un error al crear la página personalizada.';
$PMF_LANG['ad_page_lang_cannot_change'] = 'El idioma no se puede cambiar después de la creación.';
$PMF_LANG['ad_page_no_available_languages'] = 'Todos los idiomas disponibles tienen traducciones para esta página.';
$PMF_LANG['ad_page_nodata'] = 'No se han encontrado páginas personalizadas';
$PMF_LANG['ad_page_nodelete'] = 'No';
$PMF_LANG['ad_page_original_language'] = 'Idioma original';
$PMF_LANG['ad_page_select_translation_language'] = 'Seleccionar idioma de traducción';
$PMF_LANG['ad_page_seo_description'] = 'Meta descripción SEO';
$PMF_LANG['ad_page_seo_robots'] = 'Directiva para robots';
$PMF_LANG['ad_page_seo_title'] = 'Título SEO';
$PMF_LANG['ad_page_set_active'] = 'Activar página';
$PMF_LANG['ad_page_slug'] = 'Slug de URL';
$PMF_LANG['ad_page_slug_exists'] = 'Este slug ya existe para este idioma';
$PMF_LANG['ad_page_slug_help'] = 'Identificador apto para URL de esta página (p. ej., \'politica-de-privacidad\')';
$PMF_LANG['ad_page_tab_content'] = 'Contenido';
$PMF_LANG['ad_page_tab_seo'] = 'SEO';
$PMF_LANG['ad_page_tab_settings'] = 'Ajustes';
$PMF_LANG['ad_page_title'] = 'Título de la página';
$PMF_LANG['ad_page_translate'] = 'Traducir página';
$PMF_LANG['ad_page_update'] = 'Actualizar';
$PMF_LANG['ad_page_updated'] = 'Actualizada';
$PMF_LANG['ad_page_updatefail'] = 'Se ha producido un error al actualizar la página personalizada.';
$PMF_LANG['ad_page_updatesuc'] = 'La página personalizada se ha actualizado correctamente.';
$PMF_LANG['ad_page_yesdelete'] = '¡Sí, eliminar!';
$PMF_LANG['ad_pmf_news'] = 'Noticias de phpMyFAQ';
$PMF_LANG['keycloakControlCenter'] = 'Keycloak';
$PMF_LANG['msgAboutThisPage'] = 'Acerca de esta página';
$PMF_LANG['msgAccessibilityStatement'] = 'Información sobre la accesibilidad de los servicios';
$PMF_LANG['msgAdminHeaderLdap'] = 'Configuración de LDAP';
$PMF_LANG['msgAdminLdapGroupSettings'] = 'Ajustes de grupos LDAP';
$PMF_LANG['msgAdminLdapHealthCheck'] = 'Comprobación del estado de LDAP';
$PMF_LANG['msgAdminLdapMapping'] = 'Asignación de atributos LDAP';
$PMF_LANG['msgAdminLdapOptions'] = 'Opciones de LDAP';
$PMF_LANG['msgAdminLdapServers'] = 'Servidores LDAP';
$PMF_LANG['msgAdminLdapSettings'] = 'Ajustes generales de LDAP';
$PMF_LANG['msgAdminLogExportCsv'] = 'Exportar registros de administración como CSV';
$PMF_LANG['msgAdminLogVerifyIntegrity'] = 'Verificar integridad';
$PMF_LANG['msgAttention'] = '¡Atención!';
$PMF_LANG['msgChangeLanguageHint'] = 'Por favor, cambia el idioma en la administración para procesar estas preguntas.';
$PMF_LANG['msgChat'] = 'Mensajes';
$PMF_LANG['msgChatConversations'] = 'Conversaciones';
$PMF_LANG['msgChatNewConversation'] = 'Nueva conversación';
$PMF_LANG['msgChatNoMessages'] = 'Aún no hay mensajes';
$PMF_LANG['msgChatSearchUsers'] = 'Buscar usuarios...';
$PMF_LANG['msgChatSelectConversation'] = 'Selecciona una conversación o busca un usuario para empezar a chatear';
$PMF_LANG['msgChatSend'] = 'Enviar';
$PMF_LANG['msgChatTypePlaceholder'] = 'Escribe un mensaje...';
$PMF_LANG['msgCommentEditorHint'] = 'Puedes utilizar el editor de texto para dar formato a tu comentario con negrita, cursiva, listas y enlaces.';
$PMF_LANG['msgConfirmAction'] = 'Confirmar acción';
$PMF_LANG['msgConfirmUnstick'] = '¿Realmente quieres quitar esta entrada de la lista de FAQs importantes?';
$PMF_LANG['msgCookiePolicy'] = 'Política de cookies';
$PMF_LANG['msgCreated'] = 'Creada';
$PMF_LANG['msgDeletePage'] = 'Eliminar página personalizada';
$PMF_LANG['msgEmailTo'] = 'Correo electrónico a';
$PMF_LANG['msgFleschNotCalculated'] = 'Empieza a escribir para calcular';
$PMF_LANG['msgFleschReadingEase'] = 'Puntuación de legibilidad';
$PMF_LANG['msgFleschScaleHint'] = '0-29: Muy difícil | 30-49: Difícil | 50-59: Bastante difícil | 60-69: Estándar | 70-79: Bastante fácil | 80-89: Fácil | 90-100: Muy fácil';
$PMF_LANG['msgFleschTooltip'] = 'La puntuación de facilidad de lectura de Flesch mide lo fácil que es leer tu texto. Las puntuaciones más altas indican una lectura más fácil. Apunta a 60-70 para un público general.';
$PMF_LANG['msgGenerateVapidKeys'] = 'Generar claves VAPID';
$PMF_LANG['msgImprint'] = 'Aviso legal';
$PMF_LANG['msgNoTranslationProvider'] = 'No hay ningún proveedor de traducción configurado';
$PMF_LANG['msgOpenQuestion'] = 'Pregunta abierta';
$PMF_LANG['msgOtherQuestionDesc'] = 'Hay una pregunta abierta más en otro idioma:';
$PMF_LANG['msgOtherQuestionsDesc'] = 'Hay un total de %d preguntas abiertas más en otros idiomas:';
$PMF_LANG['msgPushNewFaq'] = 'Nueva FAQ publicada';
$PMF_LANG['msgPushNewQuestion'] = 'Nueva pregunta abierta enviada';
$PMF_LANG['msgPushNotifications'] = 'Notificaciones push';
$PMF_LANG['msgPushNotificationsDescription'] = 'Recibe notificaciones del navegador cuando se publiquen nuevas FAQs o se envíen preguntas.';
$PMF_LANG['msgPushNotificationsDisable'] = 'Desactivar notificaciones push';
$PMF_LANG['msgPushNotificationsDisabled'] = 'Notificaciones push desactivadas';
$PMF_LANG['msgPushNotificationsEnable'] = 'Activar notificaciones push';
$PMF_LANG['msgPushNotificationsEnabled'] = 'Notificaciones push activadas';
$PMF_LANG['msgPushNotificationsNotSupported'] = 'Tu navegador no admite las notificaciones push';
$PMF_LANG['msgPushNotificationsPermissionDenied'] = 'Se ha denegado el permiso para las notificaciones push';
$PMF_LANG['msgSignInWithKeycloak'] = 'Iniciar sesión con Keycloak';
$PMF_LANG['msgStickyRemoved'] = 'El estado «importante» se ha quitado correctamente.';
$PMF_LANG['msgTermsOfService'] = 'Términos del servicio';
$PMF_LANG['msgThemeUploadNoZip'] = 'Por favor, selecciona un archivo ZIP para subir.';
$PMF_LANG['msgToggleSidebar'] = 'Mostrar u ocultar la barra lateral';
$PMF_LANG['msgTooltipUnstick'] = 'Quitar el estado de importante';
$PMF_LANG['msgTranslateWithAI'] = 'Traducir con AI';
$PMF_LANG['msgTranslating'] = 'Traduciendo...';
$PMF_LANG['msgTranslation'] = 'Traducción';
$PMF_LANG['msgTranslationError'] = 'La traducción ha fallado';
$PMF_LANG['msgTranslationSuccess'] = 'Traducción completada correctamente';
$PMF_LANG['msgUpdated'] = 'Actualizada';
$PMF_LANG['msgVapidKeysError'] = 'No se han podido generar las claves VAPID.';
$PMF_LANG['msgVapidKeysGenerated'] = 'Las claves VAPID se han generado correctamente.';
$PMF_LANG['oauthControlCenter'] = 'OAuth 2.0';
$PMF_LANG['permission::addpage'] = 'Añadir páginas personalizadas';
$PMF_LANG['permission::delpage'] = 'Eliminar páginas personalizadas';
$PMF_LANG['permission::editpage'] = 'Editar páginas personalizadas';
$PMF_LANG['pushControlCenter'] = 'Push';
$PMF_LANG['storage.testRedisConnection'] = 'Probar la conexión con Redis';
$PMF_LANG['storageControlCenter'] = 'Almacenamiento';
