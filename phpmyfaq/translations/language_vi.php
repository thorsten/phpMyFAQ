...
$PMF_LANG["msgAskThx4Mail"] = "Xin cảm ơn câu hỏi của bạn!";
...
$PMF_LANG["err_SaveEntries"] = "Những nội dung sau là bắt buộc tên của bạn, email của bạn, mục, tựa đề, nội dung và, khi được yêu cầu, <a href=\"https://en.wikipedia.org/wiki/Captcha\" title=\"Xem thêm về Captcha trên Wikipedia\" target=\"_blank\">Captcha</a> code!  <a href=\"javascript:history.back();\">trở về trang trước</a>  ";
$PMF_LANG["err_SaveComment"] = "Những nội dung sau là bắt buộc tên của bạn, email của bạn, bình luận của bạn và, khi được yêu cầu, <a href=\"https://en.wikipedia.org/wiki/Captcha\" title=\"Xem thêm về Captcha trên Wikipedia\" target=\"_blank\">Captcha</a> code!  <a href=\"javascript:history.back();\">trở về trang trước</a>  ";
$PMF_LANG["err_VoteTooMuch"] = "Chúng tôi không tính trường hợp bình chọn hai lần.";
$PMF_LANG["err_noVote"] = "Bạn chưa bình chọn câu hỏi! <a href=\"javascript:history.back();\">Vui lòng nhấp vào đây</a>, để bình chọn.";
$PMF_LANG["err_noMailAdress"] = "Địa chỉ email của bạn không chính xác. <a href=\"javascript:history.back();\">trở về</a>";
$PMF_LANG["err_sendMail"] = "Những nội dung sau là bắt buộc tên của bạn, email của bạn, câu hỏi của bạn và, khi được yêu cầu, <a href=\"https://en.wikipedia.org/wiki/Captcha\" title=\"Xem thêm về Captcha trên Wikipedia\" target=\"_blank\">Captcha</a> code!  <a href=\"javascript:history.back();\">trở về trang trước</a>  ";

// Hilfe zur Suche
$PMF_LANG["help_search"] = "Tìm kiếm cho nội dung: Với một nội dung như từ1 từ2 bạn có thể tìm kiếm với độ chính xác giảm dần cho hai hoặc nhiều tiêu chí tìm kiếm.Chú ý: Tiêu chí tìm kiếm của bạn phải gồm ít nhất 3 chữ cái, nếu không yêu cầu của bạn sẽ bị từ chối.";
...
$PMF_LANG["ad_msg_passmatch"] = "Hai mật khẩu phải trùng khớp!";
$PMF_LANG["ad_msg_savedsuc_1"] = "Thông tin của";
$PMF_LANG["ad_msg_savedsuc_2"] = "đã được lưu.";
$PMF_LANG["ad_msg_mysqlerr"] = "Do lỗi cơ sở dữ liệu thông tin đã không được lưu.";
...
$PMF_LANG["ad_entry_commentdelsuc"] = "Bình luận đã được xóa.";
$PMF_LANG["ad_entry_back"] = "Trở lại nội dung bài";
$PMF_LANG["ad_entry_commentdelfail"] = "Bình luận chưa được xóa.";
$PMF_LANG["ad_entry_savedsuc"] = "Các thay đổi đã được lưu.";
$PMF_LANG["ad_entry_savedfail"] = "Có lỗi cơ sở dữ liệu xảy ra.";
$PMF_LANG["ad_entry_del_1"] = "Bạn có chắc rằng bài";
$PMF_LANG["ad_entry_del_2"] = "của ";
$PMF_LANG["ad_entry_del_3"] = "cần xóa?";
$PMF_LANG["ad_entry_delsuc"] = "Bài đã được xóa.";
$PMF_LANG["ad_entry_delfail"] = "Bài chưa được xóa!";
...
$PMF_LANG["ad_news_link_url"] = "Đường dẫn: (không để https://)!";
...
// Cookies
$PMF_LANG["ad_cookie_cookiesuc"] = "Cookie đã được viết thành công.";
...
$PMF_LANG["ad_passwd_remark"] = "Chú ý: Cookie đã được thay thế!";
$PMF_LANG["ad_passwd_fail"] = "Mật khẩu cũ cần được nhập chính xác và hai mật khẩu mới cần phải trùng khớp.";
...
$PMF_LANG["ad_adus_suc"] = "Thành viên đã được thêm.";
$PMF_LANG["ad_adus_edit"] = "Chỉnh sửa thông tin thành viên";
$PMF_LANG["ad_adus_dberr"] = "lỗi cơ sở dữ liệu";
$PMF_LANG["ad_adus_exerr"] = "Tên thành viên đã được đăng ký.";
...
$PMF_LANG['permission::delete_user'] = "xóa thành viên";
$PMF_LANG['permission::add_faq'] = "thêm nội dung";
$PMF_LANG['permission::edit_faq'] = "chỉnh sửa nội dung";
$PMF_LANG['permission::delete_faq'] = "xóa nội dung";
$PMF_LANG['permission::viewlog'] = "xem log";
$PMF_LANG['permission::adminlog'] = "xem admin log";
$PMF_LANG['permission::delcomment'] = "xóa bình luận";
$PMF_LANG['permission::addnews'] = "thêm nội dung mới";
$PMF_LANG['permission::editnews'] = "chỉnh sửa nội dung mới";
$PMF_LANG['permission::delnews'] = "xóa nội dung mới";
$PMF_LANG['permission::addcateg'] = "thêm mục";
$PMF_LANG['permission::editcateg'] = "chỉnh sửa mục";
$PMF_LANG['permission::delcateg'] = "xóa mục";
$PMF_LANG['permission::passwd'] = "thay đổi mật khẩu";
$PMF_LANG['permission::editconfig'] = "chỉnh sửa cấu hình";
$PMF_LANG['permission::addatt'] = "thêm tài liệu đính kèm";
$PMF_LANG['permission::delatt'] = "xóa tài liệu đính kèm";
$PMF_LANG['permission::backup'] = "tạo bản lưu";
$PMF_LANG['permission::restore'] = "tái tạo bản lưu";
$PMF_LANG['permission::delquestion'] = "xóa toàn bộ các câu hỏi mở";
$PMF_LANG['permission::changebtrevs'] = "chỉnh sửa các thay đổi";
...
$PMF_LANG['msgRevision'] = 'Hiệu đính';
...
$PMF_LANG['permission::addglossary'] = "thêm nội dung thuật ngữ";
$PMF_LANG['permission::editglossary'] = "chỉnh sửa nội dung thuật ngữ";
$PMF_LANG['permission::delglossary'] = "xóa nội dung thuật ngữ";
...
$PMF_LANG['ad_group_suc'] = "Nhóm được tạo thành công.";
...
$PMF_LANG['msgGroupPermissions'] = 'Quyền của nhóm:';
...
$PMF_LANG['msgAccessAllGroups'] = 'Quyền truy cập cho mọi nhóm';
...
$PMF_LANG['msgNewTranslationAddon'] = 'Đề nghị của bạn sẽ được đăng sau khi quản trị viên của chúng tôi thông qua. Những thông tin sau là bắt buộc Tên của bạn, email của bạn, dịch tiêu đề and dịch nội dung Câu hỏi thường gặp. Vui lòng chỉ sử dụng khoảng cách để phân biệt giữa các từ khóa.';
...
$PMF_LANG['permission::addgroup'] = "thêm tài khoản nhóm";
$PMF_LANG['permission::editgroup'] = "chỉnh sửa tài khoản nhóm";
$PMF_LANG['permission::delgroup'] = "xóa tài khoản nhóm";
...
$PMF_LANG['ad_layout_mode_auto'] = 'Tự động (theo tùy chọn hệ thống của khách truy cập)';
$PMF_LANG['ad_layout_mode_dark'] = 'Tối';
$PMF_LANG['ad_layout_mode_highContrast'] = 'Tương phản cao';
$PMF_LANG['ad_layout_mode_light'] = 'Sáng';
$PMF_LANG['ad_menu_pages'] = 'Trang tùy chỉnh';
$PMF_LANG['ad_page_add'] = 'Thêm trang tùy chỉnh';
$PMF_LANG['ad_page_add_translation'] = 'Thêm bản dịch';
$PMF_LANG['ad_page_author_email'] = 'Email tác giả';
$PMF_LANG['ad_page_author_name'] = 'Tên tác giả';
$PMF_LANG['ad_page_content'] = 'Nội dung trang';
$PMF_LANG['ad_page_created'] = 'Đã tạo';
$PMF_LANG['ad_page_del'] = 'Bạn có chắc chắn muốn xóa trang tùy chỉnh này không?';
$PMF_LANG['ad_page_delete'] = 'Xóa';
$PMF_LANG['ad_page_delsuc'] = 'Trang tùy chỉnh đã được xóa thành công.';
$PMF_LANG['ad_page_edit'] = 'Chỉnh sửa trang tùy chỉnh';
$PMF_LANG['ad_page_existing_translations'] = 'Bản dịch hiện có';
$PMF_LANG['ad_page_insertfail'] = 'Đã xảy ra lỗi khi tạo trang tùy chỉnh.';
$PMF_LANG['ad_page_lang_cannot_change'] = 'Không thể thay đổi ngôn ngữ sau khi tạo.';
$PMF_LANG['ad_page_no_available_languages'] = 'Tất cả các ngôn ngữ khả dụng đều đã có bản dịch cho trang này.';
$PMF_LANG['ad_page_nodata'] = 'Không tìm thấy trang tùy chỉnh nào';
$PMF_LANG['ad_page_nodelete'] = 'Không';
$PMF_LANG['ad_page_original_language'] = 'Ngôn ngữ gốc';
$PMF_LANG['ad_page_select_translation_language'] = 'Chọn ngôn ngữ dịch';
$PMF_LANG['ad_page_seo_description'] = 'Mô tả Meta SEO';
$PMF_LANG['ad_page_seo_robots'] = 'Chỉ thị Robots';
$PMF_LANG['ad_page_seo_title'] = 'Tiêu đề SEO';
$PMF_LANG['ad_page_set_active'] = 'Kích hoạt trang';
$PMF_LANG['ad_page_slug'] = 'URL Slug';
$PMF_LANG['ad_page_slug_exists'] = 'Slug này đã tồn tại cho ngôn ngữ này';
$PMF_LANG['ad_page_slug_help'] = 'Mã định danh thân thiện với URL cho trang này (ví dụ: \'privacy-policy\')';
$PMF_LANG['ad_page_tab_content'] = 'Nội dung';
$PMF_LANG['ad_page_tab_seo'] = 'SEO';
$PMF_LANG['ad_page_tab_settings'] = 'Cài đặt';
$PMF_LANG['ad_page_title'] = 'Tiêu đề trang';
$PMF_LANG['ad_page_translate'] = 'Dịch trang';
$PMF_LANG['ad_page_update'] = 'Cập nhật';
$PMF_LANG['ad_page_updated'] = 'Đã cập nhật';
$PMF_LANG['ad_page_updatefail'] = 'Đã xảy ra lỗi khi cập nhật trang tùy chỉnh.';
$PMF_LANG['ad_page_updatesuc'] = 'Trang tùy chỉnh đã được cập nhật thành công.';
$PMF_LANG['ad_page_yesdelete'] = 'Có, xóa!';
$PMF_LANG['ad_pmf_news'] = 'Tin tức phpMyFAQ';
$PMF_LANG['keycloakControlCenter'] = 'Keycloak';
$PMF_LANG['msgAboutThisPage'] = 'Giới thiệu về trang này';
$PMF_LANG['msgAccessibilityStatement'] = 'Thông tin về khả năng tiếp cận của dịch vụ';
$PMF_LANG['msgAdminHeaderLdap'] = 'Cấu hình LDAP';
$PMF_LANG['msgAdminLdapGroupSettings'] = 'Cài đặt nhóm LDAP';
$PMF_LANG['msgAdminLdapHealthCheck'] = 'Kiểm tra tình trạng LDAP';
$PMF_LANG['msgAdminLdapMapping'] = 'Ánh xạ thuộc tính LDAP';
$PMF_LANG['msgAdminLdapOptions'] = 'Tùy chọn LDAP';
$PMF_LANG['msgAdminLdapServers'] = 'Máy chủ LDAP';
$PMF_LANG['msgAdminLdapSettings'] = 'Cài đặt chung LDAP';
$PMF_LANG['msgAdminLogExportCsv'] = 'Xuất nhật ký quản trị dưới dạng CSV';
$PMF_LANG['msgAdminLogVerifyIntegrity'] = 'Xác minh tính toàn vẹn';
$PMF_LANG['msgAttention'] = 'Chú ý!';
$PMF_LANG['msgChangeLanguageHint'] = 'Vui lòng thay đổi ngôn ngữ trong phần quản trị để xử lý những câu hỏi này.';
$PMF_LANG['msgChat'] = 'Tin nhắn';
$PMF_LANG['msgChatConversations'] = 'Cuộc trò chuyện';
$PMF_LANG['msgChatNewConversation'] = 'Cuộc trò chuyện mới';
$PMF_LANG['msgChatNoMessages'] = 'Chưa có tin nhắn nào';
$PMF_LANG['msgChatSearchUsers'] = 'Tìm kiếm thành viên...';
$PMF_LANG['msgChatSelectConversation'] = 'Chọn một cuộc trò chuyện hoặc tìm một thành viên để bắt đầu trò chuyện';
$PMF_LANG['msgChatSend'] = 'Gửi';
$PMF_LANG['msgChatTypePlaceholder'] = 'Nhập tin nhắn...';
$PMF_LANG['msgCommentEditorHint'] = 'Bạn có thể dùng trình soạn thảo văn bản để định dạng bình luận với chữ đậm, chữ nghiêng, danh sách và liên kết.';
$PMF_LANG['msgConfirmAction'] = 'Xác nhận hành động';
$PMF_LANG['msgConfirmUnstick'] = 'Bạn có thực sự muốn xóa mục này khỏi danh sách các câu hỏi thường gặp quan trọng không?';
$PMF_LANG['msgCookiePolicy'] = 'Chính sách Cookie';
$PMF_LANG['msgCreated'] = 'Đã tạo';
$PMF_LANG['msgDeletePage'] = 'Xóa trang tùy chỉnh';
$PMF_LANG['msgEmailTo'] = 'Email đến';
$PMF_LANG['msgFleschNotCalculated'] = 'Bắt đầu nhập để tính toán';
$PMF_LANG['msgFleschReadingEase'] = 'Điểm dễ đọc';
$PMF_LANG['msgFleschScaleHint'] = '0-29: Rất khó | 30-49: Khó | 50-59: Khá khó | 60-69: Tiêu chuẩn | 70-79: Khá dễ | 80-89: Dễ | 90-100: Rất dễ';
$PMF_LANG['msgFleschTooltip'] = 'Điểm Flesch Reading Ease đo lường mức độ dễ đọc của văn bản. Điểm càng cao thì càng dễ đọc. Hãy đặt mục tiêu 60-70 cho đối tượng độc giả phổ thông.';
$PMF_LANG['msgGenerateVapidKeys'] = 'Tạo khóa VAPID';
$PMF_LANG['msgImprint'] = 'Thông tin pháp lý';
$PMF_LANG['msgNoTranslationProvider'] = 'Chưa cấu hình nhà cung cấp dịch vụ dịch thuật';
$PMF_LANG['msgOpenQuestion'] = 'Câu hỏi mở';
$PMF_LANG['msgOtherQuestionDesc'] = 'Còn một câu hỏi mở khác bằng ngôn ngữ khác:';
$PMF_LANG['msgOtherQuestionsDesc'] = 'Có tổng cộng %d câu hỏi mở khác bằng các ngôn ngữ khác:';
$PMF_LANG['msgPushNewFaq'] = 'Đã xuất bản câu hỏi thường gặp mới';
$PMF_LANG['msgPushNewQuestion'] = 'Đã gửi câu hỏi mở mới';
$PMF_LANG['msgPushNotifications'] = 'Thông báo đẩy';
$PMF_LANG['msgPushNotificationsDescription'] = 'Nhận thông báo trên trình duyệt khi có câu hỏi thường gặp mới được xuất bản hoặc câu hỏi mới được gửi.';
$PMF_LANG['msgPushNotificationsDisable'] = 'Tắt thông báo đẩy';
$PMF_LANG['msgPushNotificationsDisabled'] = 'Đã tắt thông báo đẩy';
$PMF_LANG['msgPushNotificationsEnable'] = 'Bật thông báo đẩy';
$PMF_LANG['msgPushNotificationsEnabled'] = 'Đã bật thông báo đẩy';
$PMF_LANG['msgPushNotificationsNotSupported'] = 'Trình duyệt của bạn không hỗ trợ thông báo đẩy';
$PMF_LANG['msgPushNotificationsPermissionDenied'] = 'Quyền thông báo đẩy đã bị từ chối';
$PMF_LANG['msgSignInWithKeycloak'] = 'Đăng nhập bằng Keycloak';
$PMF_LANG['msgStickyRemoved'] = 'Đã xóa thành công trạng thái "quan trọng".';
$PMF_LANG['msgTermsOfService'] = 'Điều khoản dịch vụ';
$PMF_LANG['msgThemeUploadNoZip'] = 'Vui lòng chọn một tệp ZIP để tải lên.';
$PMF_LANG['msgToggleSidebar'] = 'Bật/tắt thanh bên';
$PMF_LANG['msgTooltipUnstick'] = 'Xóa trạng thái quan trọng';
$PMF_LANG['msgTranslateWithAI'] = 'Dịch bằng AI';
$PMF_LANG['msgTranslating'] = 'Đang dịch...';
$PMF_LANG['msgTranslation'] = 'Bản dịch';
$PMF_LANG['msgTranslationError'] = 'Dịch thất bại';
$PMF_LANG['msgTranslationSuccess'] = 'Đã dịch hoàn tất thành công';
$PMF_LANG['msgUpdated'] = 'Đã cập nhật';
$PMF_LANG['msgVapidKeysError'] = 'Không thể tạo khóa VAPID.';
$PMF_LANG['msgVapidKeysGenerated'] = 'Khóa VAPID đã được tạo thành công.';
$PMF_LANG['oauthControlCenter'] = 'OAuth 2.0';
$PMF_LANG['permission::addpage'] = 'Thêm trang tùy chỉnh';
$PMF_LANG['permission::delpage'] = 'Xóa trang tùy chỉnh';
$PMF_LANG['permission::editpage'] = 'Chỉnh sửa trang tùy chỉnh';
$PMF_LANG['pushControlCenter'] = 'Đẩy';
$PMF_LANG['storage.testRedisConnection'] = 'Kiểm tra kết nối Redis';
$PMF_LANG['storageControlCenter'] = 'Lưu trữ';
