...
$PMF_LANG['ad_layout_mode_auto'] = 'Otomatik (ziyaretçinin sistem tercihini izle)';
$PMF_LANG['ad_layout_mode_dark'] = 'Koyu';
$PMF_LANG['ad_layout_mode_highContrast'] = 'Yüksek kontrast';
$PMF_LANG['ad_layout_mode_light'] = 'Açık';
$PMF_LANG['ad_menu_pages'] = 'Özel Sayfalar';
$PMF_LANG['ad_page_add'] = 'Özel Sayfa Ekle';
$PMF_LANG['ad_page_add_translation'] = 'Çeviri Ekle';
$PMF_LANG['ad_page_author_email'] = 'Yazar E-postası';
$PMF_LANG['ad_page_author_name'] = 'Yazar Adı';
$PMF_LANG['ad_page_content'] = 'Sayfa İçeriği';
$PMF_LANG['ad_page_created'] = 'Oluşturuldu';
$PMF_LANG['ad_page_del'] = 'Bu özel sayfayı silmek istediğinizden emin misiniz?';
$PMF_LANG['ad_page_delete'] = 'Sil';
$PMF_LANG['ad_page_delsuc'] = 'Özel sayfa başarıyla silindi.';
$PMF_LANG['ad_page_edit'] = 'Özel Sayfayı Düzenle';
$PMF_LANG['ad_page_existing_translations'] = 'Mevcut Çeviriler';
$PMF_LANG['ad_page_insertfail'] = 'Özel sayfa oluşturulurken bir hata oluştu.';
$PMF_LANG['ad_page_lang_cannot_change'] = 'Dil oluşturulduktan sonra değiştirilemez.';
$PMF_LANG['ad_page_no_available_languages'] = 'Bu sayfa için tüm mevcut dillerde çeviriler bulunmaktadır.';
$PMF_LANG['ad_page_nodata'] = 'Özel sayfa bulunamadı';
$PMF_LANG['ad_page_nodelete'] = 'Hayır';
$PMF_LANG['ad_page_original_language'] = 'Özgün Dil';
$PMF_LANG['ad_page_select_translation_language'] = 'Çeviri Dilini Seçin';
$PMF_LANG['ad_page_seo_description'] = 'SEO Meta Açıklaması';
$PMF_LANG['ad_page_seo_robots'] = 'Robots Yönergesi';
$PMF_LANG['ad_page_seo_title'] = 'SEO Başlığı';
$PMF_LANG['ad_page_set_active'] = 'Sayfayı etkinleştir';
$PMF_LANG['ad_page_slug'] = 'URL Kısaltması';
$PMF_LANG['ad_page_slug_exists'] = 'Bu kısaltma bu dil için zaten mevcut';
$PMF_LANG['ad_page_slug_help'] = 'Bu sayfa için URL dostu tanımlayıcı (ör. \'gizlilik-politikasi\')';
$PMF_LANG['ad_page_tab_content'] = 'İçerik';
$PMF_LANG['ad_page_tab_seo'] = 'SEO';
$PMF_LANG['ad_page_tab_settings'] = 'Ayarlar';
$PMF_LANG['ad_page_title'] = 'Sayfa Başlığı';
$PMF_LANG['ad_page_translate'] = 'Sayfayı Çevir';
$PMF_LANG['ad_page_update'] = 'Güncelle';
$PMF_LANG['ad_page_updated'] = 'Güncellendi';
$PMF_LANG['ad_page_updatefail'] = 'Özel sayfa güncellenirken bir hata oluştu.';
$PMF_LANG['ad_page_updatesuc'] = 'Özel sayfa başarıyla güncellendi.';
$PMF_LANG['ad_page_yesdelete'] = 'Evet, sil!';
$PMF_LANG['ad_pmf_news'] = 'phpMyFAQ Duyuruları';
$PMF_LANG['keycloakControlCenter'] = 'Keycloak';
$PMF_LANG['msgAboutThisPage'] = 'Bu sayfa hakkında';
$PMF_LANG['msgAccessibilityStatement'] = 'Hizmetlerin erişilebilirliği hakkında bilgi';
$PMF_LANG['msgAdminHeaderLdap'] = 'LDAP Yapılandırması';
$PMF_LANG['msgAdminLdapGroupSettings'] = 'LDAP Grup Ayarları';
$PMF_LANG['msgAdminLdapHealthCheck'] = 'LDAP Sağlık Kontrolü';
$PMF_LANG['msgAdminLdapMapping'] = 'LDAP Öznitelik Eşlemesi';
$PMF_LANG['msgAdminLdapOptions'] = 'LDAP Seçenekleri';
$PMF_LANG['msgAdminLdapServers'] = 'LDAP Sunucuları';
$PMF_LANG['msgAdminLdapSettings'] = 'LDAP Genel Ayarları';
$PMF_LANG['msgAdminLogExportCsv'] = 'Yönetici günlüklerini CSV olarak dışa aktar';
$PMF_LANG['msgAdminLogVerifyIntegrity'] = 'Bütünlüğü Doğrula';
$PMF_LANG['msgAttention'] = 'Dikkat!';
$PMF_LANG['msgChangeLanguageHint'] = 'Bu soruları işlemek için lütfen yönetim panelinde dili değiştirin.';
$PMF_LANG['msgChat'] = 'Mesajlar';
$PMF_LANG['msgChatConversations'] = 'Konuşmalar';
$PMF_LANG['msgChatNewConversation'] = 'Yeni konuşma';
$PMF_LANG['msgChatNoMessages'] = 'Henüz mesaj yok';
$PMF_LANG['msgChatSearchUsers'] = 'Kullanıcıları ara...';
$PMF_LANG['msgChatSelectConversation'] = 'Sohbete başlamak için bir konuşma seçin veya bir kullanıcı arayın';
$PMF_LANG['msgChatSend'] = 'Gönder';
$PMF_LANG['msgChatTypePlaceholder'] = 'Bir mesaj yazın...';
$PMF_LANG['msgCommentEditorHint'] = 'Yorumunuzu kalın, italik, listeler ve bağlantılarla biçimlendirmek için metin düzenleyicisini kullanabilirsiniz.';
$PMF_LANG['msgConfirmAction'] = 'Eylemi Onayla';
$PMF_LANG['msgConfirmUnstick'] = 'Bu kaydı önemli SSS\'ler listesinden gerçekten kaldırmak istiyor musunuz?';
$PMF_LANG['msgCookiePolicy'] = 'Çerez Politikası';
$PMF_LANG['msgCreated'] = 'Oluşturuldu';
$PMF_LANG['msgDeletePage'] = 'Özel Sayfayı Sil';
$PMF_LANG['msgEmailTo'] = 'Şuna e-posta gönder';
$PMF_LANG['msgFleschNotCalculated'] = 'Hesaplamak için yazmaya başlayın';
$PMF_LANG['msgFleschReadingEase'] = 'Okunabilirlik Puanı';
$PMF_LANG['msgFleschScaleHint'] = '0-29: Çok Zor | 30-49: Zor | 50-59: Oldukça Zor | 60-69: Standart | 70-79: Oldukça Kolay | 80-89: Kolay | 90-100: Çok Kolay';
$PMF_LANG['msgFleschTooltip'] = 'Flesch Okuma Kolaylığı puanı, metninizin ne kadar kolay okunduğunu ölçer. Yüksek puanlar daha kolay okuma anlamına gelir. Genel kitleler için 60-70 aralığını hedefleyin.';
$PMF_LANG['msgGenerateVapidKeys'] = 'VAPID Anahtarları Oluştur';
$PMF_LANG['msgImprint'] = 'Künye';
$PMF_LANG['msgNoTranslationProvider'] = 'Yapılandırılmış çeviri sağlayıcısı yok';
$PMF_LANG['msgOpenQuestion'] = 'Aktif soru';
$PMF_LANG['msgOtherQuestionDesc'] = 'Başka bir dilde bir aktif soru daha var:';
$PMF_LANG['msgOtherQuestionsDesc'] = 'Diğer dillerde toplam %d aktif soru daha var:';
$PMF_LANG['msgPushNewFaq'] = 'Yeni SSS yayınlandı';
$PMF_LANG['msgPushNewQuestion'] = 'Yeni aktif soru gönderildi';
$PMF_LANG['msgPushNotifications'] = 'Anlık Bildirimler';
$PMF_LANG['msgPushNotificationsDescription'] = 'Yeni SSS\'ler yayınlandığında veya sorular gönderildiğinde tarayıcı bildirimleri alın.';
$PMF_LANG['msgPushNotificationsDisable'] = 'Anlık bildirimleri devre dışı bırak';
$PMF_LANG['msgPushNotificationsDisabled'] = 'Anlık bildirimler devre dışı bırakıldı';
$PMF_LANG['msgPushNotificationsEnable'] = 'Anlık bildirimleri etkinleştir';
$PMF_LANG['msgPushNotificationsEnabled'] = 'Anlık bildirimler etkinleştirildi';
$PMF_LANG['msgPushNotificationsNotSupported'] = 'Anlık bildirimler tarayıcınız tarafından desteklenmiyor';
$PMF_LANG['msgPushNotificationsPermissionDenied'] = 'Anlık bildirim izni reddedildi';
$PMF_LANG['msgSignInWithKeycloak'] = 'Keycloak ile giriş yap';
$PMF_LANG['msgStickyRemoved'] = '"Önemli" durumu başarıyla kaldırıldı.';
$PMF_LANG['msgTermsOfService'] = 'Hizmet Şartları';
$PMF_LANG['msgThemeUploadNoZip'] = 'Lütfen yüklemek için bir ZIP dosyası seçin.';
$PMF_LANG['msgToggleSidebar'] = 'Kenar çubuğunu aç/kapat';
$PMF_LANG['msgTooltipUnstick'] = 'Önemli durumunu kaldır';
$PMF_LANG['msgTranslateWithAI'] = 'AI ile çevir';
$PMF_LANG['msgTranslating'] = 'Çevriliyor...';
$PMF_LANG['msgTranslation'] = 'Çeviri';
$PMF_LANG['msgTranslationError'] = 'Çeviri başarısız oldu';
$PMF_LANG['msgTranslationSuccess'] = 'Çeviri başarıyla tamamlandı';
$PMF_LANG['msgUpdated'] = 'Güncellendi';
$PMF_LANG['msgVapidKeysError'] = 'VAPID anahtarları oluşturulamadı.';
$PMF_LANG['msgVapidKeysGenerated'] = 'VAPID anahtarları başarıyla oluşturuldu.';
$PMF_LANG['oauthControlCenter'] = 'OAuth 2.0';
$PMF_LANG['permission::addpage'] = 'Özel sayfa ekle';
$PMF_LANG['permission::delpage'] = 'Özel sayfa sil';
$PMF_LANG['permission::editpage'] = 'Özel sayfa düzenle';
$PMF_LANG['pushControlCenter'] = 'Anlık Bildirim';
$PMF_LANG['storage.testRedisConnection'] = 'Redis bağlantısını test et';
$PMF_LANG['storageControlCenter'] = 'Depolama';
