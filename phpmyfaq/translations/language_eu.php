...
$PMF_LANG["msgMailCheck"] = "FAQerako erregistro berria dago!Mesedez, administratzailearen atala ikusi!";
...
$PMF_LANG["err_SaveEntries"] = "Beharrezko eremuak dira: zure izena, zure posta elektronikoaren helbidea, kategoria, goiburua eta zure erregistroa !  \n<a href=\"javascript:history.back();\">atzera itzuli</a>  \n";
$PMF_LANG["err_SaveComment"] = "Beharrezko eremuak dira zure izena , zure posta elektronikoaren helbidea eta zure iruzkinak!  \n<a href=\"javascript:history.back();\">itzuli volver atrás</a>  \n";
...
$PMF_LANG["err_noMailAdress"] = "Zure posta elektronikoa ez da zuzena. <a href=\"javascript:history.back();\">itzuli</a>";
$PMF_LANG["err_sendMail"] = "Beharrezko eremuak dira zure izena, zure posta elektronikoaren helbidea eta zure galdera!";

// Hilfe zur Suche
$PMF_LANG["help_search"] = "Erregistro bilaketa: ";
...
$PMF_LANG["msgHeaderCategoryOverview"] = "Atala editatu";
...
$PMF_LANG["msgKeywords"] = "Hitz gakoak";
$PMF_LANG["msgAuthor"] = "Egilea";
...
$PMF_LANG["msgCategoryRemark"] = "Kontuan izan, mesedez, dauden erregistroak ez direla gehiago azalduko maila ezabatzen baduzu. Atal berri bat esleitu beharko zenioke artikuluari edo, bestela, artikulua ezabatu.";
...
$PMF_LANG["ad_passwd_remark"] = "ADI:  Ez da oraindik Cookie-rik ezarri!";
...
$PMF_LANG["msgHeaderCategoryOverview"] = "Atalen administrazioa";
$PMF_LANG["ad_menu_stat"] = "Botuen estatistikak";
$PMF_LANG["msgAddCategory"] = "Atala gehitu";
...
$PMF_LANG['permission::add_user'] = "erabiltzailea gehitu";
$PMF_LANG['permission::edit_user'] = "erabiltzailea editatu";
$PMF_LANG['permission::delete_user'] = "erabiltzailea ezabatu";
$PMF_LANG['permission::add_faq'] = "erregistroa gehitu";
$PMF_LANG['permission::edit_faq'] = "erregistroa editatu";
$PMF_LANG['permission::delete_faq'] = "erregistroa ezabatu";
$PMF_LANG['permission::viewlog'] = "loga ikusi";
$PMF_LANG['permission::adminlog'] = "admin-loga ikusi";
$PMF_LANG['permission::delcomment'] = "iruzkina ezabatu";
$PMF_LANG['permission::addnews'] = "albisteak gehitu";
$PMF_LANG['permission::editnews'] = "albisteak editatu";
$PMF_LANG['permission::delnews'] = "albisteak ezabatu";
$PMF_LANG['permission::addcateg'] = "atala gehitu";
$PMF_LANG['permission::editcateg'] = "atala editatu";
$PMF_LANG['permission::delcateg'] = "atala ezabatu";
$PMF_LANG['permission::passwd'] = "pasahitza aldatu";
$PMF_LANG['permission::editconfig'] = "konfigurazioa editatu";
$PMF_LANG['permission::addatt'] = "eranskinak gehitu";
$PMF_LANG['permission::delatt'] = "eranskinak ezabatu";
$PMF_LANG['permission::backup'] = "backup egin";
$PMF_LANG['permission::restore'] = "backup berrezarri";
$PMF_LANG['permission::delquestion'] = "galdera irekiak ezabatu";
$PMF_LANG['permission::changebtrevs'] = "Berrikuspenak editatu";
...
$PMF_LANG["err_SaveQuestion"] = "Beharrezko eremuak dira Zure izena, Posta elektronikoa eta  zure galdera !  <a href=\"javascript:history.back();\">itzuli</a>  ";

// added v1.4.0 - 2003-12-04 by Thorsten / Mathias
$LANG_CONF['main.language'] = array("select", "Fitxategientzat lehenetsitako hizkuntza");
$LANG_CONF["main.languageDetection"] = array("checkbox", "Edukien kudeaketa automatikoa gaitu");
...
$LANG_CONF["main.enableAdminLog"] = array("checkbox", "Adminlog-a erabili?");
$LANG_CONF["security.ipCheck"] = array("checkbox", "Nahi al duzu IP-ak aztertzea UIN-ak egiaztatzean?");
...
$PMF_LANG['ad_entry_solution_id'] = 'Konponbide ID bakarra';
$PMF_LANG['ad_entry_faq_record'] = 'FAQ erregistroa';
$PMF_LANG['ad_entry_new_revision'] = 'Berrikuspena berria sortu?';
$PMF_LANG['ad_entry_record_administration'] = 'Erregistro administrazioa';
$PMF_LANG['msgRevision'] = 'Berrikuspena';
$PMF_LANG['ad_changerev'] = 'Berrikuspena aukeratu';
$PMF_LANG['msgCaptcha'] = "Mesedez sartu captcha kodea";
$PMF_LANG['msgSelectCategories'] = 'Bilatu hemen ...';
$PMF_LANG['msgAllCategories'] = '... kategoria guztietan';
$PMF_LANG['ad_you_should_update'] = 'Zure phpMyFAQ instalazioa zaharkitua dago. Eskuragarri dagoen azken bertsiora eguneratu beharko zenuke.';
$PMF_LANG['msgAdvancedSearch'] = 'Bilaketa aurreratua';

// added v1.6.1 - 2006-04-25 by Matteo and Thorsten
$PMF_LANG['spamControlCenter'] = 'Spam kontrol gunea';
$LANG_CONF["spam.enableSafeEmail"] = ["checkbox", "Inprimatu erabiltzailearen emaila modu seguruan."];
$LANG_CONF["spam.checkBannedWords"] = ["checkbox", "Egiaztatu formulario publikoen edukia debekatutako hitzen aurka."];
$LANG_CONF["spam.enableCaptchaCode"] = ["checkbox", "Erabili captcha kodea formulario publikoak bidaltzeko."];
$PMF_LANG['ad_session_expiring'] = 'Zure saioa %d minututan iraungiko da: lanean jarraitu nahi duzu?';

// added v1.6.2 - 2006-06-13 by Matteo
$PMF_LANG['ad_stat_management'] = 'Saioen kudeaketa';
$PMF_LANG['ad_stat_choose'] = 'Hilabetea aukeratu';
$PMF_LANG['ad_stat_delete'] = 'Hautatutako saioak berehala ezabatu?';

// added v2.0.0 - 2005-09-15 by Thorsten and by Minoru TODA
$PMF_LANG['ad_menu_glossary'] = 'FAQ Glosarioa';
$PMF_LANG['ad_glossary_add'] = 'Glosario sarrera gehitu';
$PMF_LANG['ad_glossary_edit'] = 'Glosario sarrera editatu';
$PMF_LANG['ad_glossary_item'] = 'Izenburua';
$PMF_LANG['ad_glossary_definition'] = 'Definizioa';
$PMF_LANG['ad_glossary_save'] = 'Glosarioa gorde';
$PMF_LANG['ad_glossary_save_success'] = 'Glosario sarrera arrakastaz gorde da!';
$PMF_LANG['ad_glossary_save_error'] = 'Glosario sarrera ezin izan da gorde errore bat gertatu delako.';
$PMF_LANG['ad_glossary_update_success'] = 'Glosario sarrera arrakastaz eguneratu da!';
$PMF_LANG['ad_glossary_update_error'] = 'Glosario sarrera ezin izan da eguneratu errore bat gertatu delako.';
$PMF_LANG['ad_glossary_delete'] = 'Sarrera ezabatu';
$PMF_LANG['ad_glossary_delete_success'] = 'Glosario sarrera arrakastaz ezabatu da!';
$PMF_LANG['ad_glossary_delete_error'] = 'Glosario sarrera ezin izan da ezabatu errore bat gertatu delako.';
$PMF_LANG['msgNewQuestionVisible'] = 'Galdera lehenengo berrikusi behar da publikoa izan baino lehen.';
$PMF_LANG['msgQuestionsWaiting'] = 'Administratzaileek argitaratzeko zain: ';
$PMF_LANG['ad_entry_visibility'] = 'argitaratuta';
$PMF_LANG['ad_entry_not_visibility'] = "argitaratu gabe";

// added v2.0.0 - 2006-01-02 by Lars
$PMF_LANG['ad_user_error_password'] = "Mesedez sartu pasahitz bat. ";
$PMF_LANG['ad_user_error_passwordsDontMatch'] = "Pasahitzak ez datoz bat. ";
$PMF_LANG['ad_user_error_loginInvalid'] = "Zehaztutako erabiltzaile izena baliogabea da.";
$PMF_LANG['ad_user_error_noEmail'] = "Mesedez sartu baliozko email helbide bat. ";
$PMF_LANG['ad_user_error_noRealName'] = "Mesedez sartu zure benetako izena. ";
$PMF_LANG['ad_user_error_delete'] = "Erabiltzaile kontua ezin izan da ezabatu. ";
$PMF_LANG['ad_user_error_noId'] = "Ez da ID-rik zehaztu. ";
$PMF_LANG['ad_user_error_protectedAccount'] = "Erabiltzaile kontua babestuta dago. ";
$PMF_LANG['ad_user_deleteUser'] = "Erabiltzailea ezabatu";
$PMF_LANG['ad_user_status'] = "Egoera";
$PMF_LANG['ad_user_lastModified'] = "azken aldaketa";
$PMF_LANG['ad_gen_cancel'] = "Utzi";
$PMF_LANG['permission::addglossary'] = "Glosario elementua gehitu";
$PMF_LANG['permission::editglossary'] = "Glosario elementua editatu";
$PMF_LANG['permission::delglossary'] = "Glosario elementua ezabatu";
$PMF_LANG["ad_menu_group_administration"] = "Taldeak";
$PMF_LANG['ad_user_loggedin'] = 'Saioa hasita honela: ';
$PMF_LANG['ad_group_details'] = "Taldearen xehetasunak";
$PMF_LANG['ad_group_add'] = "Taldea gehitu";
$PMF_LANG['ad_group_add_link'] = "Taldea gehitu";
$PMF_LANG['ad_group_name'] = "Izena";
$PMF_LANG['ad_group_description'] = "Deskripzioa";
$PMF_LANG['ad_group_autoJoin'] = "Automatikoki elkartu";
$PMF_LANG['ad_group_suc'] = "Taldea arrakastaz gehitu da.";
$PMF_LANG['ad_group_error_noName'] = "Mesedez sartu talde izen bat. ";
$PMF_LANG['ad_group_error_delete'] = "Taldea ezin izan da ezabatu. ";
$PMF_LANG['ad_group_deleted'] = "Taldea arrakastaz ezabatu da.";
$PMF_LANG['ad_group_deleteGroup'] = "Taldea ezabatu";
$PMF_LANG['ad_group_deleteQuestion'] = "Ziur zaude talde hau ezabatu nahi duzula?";
$PMF_LANG['ad_user_uncheckall'] = "Dena desautatu";
$PMF_LANG['ad_group_membership'] = "Talde kidetzak";
$PMF_LANG['ad_group_members'] = "Kideak";
$PMF_LANG['ad_group_addMember'] = "+";
$PMF_LANG['ad_group_removeMember'] = "-";

// added v2.0.0 - 2006-07-20 by Matteo
$PMF_LANG['ad_export_which_cat'] = 'Esportatu beharreko FAQ datuak mugatu (aukerakoa)';
$PMF_LANG['ad_export_cat_downwards'] = 'Azpikategoriak sartu?';
$PMF_LANG['ad_export_type'] = 'Esportaziorako formatua';
$PMF_LANG['ad_export_type_choose'] = 'Onartutako formatuak:';
$PMF_LANG['ad_export_download_view'] = 'Deskargatu edo lineaz ikusi?';
$PMF_LANG['ad_export_download'] = 'deskargatu';
$PMF_LANG['ad_export_view'] = 'lineaz ikusi';

// added v2.0.0 - 2006-07-22 by Matteo
$PMF_LANG['ad_news_data'] = 'FAQ Albisteak';
$PMF_LANG['ad_news_author_name'] = 'Egilearen izena:';
$PMF_LANG['ad_news_author_email'] = 'Egilearen emaila:';
$PMF_LANG['ad_news_set_active'] = 'Aktibatu';
$PMF_LANG['ad_news_allowComments'] = 'Iruzkinak onartu:';
$PMF_LANG['ad_news_expiration_window'] = 'Albisteen iraungitze denboraren leihoa (aukerakoa)';
$PMF_LANG['ad_news_from'] = 'Nondik:';
$PMF_LANG['ad_news_to'] = 'Nora:';
$PMF_LANG['ad_news_insertfail'] = 'Errore bat gertatu da albiste sarrera datu basean txertatzerakoan.';
$PMF_LANG['ad_news_updatefail'] = 'Errore bat gertatu da albiste sarrera datu basean eguneratzerakoan.';
$PMF_LANG['newsShowCurrent'] = 'Uneko albisteak erakutsi.';
$PMF_LANG['newsShowArchive'] = 'Artxibatutako albisteak erakutsi.';
$PMF_LANG['newsArchive'] = ' Albiste artxiboa';
$PMF_LANG['newsWriteComment'] = 'sarrera honi buruz iruzkindu';
$PMF_LANG['newsCommentDate'] = 'Gehitua: ';

// added v2.0.0 - 2006-07-29 by Matteo & Thorsten
$PMF_LANG['ad_record_expiration_window'] = 'Erregistroaren iraungitze denboraren leihoa (aukerakoa)';
$PMF_LANG['adminHeaderDashboard'] = 'Aginte panela';
$PMF_LANG['admin_mainmenu_users'] = 'Erabiltzaileak';
$PMF_LANG['admin_mainmenu_content'] = 'Edukia';
$PMF_LANG['admin_mainmenu_statistics'] = 'Estatistikak';
$PMF_LANG['admin_mainmenu_backup'] = 'Babes-kopia';
$PMF_LANG['admin_mainmenu_configuration'] = 'Konfigurazioa';
$PMF_LANG['admin_mainmenu_logout'] = 'Saioa itxi';

// added v2.0.0 - 2006-08-15 by Thorsten and Matteo
$PMF_LANG["categoryOwnerLabel"] = 'Kategoriaren jabea';
$PMF_LANG['adminSection'] = 'Administrazioa';
$PMF_LANG['err_expiredArticle'] = 'Sarrera hau iraungi egin da eta ezin da bistaratu';
$PMF_LANG['err_expiredNews'] = 'Albiste sarrera hau iraungi egin da eta ezin da bistaratu';
$PMF_LANG['err_inactiveNews'] = 'Albiste sarrera hau berrikuspena egiten ari da eta ezin da bistaratu';
$PMF_LANG['msgSearchOnAllLanguages'] = 'hizkuntza guztietan bilatu';
$PMF_LANG['msgTags'] = 'Etiketak';
...
$PMF_LANG['ad_layout_mode_auto'] = 'Automatikoa (jarraitu bisitariaren sistemaren hobespena)';
$PMF_LANG['ad_layout_mode_dark'] = 'Iluna';
$PMF_LANG['ad_layout_mode_highContrast'] = 'Kontraste handikoa';
$PMF_LANG['ad_layout_mode_light'] = 'Argia';
$PMF_LANG['ad_menu_pages'] = 'Orri pertsonalizatuak';
$PMF_LANG['ad_page_add'] = 'Gehitu orri pertsonalizatua';
$PMF_LANG['ad_page_add_translation'] = 'Gehitu itzulpena';
$PMF_LANG['ad_page_author_email'] = 'Egilearen posta helbidea';
$PMF_LANG['ad_page_author_name'] = 'Egilearen izena';
$PMF_LANG['ad_page_content'] = 'Orriaren edukia';
$PMF_LANG['ad_page_created'] = 'Sortuta';
$PMF_LANG['ad_page_del'] = 'Ziur zaude orri pertsonalizatu hau ezabatu nahi duzula?';
$PMF_LANG['ad_page_delete'] = 'Ezabatu';
$PMF_LANG['ad_page_delsuc'] = 'Orri pertsonalizatua ongi ezabatu da.';
$PMF_LANG['ad_page_edit'] = 'Editatu orri pertsonalizatua';
$PMF_LANG['ad_page_existing_translations'] = 'Lehendik dauden itzulpenak';
$PMF_LANG['ad_page_insertfail'] = 'Errore bat gertatu da orri pertsonalizatua sortzean.';
$PMF_LANG['ad_page_lang_cannot_change'] = 'Hizkuntza ezin da aldatu sortu ondoren.';
$PMF_LANG['ad_page_no_available_languages'] = 'Eskuragarri dauden hizkuntza guztiek dute orri honen itzulpena.';
$PMF_LANG['ad_page_nodata'] = 'Ez da orri pertsonalizaturik aurkitu';
$PMF_LANG['ad_page_nodelete'] = 'Ez';
$PMF_LANG['ad_page_original_language'] = 'Jatorrizko hizkuntza';
$PMF_LANG['ad_page_select_translation_language'] = 'Hautatu itzulpenaren hizkuntza';
$PMF_LANG['ad_page_seo_description'] = 'SEO meta deskribapena';
$PMF_LANG['ad_page_seo_robots'] = 'Robots direktiba';
$PMF_LANG['ad_page_seo_title'] = 'SEO izenburua';
$PMF_LANG['ad_page_set_active'] = 'Aktibatu orria';
$PMF_LANG['ad_page_slug'] = 'URL slug-a';
$PMF_LANG['ad_page_slug_exists'] = 'Slug hau lehendik dago hizkuntza honetarako';
$PMF_LANG['ad_page_slug_help'] = 'Orri honetarako URL-arekin bateragarria den identifikatzailea (adib., \'pribatutasun-politika\')';
$PMF_LANG['ad_page_tab_content'] = 'Edukia';
$PMF_LANG['ad_page_tab_seo'] = 'SEO';
$PMF_LANG['ad_page_tab_settings'] = 'Ezarpenak';
$PMF_LANG['ad_page_title'] = 'Orriaren izenburua';
$PMF_LANG['ad_page_translate'] = 'Itzuli orria';
$PMF_LANG['ad_page_update'] = 'Eguneratu';
$PMF_LANG['ad_page_updated'] = 'Eguneratuta';
$PMF_LANG['ad_page_updatefail'] = 'Errore bat gertatu da orri pertsonalizatua eguneratzean.';
$PMF_LANG['ad_page_updatesuc'] = 'Orri pertsonalizatua ongi eguneratu da.';
$PMF_LANG['ad_page_yesdelete'] = 'Bai, ezabatu!';
$PMF_LANG['ad_pmf_news'] = 'phpMyFAQ Berriak';
$PMF_LANG['keycloakControlCenter'] = 'Keycloak';
$PMF_LANG['msgAboutThisPage'] = 'Orri honi buruz';
$PMF_LANG['msgAccessibilityStatement'] = 'Zerbitzuen irisgarritasunari buruzko informazioa';
$PMF_LANG['msgAdminHeaderLdap'] = 'LDAP konfigurazioa';
$PMF_LANG['msgAdminLdapGroupSettings'] = 'LDAP talde ezarpenak';
$PMF_LANG['msgAdminLdapHealthCheck'] = 'LDAP osasun egiaztapena';
$PMF_LANG['msgAdminLdapMapping'] = 'LDAP atributuen mapaketa';
$PMF_LANG['msgAdminLdapOptions'] = 'LDAP aukerak';
$PMF_LANG['msgAdminLdapServers'] = 'LDAP zerbitzariak';
$PMF_LANG['msgAdminLdapSettings'] = 'LDAP ezarpen orokorrak';
$PMF_LANG['msgAdminLogExportCsv'] = 'Esportatu admin-logak CSV gisa';
$PMF_LANG['msgAdminLogVerifyIntegrity'] = 'Egiaztatu osotasuna';
$PMF_LANG['msgAttention'] = 'Kontuz!';
$PMF_LANG['msgChangeLanguageHint'] = 'Aldatu hizkuntza administrazioan galdera hauek prozesatzeko.';
$PMF_LANG['msgChat'] = 'Mezuak';
$PMF_LANG['msgChatConversations'] = 'Elkarrizketak';
$PMF_LANG['msgChatNewConversation'] = 'Elkarrizketa berria';
$PMF_LANG['msgChatNoMessages'] = 'Oraindik mezurik ez';
$PMF_LANG['msgChatSearchUsers'] = 'Bilatu erabiltzaileak...';
$PMF_LANG['msgChatSelectConversation'] = 'Hautatu elkarrizketa bat edo bilatu erabiltzaile bat elkarrizketan hasteko';
$PMF_LANG['msgChatSend'] = 'Bidali';
$PMF_LANG['msgChatTypePlaceholder'] = 'Idatzi mezu bat...';
$PMF_LANG['msgCommentEditorHint'] = 'Testu editorea erabil dezakezu zure iruzkina lodiz, etzanez, zerrendekin eta estekekin formateatzeko.';
$PMF_LANG['msgConfirmAction'] = 'Berretsi ekintza';
$PMF_LANG['msgConfirmUnstick'] = 'Benetan kendu nahi duzu sarrera hau FAQ garrantzitsuen zerrendatik?';
$PMF_LANG['msgCookiePolicy'] = 'Cookie politika';
$PMF_LANG['msgCreated'] = 'Sortuta';
$PMF_LANG['msgDeletePage'] = 'Ezabatu orri pertsonalizatua';
$PMF_LANG['msgEmailTo'] = 'Posta helbidea hartzailea';
$PMF_LANG['msgFleschNotCalculated'] = 'Hasi idazten kalkulatzeko';
$PMF_LANG['msgFleschReadingEase'] = 'Irakurgarritasun puntuazioa';
$PMF_LANG['msgFleschScaleHint'] = '0-29: Oso zaila | 30-49: Zaila | 50-59: Nahiko zaila | 60-69: Estandarra | 70-79: Nahiko erraza | 80-89: Erraza | 90-100: Oso erraza';
$PMF_LANG['msgFleschTooltip'] = 'Flesch irakurgarritasun puntuazioak zure testua zein erraz irakurtzen den neurtzen du. Puntuazio altuagoek irakurketa errazagoa esan nahi dute. Saiatu 60-70 lortzen publiko orokorrarentzat.';
$PMF_LANG['msgGenerateVapidKeys'] = 'Sortu VAPID gakoak';
$PMF_LANG['msgImprint'] = 'Lege oharra';
$PMF_LANG['msgNoTranslationProvider'] = 'Ez da itzulpen hornitzailerik konfiguratu';
$PMF_LANG['msgOpenQuestion'] = 'Galdera irekia';
$PMF_LANG['msgOtherQuestionDesc'] = 'Beste hizkuntza batean galdera ireki bat gehiago dago:';
$PMF_LANG['msgOtherQuestionsDesc'] = 'Beste hizkuntzetan guztira %d galdera ireki gehiago daude:';
$PMF_LANG['msgPushNewFaq'] = 'FAQ berria argitaratu da';
$PMF_LANG['msgPushNewQuestion'] = 'Galdera ireki berria bidali da';
$PMF_LANG['msgPushNotifications'] = 'Push jakinarazpenak';
$PMF_LANG['msgPushNotificationsDescription'] = 'Jaso nabigatzaileko jakinarazpenak FAQ berriak argitaratzen direnean edo galderak bidaltzen direnean.';
$PMF_LANG['msgPushNotificationsDisable'] = 'Desgaitu push jakinarazpenak';
$PMF_LANG['msgPushNotificationsDisabled'] = 'Push jakinarazpenak desgaituta';
$PMF_LANG['msgPushNotificationsEnable'] = 'Gaitu push jakinarazpenak';
$PMF_LANG['msgPushNotificationsEnabled'] = 'Push jakinarazpenak gaituta';
$PMF_LANG['msgPushNotificationsNotSupported'] = 'Zure nabigatzaileak ez ditu push jakinarazpenak onartzen';
$PMF_LANG['msgPushNotificationsPermissionDenied'] = 'Push jakinarazpenen baimena ukatu da';
$PMF_LANG['msgSignInWithKeycloak'] = 'Hasi saioa Keycloak-ekin';
$PMF_LANG['msgStickyRemoved'] = '"Garrantzitsua" egoera ongi kendu da.';
$PMF_LANG['msgTermsOfService'] = 'Zerbitzu baldintzak';
$PMF_LANG['msgThemeUploadNoZip'] = 'Hautatu ZIP fitxategi bat kargatzeko.';
$PMF_LANG['msgToggleSidebar'] = 'Txandakatu alboko barra';
$PMF_LANG['msgTooltipUnstick'] = 'Kendu garrantzitsua egoera';
$PMF_LANG['msgTranslateWithAI'] = 'Itzuli AI-rekin';
$PMF_LANG['msgTranslating'] = 'Itzultzen...';
$PMF_LANG['msgTranslation'] = 'Itzulpena';
$PMF_LANG['msgTranslationError'] = 'Itzulpenak huts egin du';
$PMF_LANG['msgTranslationSuccess'] = 'Itzulpena ongi osatu da';
$PMF_LANG['msgUpdated'] = 'Eguneratuta';
$PMF_LANG['msgVapidKeysError'] = 'Ezin izan dira VAPID gakoak sortu.';
$PMF_LANG['msgVapidKeysGenerated'] = 'VAPID gakoak ongi sortu dira.';
$PMF_LANG['oauthControlCenter'] = 'OAuth 2.0';
$PMF_LANG['permission::addpage'] = 'Gehitu orri pertsonalizatuak';
$PMF_LANG['permission::delpage'] = 'Ezabatu orri pertsonalizatuak';
$PMF_LANG['permission::editpage'] = 'Editatu orri pertsonalizatuak';
$PMF_LANG['pushControlCenter'] = 'Push';
$PMF_LANG['storage.testRedisConnection'] = 'Probatu Redis konexioa';
$PMF_LANG['storageControlCenter'] = 'Biltegiratzea';
