...
$PMF_LANG['err_SaveEntries'] = 'ข้อมูลที่จำเป็น ชื่อ, อีเมล์, หัวข้อ, ชื่อเรื่อง, ข้อมูลของคุณ และ รหัสตัวอักษร<a href="https://en.wikipedia.org/wiki/Captcha" title="รายละเอียดเกี่ยวกับ Captcha ใน Wikipedia" target="_blank">Captcha</a>!<br><br><a href="nojavascript...history.back();">ย้อนกลับ</a><br><br>';
$PMF_LANG['err_SaveComment'] = 'ข้อมูลที่จำเป็น ชื่อ, อีเมล์, ความเห็น และ รหัสตัวอักษร <a href="https://en.wikipedia.org/wiki/Captcha" title="รายละเอียดเกี่ยวกับ Captcha ใน Wikipedia" target="_blank">Captcha</a>!<br><br><a href="nojavascript...history.back();">ย้อนกลับ</a><br><br>';
...
$PMF_LANG['help_search'] = 'ค้นหาข้อมูล:<br>ที่ตรงกับ <strong style="color: Red;">คำที่1 คำที่2 คุณสามารถหาข้อมูลที่ตรงความต้องการได้มากที่สุด หากระบุคำที่ต้องการมากว่า 2 คำขึ้นไปคำแนะนำ: คุณจะต้องระบุคำที่มีความยาวมากกว่า 4 ตัวอักษรเท่านั้น';
...
$PMF_LANG['ad_passwd_remark'] = 'คำเตือน:<br>คุกกี้ไม่สามารถแก้ไขได้!';
...
$PMF_LANG['err_SaveQuestion'] = 'ข้อมูลที่จำเป็น ชื่อ, อีเมล์, คำถาม และ รหัสตัวอักษร <a href="https://en.wikipedia.org/wiki/Captcha" title="รายละเอียดเกี่ยวกับ Captcha ใน Wikipedia" target="_blank">Captcha</a><br><br><a href="nojavascript...history.back();">ย้อนกลับ</a><br><br>';
