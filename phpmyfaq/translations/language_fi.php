...
$PMF_LANG['msgAboutFAQ'] = 'Tietoja tästä kysymyksestä';
...
$PMF_LANG['ad_record_inactive'] = 'Julkaisemattomat FAQ:t';
...
$PMF_LANG['ad_layout_mode_auto'] = 'Automaattinen (noudata kävijän järjestelmäasetusta)';
$PMF_LANG['ad_layout_mode_dark'] = 'Tumma';
$PMF_LANG['ad_layout_mode_highContrast'] = 'Suuri kontrasti';
$PMF_LANG['ad_layout_mode_light'] = 'Vaalea';
$PMF_LANG['ad_menu_pages'] = 'Mukautetut sivut';
$PMF_LANG['ad_page_add'] = 'Lisää mukautettu sivu';
$PMF_LANG['ad_page_add_translation'] = 'Lisää käännös';
$PMF_LANG['ad_page_author_email'] = 'Laatijan sähköposti';
$PMF_LANG['ad_page_author_name'] = 'Laatijan nimi';
$PMF_LANG['ad_page_content'] = 'Sivun sisältö';
$PMF_LANG['ad_page_created'] = 'Luotu';
$PMF_LANG['ad_page_del'] = 'Haluatko varmasti poistaa tämän mukautetun sivun?';
$PMF_LANG['ad_page_delete'] = 'Poista';
$PMF_LANG['ad_page_delsuc'] = 'Mukautettu sivu on poistettu onnistuneesti.';
$PMF_LANG['ad_page_edit'] = 'Muokkaa mukautettua sivua';
$PMF_LANG['ad_page_existing_translations'] = 'Olemassa olevat käännökset';
$PMF_LANG['ad_page_insertfail'] = 'Mukautetun sivun luonnissa tapahtui virhe.';
$PMF_LANG['ad_page_lang_cannot_change'] = 'Kieltä ei voi vaihtaa luonnin jälkeen.';
$PMF_LANG['ad_page_no_available_languages'] = 'Tällä sivulla on käännökset kaikille saatavilla oleville kielille.';
$PMF_LANG['ad_page_nodata'] = 'Mukautettuja sivuja ei löytynyt';
$PMF_LANG['ad_page_nodelete'] = 'Ei';
$PMF_LANG['ad_page_original_language'] = 'Alkuperäinen kieli';
$PMF_LANG['ad_page_select_translation_language'] = 'Valitse käännöksen kieli';
$PMF_LANG['ad_page_seo_description'] = 'SEO-metakuvaus';
$PMF_LANG['ad_page_seo_robots'] = 'Robots-direktiivi';
$PMF_LANG['ad_page_seo_title'] = 'SEO-otsikko';
$PMF_LANG['ad_page_set_active'] = 'Aktivoi sivu';
$PMF_LANG['ad_page_slug'] = 'URL-tunnus';
$PMF_LANG['ad_page_slug_exists'] = 'Tämä tunnus on jo olemassa tällä kielellä';
$PMF_LANG['ad_page_slug_help'] = 'URL-ystävällinen tunniste tälle sivulle (esim. \'tietosuojakaytanto\')';
$PMF_LANG['ad_page_tab_content'] = 'Sisältö';
$PMF_LANG['ad_page_tab_seo'] = 'SEO';
$PMF_LANG['ad_page_tab_settings'] = 'Asetukset';
$PMF_LANG['ad_page_title'] = 'Sivun otsikko';
$PMF_LANG['ad_page_translate'] = 'Käännä sivu';
$PMF_LANG['ad_page_update'] = 'Päivitä';
$PMF_LANG['ad_page_updated'] = 'Päivitetty';
$PMF_LANG['ad_page_updatefail'] = 'Mukautetun sivun päivityksessä tapahtui virhe.';
$PMF_LANG['ad_page_updatesuc'] = 'Mukautettu sivu on päivitetty onnistuneesti.';
$PMF_LANG['ad_page_yesdelete'] = 'Kyllä, poista!';
$PMF_LANG['ad_pmf_news'] = 'phpMyFAQ-uutiset';
$PMF_LANG['keycloakControlCenter'] = 'Keycloak';
$PMF_LANG['msgAboutThisPage'] = 'Tietoja tästä sivusta';
$PMF_LANG['msgAccessibilityStatement'] = 'Tietoa palveluiden saavutettavuudesta';
$PMF_LANG['msgAdminHeaderLdap'] = 'LDAP-määritykset';
$PMF_LANG['msgAdminLdapGroupSettings'] = 'LDAP-ryhmäasetukset';
$PMF_LANG['msgAdminLdapHealthCheck'] = 'LDAP-tilatarkistus';
$PMF_LANG['msgAdminLdapMapping'] = 'LDAP-attribuuttien kartoitus';
$PMF_LANG['msgAdminLdapOptions'] = 'LDAP-valinnat';
$PMF_LANG['msgAdminLdapServers'] = 'LDAP-palvelimet';
$PMF_LANG['msgAdminLdapSettings'] = 'LDAP:n yleiset asetukset';
$PMF_LANG['msgAdminLogExportCsv'] = 'Vie ylläpitolokit CSV-muodossa';
$PMF_LANG['msgAdminLogVerifyIntegrity'] = 'Tarkista eheys';
$PMF_LANG['msgAttention'] = 'Huomio!';
$PMF_LANG['msgChangeLanguageHint'] = 'Vaihda kieli ylläpidossa käsitelläksesi nämä kysymykset.';
$PMF_LANG['msgChat'] = 'Viestit';
$PMF_LANG['msgChatConversations'] = 'Keskustelut';
$PMF_LANG['msgChatNewConversation'] = 'Uusi keskustelu';
$PMF_LANG['msgChatNoMessages'] = 'Ei vielä viestejä';
$PMF_LANG['msgChatSearchUsers'] = 'Hae käyttäjiä...';
$PMF_LANG['msgChatSelectConversation'] = 'Valitse keskustelu tai hae käyttäjää aloittaaksesi keskustelun';
$PMF_LANG['msgChatSend'] = 'Lähetä';
$PMF_LANG['msgChatTypePlaceholder'] = 'Kirjoita viesti...';
$PMF_LANG['msgCommentEditorHint'] = 'Voit käyttää tekstieditoria muotoillaksesi kommenttisi lihavoinnilla, kursivoinnilla, luetteloilla ja linkeillä.';
$PMF_LANG['msgConfirmAction'] = 'Vahvista toiminto';
$PMF_LANG['msgConfirmUnstick'] = 'Haluatko varmasti poistaa tämän tietueen tärkeiden UKK:iden listalta?';
$PMF_LANG['msgCookiePolicy'] = 'Evästekäytäntö';
$PMF_LANG['msgCreated'] = 'Luotu';
$PMF_LANG['msgDeletePage'] = 'Poista mukautettu sivu';
$PMF_LANG['msgEmailTo'] = 'Sähköposti vastaanottajalle';
$PMF_LANG['msgFleschNotCalculated'] = 'Aloita kirjoittaminen laskeaksesi';
$PMF_LANG['msgFleschReadingEase'] = 'Luettavuuspisteet';
$PMF_LANG['msgFleschScaleHint'] = '0-29: Erittäin vaikea | 30-49: Vaikea | 50-59: Melko vaikea | 60-69: Tavallinen | 70-79: Melko helppo | 80-89: Helppo | 90-100: Erittäin helppo';
$PMF_LANG['msgFleschTooltip'] = 'Flesch-luettavuuspistemäärä mittaa, kuinka helppoa tekstiäsi on lukea. Korkeammat pisteet tarkoittavat helpompaa luettavuutta. Tavoittele 60-70 yleisölle.';
$PMF_LANG['msgGenerateVapidKeys'] = 'Luo VAPID-avaimet';
$PMF_LANG['msgImprint'] = 'Julkaisutiedot';
$PMF_LANG['msgNoTranslationProvider'] = 'Käännöspalveluntarjoajaa ei ole määritetty';
$PMF_LANG['msgOpenQuestion'] = 'Avoin kysymys';
$PMF_LANG['msgOtherQuestionDesc'] = 'Toisella kielellä on yksi avoin kysymys lisää:';
$PMF_LANG['msgOtherQuestionsDesc'] = 'Muilla kielillä on yhteensä %d avointa kysymystä lisää:';
$PMF_LANG['msgPushNewFaq'] = 'Uusi UKK julkaistu';
$PMF_LANG['msgPushNewQuestion'] = 'Uusi avoin kysymys lähetetty';
$PMF_LANG['msgPushNotifications'] = 'Push-ilmoitukset';
$PMF_LANG['msgPushNotificationsDescription'] = 'Vastaanota selainilmoituksia, kun uusia UKK:ita julkaistaan tai kysymyksiä lähetetään.';
$PMF_LANG['msgPushNotificationsDisable'] = 'Poista push-ilmoitukset käytöstä';
$PMF_LANG['msgPushNotificationsDisabled'] = 'Push-ilmoitukset poistettu käytöstä';
$PMF_LANG['msgPushNotificationsEnable'] = 'Ota push-ilmoitukset käyttöön';
$PMF_LANG['msgPushNotificationsEnabled'] = 'Push-ilmoitukset otettu käyttöön';
$PMF_LANG['msgPushNotificationsNotSupported'] = 'Selaimesi ei tue push-ilmoituksia';
$PMF_LANG['msgPushNotificationsPermissionDenied'] = 'Push-ilmoitusten käyttölupa evättiin';
$PMF_LANG['msgSignInWithKeycloak'] = 'Kirjaudu sisään Keycloakilla';
$PMF_LANG['msgStickyRemoved'] = '"Tärkeä"-tila poistettu onnistuneesti.';
$PMF_LANG['msgTermsOfService'] = 'Käyttöehdot';
$PMF_LANG['msgThemeUploadNoZip'] = 'Valitse ZIP-tiedosto ladattavaksi.';
$PMF_LANG['msgToggleSidebar'] = 'Näytä/piilota sivupalkki';
$PMF_LANG['msgTooltipUnstick'] = 'Poista tärkeä-tila';
$PMF_LANG['msgTranslateWithAI'] = 'Käännä tekoälyllä';
$PMF_LANG['msgTranslating'] = 'Käännetään...';
$PMF_LANG['msgTranslation'] = 'Käännös';
$PMF_LANG['msgTranslationError'] = 'Käännös epäonnistui';
$PMF_LANG['msgTranslationSuccess'] = 'Käännös valmistui onnistuneesti';
$PMF_LANG['msgUpdated'] = 'Päivitetty';
$PMF_LANG['msgVapidKeysError'] = 'VAPID-avainten luonti epäonnistui.';
$PMF_LANG['msgVapidKeysGenerated'] = 'VAPID-avaimet on luotu onnistuneesti.';
$PMF_LANG['oauthControlCenter'] = 'OAuth 2.0';
$PMF_LANG['permission::addpage'] = 'Lisää mukautettuja sivuja';
$PMF_LANG['permission::delpage'] = 'Poista mukautettuja sivuja';
$PMF_LANG['permission::editpage'] = 'Muokkaa mukautettuja sivuja';
$PMF_LANG['pushControlCenter'] = 'Push';
$PMF_LANG['storage.testRedisConnection'] = 'Testaa Redis-yhteys';
$PMF_LANG['storageControlCenter'] = 'Tallennustila';
