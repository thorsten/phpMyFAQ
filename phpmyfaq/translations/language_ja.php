...
$PMF_LANG['msgAboutFAQ'] = 'この FAQ について';
...
$PMF_LANG['ad_layout_mode_auto'] = '自動 (訪問者のシステム設定に従う)';
$PMF_LANG['ad_layout_mode_dark'] = 'ダーク';
$PMF_LANG['ad_layout_mode_highContrast'] = 'ハイコントラスト';
$PMF_LANG['ad_layout_mode_light'] = 'ライト';
$PMF_LANG['ad_menu_pages'] = 'カスタムページ';
$PMF_LANG['ad_page_add'] = 'カスタムページの追加';
$PMF_LANG['ad_page_add_translation'] = '翻訳の追加';
$PMF_LANG['ad_page_author_email'] = '作成者のメールアドレス';
$PMF_LANG['ad_page_author_name'] = '作成者名';
$PMF_LANG['ad_page_content'] = 'ページの内容';
$PMF_LANG['ad_page_created'] = '作成日';
$PMF_LANG['ad_page_del'] = 'このカスタムページを本当に削除しますか?';
$PMF_LANG['ad_page_delete'] = '削除';
$PMF_LANG['ad_page_delsuc'] = 'カスタムページを正常に削除しました。';
$PMF_LANG['ad_page_edit'] = 'カスタムページの編集';
$PMF_LANG['ad_page_existing_translations'] = '既存の翻訳';
$PMF_LANG['ad_page_insertfail'] = 'カスタムページの作成中にエラーが発生しました。';
$PMF_LANG['ad_page_lang_cannot_change'] = '作成後に言語を変更することはできません。';
$PMF_LANG['ad_page_no_available_languages'] = '利用可能なすべての言語にこのページの翻訳があります。';
$PMF_LANG['ad_page_nodata'] = 'カスタムページが見つかりません';
$PMF_LANG['ad_page_nodelete'] = 'いいえ';
$PMF_LANG['ad_page_original_language'] = '元の言語';
$PMF_LANG['ad_page_select_translation_language'] = '翻訳言語の選択';
$PMF_LANG['ad_page_seo_description'] = 'SEO メタディスクリプション';
$PMF_LANG['ad_page_seo_robots'] = 'ロボット ディレクティブ';
$PMF_LANG['ad_page_seo_title'] = 'SEO タイトル';
$PMF_LANG['ad_page_set_active'] = 'ページを有効にする';
$PMF_LANG['ad_page_slug'] = 'URL スラッグ';
$PMF_LANG['ad_page_slug_exists'] = 'このスラッグはこの言語で既に存在します';
$PMF_LANG['ad_page_slug_help'] = 'このページの URL に適した識別子 (例: \'privacy-policy\')';
$PMF_LANG['ad_page_tab_content'] = '内容';
$PMF_LANG['ad_page_tab_seo'] = 'SEO';
$PMF_LANG['ad_page_tab_settings'] = '設定';
$PMF_LANG['ad_page_title'] = 'ページタイトル';
$PMF_LANG['ad_page_translate'] = 'ページの翻訳';
$PMF_LANG['ad_page_update'] = '更新';
$PMF_LANG['ad_page_updated'] = '更新日';
$PMF_LANG['ad_page_updatefail'] = 'カスタムページの更新中にエラーが発生しました。';
$PMF_LANG['ad_page_updatesuc'] = 'カスタムページを正常に更新しました。';
$PMF_LANG['ad_page_yesdelete'] = 'はい、削除します!';
$PMF_LANG['ad_pmf_news'] = 'phpMyFAQ ニュース';
$PMF_LANG['keycloakControlCenter'] = 'Keycloak';
$PMF_LANG['msgAboutThisPage'] = 'このページについて';
$PMF_LANG['msgAccessibilityStatement'] = 'サービスのアクセシビリティに関する情報';
$PMF_LANG['msgAdminHeaderLdap'] = 'LDAP 構成';
$PMF_LANG['msgAdminLdapGroupSettings'] = 'LDAP グループ設定';
$PMF_LANG['msgAdminLdapHealthCheck'] = 'LDAP ヘルスチェック';
$PMF_LANG['msgAdminLdapMapping'] = 'LDAP 属性マッピング';
$PMF_LANG['msgAdminLdapOptions'] = 'LDAP オプション';
$PMF_LANG['msgAdminLdapServers'] = 'LDAP サーバー';
$PMF_LANG['msgAdminLdapSettings'] = 'LDAP 全般設定';
$PMF_LANG['msgAdminLogExportCsv'] = '管理者ログを CSV としてエクスポート';
$PMF_LANG['msgAdminLogVerifyIntegrity'] = '整合性を検証';
$PMF_LANG['msgAttention'] = '注意!';
$PMF_LANG['msgChangeLanguageHint'] = 'これらの質問を処理するには、管理者ページで言語を変更してください。';
$PMF_LANG['msgChat'] = 'メッセージ';
$PMF_LANG['msgChatConversations'] = '会話';
$PMF_LANG['msgChatNewConversation'] = '新しい会話';
$PMF_LANG['msgChatNoMessages'] = 'まだメッセージがありません';
$PMF_LANG['msgChatSearchUsers'] = 'ユーザーを検索...';
$PMF_LANG['msgChatSelectConversation'] = '会話を選択するか、ユーザーを検索してチャットを開始してください';
$PMF_LANG['msgChatSend'] = '送信';
$PMF_LANG['msgChatTypePlaceholder'] = 'メッセージを入力...';
$PMF_LANG['msgCommentEditorHint'] = 'テキストエディターを使用して、太字、斜体、リスト、リンクでコメントを書式設定できます。';
$PMF_LANG['msgConfirmAction'] = '操作の確認';
$PMF_LANG['msgConfirmUnstick'] = 'このエントリーを重要な FAQ の一覧から本当に削除しますか?';
$PMF_LANG['msgCookiePolicy'] = 'クッキーポリシー';
$PMF_LANG['msgCreated'] = '作成日';
$PMF_LANG['msgDeletePage'] = 'カスタムページの削除';
$PMF_LANG['msgEmailTo'] = 'メール送信先';
$PMF_LANG['msgFleschNotCalculated'] = '入力を開始すると計算されます';
$PMF_LANG['msgFleschReadingEase'] = '読みやすさスコア';
$PMF_LANG['msgFleschScaleHint'] = '0-29: 非常に難しい | 30-49: 難しい | 50-59: やや難しい | 60-69: 標準 | 70-79: やや易しい | 80-89: 易しい | 90-100: 非常に易しい';
$PMF_LANG['msgFleschTooltip'] = 'Flesch リーディングイーズスコアは、テキストの読みやすさを測定します。スコアが高いほど読みやすくなります。一般的な読者には 60-70 を目指してください。';
$PMF_LANG['msgGenerateVapidKeys'] = 'VAPID キーを生成';
$PMF_LANG['msgImprint'] = '発行者情報';
$PMF_LANG['msgNoTranslationProvider'] = '翻訳プロバイダーが構成されていません';
$PMF_LANG['msgOpenQuestion'] = '未処理の質問';
$PMF_LANG['msgOtherQuestionDesc'] = '他の言語でもう 1 件の未処理の質問があります:';
$PMF_LANG['msgOtherQuestionsDesc'] = '他の言語で合計 %d 件の未処理の質問があります:';
$PMF_LANG['msgPushNewFaq'] = '新しい FAQ が公開されました';
$PMF_LANG['msgPushNewQuestion'] = '新しい未処理の質問が送信されました';
$PMF_LANG['msgPushNotifications'] = 'プッシュ通知';
$PMF_LANG['msgPushNotificationsDescription'] = '新しい FAQ が公開されたとき、または質問が送信されたときにブラウザー通知を受け取ります。';
$PMF_LANG['msgPushNotificationsDisable'] = 'プッシュ通知を無効にする';
$PMF_LANG['msgPushNotificationsDisabled'] = 'プッシュ通知が無効になりました';
$PMF_LANG['msgPushNotificationsEnable'] = 'プッシュ通知を有効にする';
$PMF_LANG['msgPushNotificationsEnabled'] = 'プッシュ通知が有効になりました';
$PMF_LANG['msgPushNotificationsNotSupported'] = 'お使いのブラウザーはプッシュ通知をサポートしていません';
$PMF_LANG['msgPushNotificationsPermissionDenied'] = 'プッシュ通知の許可が拒否されました';
$PMF_LANG['msgSignInWithKeycloak'] = 'Keycloak でサインイン';
$PMF_LANG['msgStickyRemoved'] = '「重要」ステータスを正常に削除しました。';
$PMF_LANG['msgTermsOfService'] = '利用規約';
$PMF_LANG['msgThemeUploadNoZip'] = 'アップロードする ZIP ファイルを選択してください。';
$PMF_LANG['msgToggleSidebar'] = 'サイドバーの切り替え';
$PMF_LANG['msgTooltipUnstick'] = '重要ステータスを削除';
$PMF_LANG['msgTranslateWithAI'] = 'AI で翻訳';
$PMF_LANG['msgTranslating'] = '翻訳中...';
$PMF_LANG['msgTranslation'] = '翻訳';
$PMF_LANG['msgTranslationError'] = '翻訳に失敗しました';
$PMF_LANG['msgTranslationSuccess'] = '翻訳が正常に完了しました';
$PMF_LANG['msgUpdated'] = '更新日';
$PMF_LANG['msgVapidKeysError'] = 'VAPID キーの生成に失敗しました。';
$PMF_LANG['msgVapidKeysGenerated'] = 'VAPID キーが正常に生成されました。';
$PMF_LANG['oauthControlCenter'] = 'OAuth 2.0';
$PMF_LANG['permission::addpage'] = 'カスタムページの追加';
$PMF_LANG['permission::delpage'] = 'カスタムページの削除';
$PMF_LANG['permission::editpage'] = 'カスタムページの編集';
$PMF_LANG['pushControlCenter'] = 'プッシュ';
$PMF_LANG['storage.testRedisConnection'] = 'Redis 接続をテスト';
$PMF_LANG['storageControlCenter'] = 'ストレージ';
