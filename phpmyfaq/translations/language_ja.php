...
$PMF_LANG['msgHelpText'] = 'このFAQ (Frequently Asked Questions) の利用方法が簡単です。<a href="?action=show">カテゴリー</a> から関連内容を項目別に探すか <a href="?action=search">検索</a> からキーワードを入力して探すことができます。';
...
$PMF_LANG['ad_entry_savedfail   '] = 'データベースのエラーが発生しました。';
...
$PMF_LANG['ad_entry_savedfail'] = 'データベースエラーが発生しました。';
...
$PMF_LANG['cacheControlCenter'] = 'キャッシュ設定';
