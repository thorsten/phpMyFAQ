...
$PMF_LANG['err_SaveEntries'] = '名前、メールアドレス、カテゴリー、件名、FAQ 内容、要求された場合は <a href="https://ja.wikipedia.org/wiki/Captcha" title="Wikipedia で Captcha について読む" target="_blank">Captcha</a> コード は必須フィールドです!<br><br><a href="javascript:history.back();">戻る</a><br><br>';
$PMF_LANG['err_SaveComment'] = '名前、メールアドレス、コメントと要求された場合は <a href="https://ja.wikipedia.org/wiki/Captcha" title="Wikipedia で Captcha について読む" target="_blank">Captcha</a> コード は必須項目です!<br><br><a href="javascript:history.back();">戻る</a><br><br>';
...
$PMF_LANG['help_search'] = '内容検索: <br><strong style="color: Red;">言葉1 言葉2のように検索すると、2 個以上の検索結果が関連度が高い順番で表示されます。注意: 英文を検索する際には、少なくとも 4 文字以上を入力してください。';
$PMF_LANG['ad'] = '管理者ページ';
...
$PMF_LANG['ad_passwd_remark'] = '注意:<br>もう一度Cookieを設定してください。';
...
$PMF_LANG['err_SaveQuestion'] = '名前、メールアドレス、質問と要求された場合は <a href="https://ja.wikipedia.org/wiki/Captcha" title="Wikipedia で Captcha について読む" target="_blank">Captcha</a> コード は必須項目です。<br><br><a href="javascript:history.back();">戻る</a><br><br>';
