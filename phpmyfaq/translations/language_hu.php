...
$PMF_LANG['msgVoteUsability'] = 'Kérlek osztályozd a bejegyzést:';
...
$PMF_LANG['msgShareFAQ'] = 'Küld el a barátaidnak';
...
$PMF_LANG['msgAskThx4Mail'] = 'Köszönjük a leveledet!';
...
$PMF_LANG['msgHelpText'] = 'A GYIK (GYakran Ismételt Kérdések) használata meglehetősen egyszerű. Kereshetsz a <a href=\"?action=show\">kategóriákban</a> vagy <a href=\"?action=search\">kulcsszavakra</a>.';
...
$PMF_LANG['msgErrorNoRecords'] = 'Nincsenek bejegyzések.';
$PMF_LANG['err_badID'] = 'Rossz ID.';
$PMF_LANG['err_noTopTen'] = 'Még nincs TOP 10.';
$PMF_LANG['err_nothingFound'] = 'Nincs bejegyzés.';
$PMF_LANG['err_SaveEntries'] = 'Kötelező mezők: név, email, kategória, cím és a kérdés!  <a href="javascript:history.back();">egy oldal vissza</a>  ';
$PMF_LANG['err_SaveComment'] = 'Required fields are your name, your email address and your comments!  <a href="javascript:history.back();">one page back</a>  ';
$PMF_LANG['err_VoteTooMuch'] = 'We do not count double votings. Click here, to go back.';
$PMF_LANG['err_noVote'] = 'You did not rate the question! <a href="javascript:history.back();">Please click here</a>, to vote.';
$PMF_LANG['err_noMailAdress'] = 'E-mail cím helytelen <a href="javascript:history.back();">vissza</a>';
$PMF_LANG['err_sendMail'] = 'Kötelező mezők: név, email és a kérdés!';
$PMF_LANG['help_search'] = 'Találatok: ';
...
$PMF_LANG['msgHeaderCategoryOverview'] = 'Kategória szerkesztése';
...
$PMF_LANG['ad_msg_mysqlerr'] = 'Adatbázis hiba miatt a profilt nem lehet tárolni.';
...
$PMF_LANG['msgHeaderFAQOverview'] = 'Bejegyzések szerkesztése';
...
$PMF_LANG['ad_entry_commentdelsuc '] = 'A megjegyzés sikeresen törölve.';
$PMF_LANG['ad_entry_back'] = 'Vissza';
$PMF_LANG['ad_entry_commentdelfail '] = 'A megjegyzés nem lett törölve.';
$PMF_LANG['ad_entry_savedsuc'] = 'A változások sikeresen tárolva.';
$PMF_LANG['ad_entry_savedfail'] = 'Hiba az adatbázis elérésében.';
$PMF_LANG['ad_entry_del_1'] = 'Biztos hogy a téma [';
$PMF_LANG['ad_entry_del_2'] = '][';
$PMF_LANG['ad_entry_del_3'] = '] törölhető?';
$PMF_LANG['ad_entry_delsuc'] = 'Bejegyzés sikeresen törölve.';
$PMF_LANG['ad_entry_delfail'] = 'A bejegyzés nem lett törölve!';
$PMF_LANG['ad_news_header'] = 'A hír címe';
$PMF_LANG['ad_news_text'] = 'A hír szövege';
$PMF_LANG['ad_news_link_url'] = 'Link: (https:// nélkül)!';
...
$PMF_LANG['msgNewCategory'] = 'Kategória hozzáadása';
...
$PMF_LANG['msgCategoryRemark'] = 'A meglévő bejegyzések nem lesznek elérhetőek ha törlöd a kategóriát. Új kategóriát kell hozzárendelned a bejegyzéshez, vagy törölni azt.';
...
$PMF_LANG['ad_passwd_remark'] = 'FIGYELEM: A cookiet újra be kell állítani!';
...
$PMF_LANG['msgAddFAQ'] = 'Bejegyzés létrehozása';
...
$PMF_LANG['msgAddCategory'] = 'kategória hozzáadása';
...
$PMF_LANG['msgComments'] = 'Megjegyzések';
...
$PMF_LANG['msgNoPermission'] = 'Nem vagy bejelentkezve.';
...
$PMF_LANG['permission::add_user'] = 'felhasználó hozzáadása';
$PMF_LANG['permission::edit_user'] = 'felhasználó szerkesztése';
$PMF_LANG['permission::delete_user'] = 'felhasználó törlése';
$PMF_LANG['permission::add_faq'] = 'bejegyzés hozzáadása';
$PMF_LANG['permission::edit_faq'] = 'bejegyzés szerkesztése';
$PMF_LANG['permission::delete_faq'] = 'bejegyzés törlése';
$PMF_LANG['permission::viewlog'] = 'log megnézése';
$PMF_LANG['permission::adminlog'] = 'admin log megnézése';
$PMF_LANG['permission::delcomment'] = 'megjegyzés törlése';
$PMF_LANG['permission::addnews'] = 'hír hozzáadása';
$PMF_LANG['permission::editnews'] = 'hír szerkesztése';
$PMF_LANG['permission::delnews'] = 'hír törlése';
$PMF_LANG['permission::addcateg'] = 'kategória hozzáadása';
$PMF_LANG['permission::editcateg'] = 'kategória szerkesztése';
$PMF_LANG['permission::delcateg'] = 'kategória törlése';
$PMF_LANG['permission::passwd'] = 'jelszó megváltoztatása';
$PMF_LANG['permission::editconfig'] = 'beállítások szerkesztése';
$PMF_LANG['permission::addatt'] = 'fájl csatolása';
$PMF_LANG['permission::delatt'] = 'csatolt fájl törlése';
$PMF_LANG['permission::backup'] = 'backup készítése';
$PMF_LANG['permission::restore'] = 'backup visszaállítása';
...
$PMF_LANG['msgRealname'] = 'teljes név:';
...
$PMF_LANG['err_SaveQuestion'] = 'A kötelező mezők: neved, email címed és a kérdésed.  <a href="nojavascript...history.back();">egy oldalt visszak</a>  ';
$PMF_LANG['ad_entry_fontcolor'] = 'Betű szín: ';
$PMF_LANG['ad_entry_fontsize'] = 'Betű méret: ';
$LANG_CONF['main.language'] = array('select', 'Nyelvi File');
...
$LANG_CONF['records.maxAttachmentSize'] = array('input', 'a csatolmányok maximum mérete byte-ban (max. %sByte)');
$LANG_CONF['records.disableAttachments'] = array('checkbox', 'Link the attachments below the entries?');
$LANG_CONF['main.enableUserTracking'] = array('checkbox', 'követés');
$LANG_CONF['main.enableAdminLog'] = array('checkbox', 'Adminlog');
...
$PMF_LANG['msgNewCategory_main_cat'] = 'mint új főkategória';
...
$PMF_LANG['msgButtonFetchLatestVersion'] = 'Ellenőrizzük a legfrissebb phpMyFAQ verziót';
...
$PMF_LANG['msgOnlineVerificationCheckButton'] = 'phpMyFAQ ellenőrzése';
...
$PMF_LANG['msgAdminSearchFaqs'] = 'Keresés a bejegyzések között';
...
$PMF_LANG['msgAttachments'] = 'FAQ csatolmányok';
...
$PMF_LANG['msgAttachmentsDeleted'] = 'Csatolmány sikeresen törölve.';
...
$LANG_CONF['security.ssoSupport'] = array('checkbox', 'Single Sign On támogatás(alapértelmezetten:kikapcsolva)');
$LANG_CONF['security.ssoLogoutRedirect'] = array('input', 'Single Sign On logout redirect service URL');
$LANG_CONF['main.dateFormat'] = array('input', 'Dátum formátum (alapértelmezett: Y-m-d H:i)');
...
$PMF_LANG['msgEditFaqDate'] = 'szerkeszt';
...
$PMF_LANG['permission::addtranslation'] = 'fordítás hozzáadása';
$PMF_LANG['permission::edittranslation'] = 'fordítás szerkesztése';
$PMF_LANG['permission::deltranslation'] = 'fordítás törlése';
...
$PMF_LANG['msgAdminElasticsearchStats'] = 'Keresési statisztika';
...
$PMF_LANG['adminHeaderComments'] = 'Komment adminisztráció';
...
$LANG_CONF['spam.enableCaptchaCode'] = array('checkbox', 'Use a captcha code to allow public form submission (default: enabled).');
...
$PMF_LANG['permission::addglossary'] = 'új szójegyzék elem';
...
$PMF_LANG['adminHeaderDashboard'] = 'Műszerfal';
...
$PMF_LANG['msgCategoryMatrix'] = 'Kategória áttekintése';
...
$PMF_LANG['msgGroupPermissions'] = 'Csoport engedélyek:';
$LANG_CONF['records.numberOfRelatedArticles'] = array('input', 'Number of related entries');
$PMF_LANG['msgAccessAllUsers'] = 'Minden felhasználó hozzáférhet';
$PMF_LANG['ad_entry_restricted_users'] = 'Hozzáférés megtiltva: ';
$PMF_LANG['msgAccessAllGroups'] = 'Minden csoport hozzáférése';
