...
$PMF_LANG['help_search'] = 'Pesquisa de artigos:<br>Usando uma expressão do tipo <strong style="color: red;">palavra1 palavra2 pode obter resultados por relevância descendente para dois ou mais critérios de pesquisa.Nota: A expressão a pesquisar tem que ter pelo menos 4 carateres, caso contrário será ignorada<br><small>(no caso de uma sigla com três carateres acrescente um espaco no final)</small>.';
...
$PMF_LANG['msgCategoryRemark'] = 'Atenção : Quando uma categoria é eliminada os seus artigos deixam de ser visíveis.<br>É necessário atribuir-lhes previamente outra categoria para os manter (caso contrário deve apagá-los).';
...
$PMF_LANG['ad_adminlog'] = 'Registo de Administração <small>(AdminLog )</small>';
...
$PMF_LANG['ad_passwd_remark'] = 'Atenção:<br>Tem que adicionar novamente o cookie.';
...
$PMF_LANG['ad_adus_name'] = 'Nome <small>(login)</small>:';
...
$PMF_LANG['ad_att_nope'] = '<small>Nota: só é possível inserir anexos em registos já gravados e apenas no modo de edição.</small>';
...
$PMF_LANG['ad_csv_restore'] = 'Através deste formulário pode repor o conteúdo da base de dados usando um backup efetuado previamente pelo phpMyFAQ.<br>Atenção: os dados existentes serão apagados.';
...
$PMF_LANG['msgRealname'] = 'Nome <small>(completo)</small>:';
...
$LANG_CONF['records.maxAttachmentSize'] = array('input', 'Tamanho máximo do anexo em Bytes <small>(máx.: %sByte)</small>');
...
$LANG_CONF['main.referenceURL'] = array('input', 'URL-base para verificação de links <small>( ex.: https://www.example.org/faq/ )</small>');
...
$PMF_LANG['msgNewCategory_main_cat'] = ' como uma nova categoria principal <small>(i.e., de topo)</small>';
...
$LANG_CONF['spam.enableSafeEmail'] = array('checkbox', 'Mostrar o e-mail do utilizador de forma segura <small>(pré-definição: ativo)</small>');
$LANG_CONF['spam.checkBannedWords'] = array('checkbox', 'Verificar o conteúdo dos formulários públicos usando a lista de stop words <small>(pré-definição: ativo)</small>');
$LANG_CONF['spam.enableCaptchaCode'] = array('checkbox', 'Usar catpcha para permitir o envio de formulários públicos <small>(pré-definição: ativo)</small>');
...
$PMF_LANG['ad_export_download_view'] = 'Transferir <small>("descarregar")</small> ou ver no browser?';
...
$PMF_LANG['ad_news_author_email'] = 'Autor <small>(e-mail)</small>:';
...
$PMF_LANG['msgNewTranslationAddon'] = 'A sua proposta não será publicada imediatamente mas será avaliada pelos editores. Os campos obrigatórios são: Nome, E-mail, Cabeçalho <small>(tema)</small> traduzido e Conteúdo traduzido. As palavras-chave têm que ser separadas por vírgulas.';
...
$LANG_CONF['records.orderby'] = array('select', 'Ordenação dos registos <small>(de acordo com as propriedades)</small>');
$LANG_CONF['records.sortby'] = array('select', 'Ordenação dos registos <small>(ascendente ou descendente)</small>');
...
$LANG_CONF['records.defaultActivation'] = array('checkbox', 'Ativar automaticamente os novos registos <small>(pré-definição: desativada)</small>');
$LANG_CONF['records.defaultAllowComments'] = array('checkbox', 'Permitir comentários nos novos registos <small>(pré-definição: desativada)</small>');
...
$PMF_LANG['msgUsername'] = 'Nome <small>(de login)</small>:';
...
$LANG_CONF['main.enableWysiwygEditor'] = array('checkbox', 'Ativar o editor gráfico incluído <small>(pré-definição: ativo)</small>');
...
$LANG_CONF['records.attachmentsPath'] = array('input', 'Path para o local de gravação de anexos.<br><small>Um path relativo refere-se a uma pasta dentro do web root</small>');
...
$LANG_CONF['layout.templateSet'] = array('select', 'Conjunto de Modelos <small>(Templates)</small> a usar');
...
$LANG_CONF['records.defaultAttachmentEncKey'] = array('input', 'Chave pré-definida para cifragem (encriptação) dos anexos <br><small>(não será usada caso a opção de encriptação de anexos se encontrar desativada).</small><br><small style="color: red">Atenção: Não alterar depois da chave ter sido definida e a opção de encriptação de anexos ter sido ativada.</small>');
...
$LANG_CONF['security.useSslForLogins'] = array('checkbox', 'Permitir a validação <small>(login )</small> apenas no modo seguro? - <small>HTTPS</small> <small>(pré-definição: desativada)</small>');
...
$PMF_LANG['msgRegistrationCredentials'] = 'Para se registar é necessário indicar o seu Nome <small>(real)</small>, o Username desejado <small>(login)</small> e um E-mail válido.';
...
$LANG_CONF['security.ssoSupport'] = array('checkbox', 'Single Sign On Support - SSO <small>(pré-definição: desativado)</small>');
$LANG_CONF['security.ssoLogoutRedirect'] = array('input', 'SSO logout redirect service URL');
$LANG_CONF['main.dateFormat'] = array('input', 'Formato da Data e Hora <small>(pré-definição: Y-m-d H:i<br>ex.: 2011-12-31 13:00)</small>');
$LANG_CONF['security.enableLoginOnly'] = array('checkbox', 'Acesso restrito ao conteúdo - <small>Complete secured FAQ</small> <small>(pré-definição: desativado)</small>');
...
$LANG_CONF['security.useSslOnly'] = array('checkbox', 'FAQ apenas via SSL <small>(pré-definição: desativado)</small>');
...
$PMF_LANG['cacheControlCenter'] = 'Cache - configuração';
$PMF_LANG['msgAdminSearchFaqs'] = 'Pesquisar artigos <small>(tipo FAQ)</small>';
...
$LANG_CONF['records.randomSort'] = array('checkbox', 'Ordenar os registos de FAQ de forma aleatória <small>(pré-definição: desativado)</small>');
$LANG_CONF['main.enableWysiwygEditorFrontend'] = array('checkbox', 'Ativar o editor gráfico incluído no modo frontend <small>(pré-definição: desativado)</small>');
$LANG_CONF['main.enableGravatarSupport'] = array('checkbox', 'Gravatar - suporte <small>(pré-definição: desativado)</small>');
...
$PMF_LANG['ad_instance_admin'] = 'Administração - username <small>(login)</small>';
