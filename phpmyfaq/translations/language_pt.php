...
$PMF_LANG['msgCategoryRemark'] = '<strong>Atenção</strong> : Quando uma categoria é eliminada os seus artigos <em>deixam</em> de ser visíveis.<br>É necessário atribuir-lhes previamente <em>outra</em> categoria para os <em>manter</em> (caso contrário deve apagá-los).';
...
$PMF_LANG['msgNoPermission'] = '<strong>Não possui autorização</strong> para realizar esta operação.';
...
$PMF_LANG['permission::viewlog'] = 'ver <em>logs</em>';
$PMF_LANG['permission::adminlog'] = 'ver o <em>admin log</em>';
...
$PMF_LANG['permission::passwd'] = 'alterar a <em>password</em>';
...
$PMF_LANG['permission::backup'] = 'criar <em>backup</em>';
$PMF_LANG['permission::restore'] = 'repor <em>backup</em>';
...
$PMF_LANG['msgEmail'] = '<em>E-mail</em>:';
...
$LANG_CONF['main.send2friendText'] = array('area', 'Texto para a página <em>send2friend</em>');
$LANG_CONF['records.maxAttachmentSize'] = array('input', 'Tamanho máximo do anexo em Bytes <small><strong>(máx.: %sByte)</strong></small>');
$LANG_CONF['records.disableAttachments'] = array('checkbox', 'Colocar <em>links</em> para anexos por baixo das entradas?');
$LANG_CONF['main.enableUserTracking'] = array('checkbox', 'Usar <em>Tracking</em>?');
$LANG_CONF['main.enableAdminLog'] = array('checkbox', 'Usar o <em>Adminlog</em>?');
...
$LANG_CONF['spam.enableSafeEmail'] = array('checkbox', 'Mostrar o <em>e-mail</em> do utilizador de forma segura <small>(pré-definição: ativo)</small>');
$LANG_CONF['spam.checkBannedWords'] = array('checkbox', 'Verificar o conteúdo dos formulários públicos usando a lista de <em>stop words</em> <small>(pré-definição: ativo)</small>');
$LANG_CONF['spam.enableCaptchaCode'] = array('checkbox', 'Usar <em>catpcha</em> para permitir o envio de formulários públicos <small>(pré-definição: ativo)</small>');
...
$PMF_LANG['categoryOwnerLabel'] = '<em>Owner</em> da Categoria';
...
$PMF_LANG['msgCategoryRemark_overview'] = '<em>Nota</em>: só se pode obter e apresentar a <em>ordenação correta</em> das categorias caso <em>todas existam</em> no idioma atual (primeira coluna).';
...
$LANG_CONF['records.orderby'] = array('select', 'Ordenação dos registos <small>(de acordo com as <strong>propriedades</strong>)</small>');
...
$PMF_LANG['msgOnlineVersionCheck'] = 'Verificação <em>on-line</em> da versão mais recente do phpMyFAQ';
$PMF_LANG['ad_system_info'] = 'Informação sobre o Sistema';
$PMF_LANG['msgRegisterUser'] = 'Deseja registar-se?';
$PMF_LANG['msgUsername'] = 'Nome <small>(de <em>login</em>)</small>:';
...
$LANG_CONF['records.attachmentsPath'] = array('input', '<em>Path</em> para o local de gravação de anexos.<br><small>Um <em>path</em> relativo refere-se a uma pasta dentro do <em>web root</em></small>');
...
$LANG_CONF['layout.templateSet'] = array('select', 'Conjunto de Modelos <small>(<em>Templates</em>)</small> a usar');
...
$LANG_CONF['security.ssoSupport'] = array('checkbox', '<em>Single Sign On Support - SSO</em> <small>(pré-definição: desativado)</small>');
$LANG_CONF['security.ssoLogoutRedirect'] = array('input', '<em>SSO logout redirect service URL</em>');
$LANG_CONF['main.dateFormat'] = array('input', 'Formato da Data e Hora <small>(pré-definição: Y-m-d H:i<br>ex.: 2011-12-31 13:00)</small>');
$LANG_CONF['security.enableLoginOnly'] = array('checkbox', 'Acesso restrito ao conteúdo - <small><em>Complete secured FAQ</em></small> <small>(pré-definição: desativado)</small>');
...
$PMF_LANG['msgOnlineVerificationCheck'] = 'Verificação <em>on-line</em> do phpMyFAQ instalado';
...
$LANG_CONF['main.enableWysiwygEditorFrontend'] = array('checkbox', 'Ativar o editor gráfico incluído no modo <em>frontend</em> <small>(pré-definição: desativado)</small>');
$LANG_CONF['main.enableGravatarSupport'] = array('checkbox', '<em>Gravatar</em> - suporte <small>(pré-definição: desativado)</small>');
