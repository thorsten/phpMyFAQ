...
$PMF_LANG["msgAskThx4Mail"] = "Terima kasih atas pertanyaan anda!";
...
$PMF_LANG["err_SaveEntries"] = "Bagian yang harus diisi adalah Nama Anda, Alamat Email, Kategori, Pengantar, Isi Materi dan, jika diminta, kode <a href=\"https://id.wikipedia.org/wiki/CAPTCHA\" title=\"lebih lanjut tentang Captcha di Wikipedia\" target=\"_blank\">Captcha</a>!  <a href=\"javascript:history.back();\">mundur satu halaman</a>  ";
$PMF_LANG["err_SaveComment"] = "Bagian yang harus diisi adalah Nama Anda, Alamat Email, Isi Komentar dan, jika diminta, kode <a href=\"https://id.wikipedia.org/wiki/CAPTCHA\" title=\"lebih lanjut tentang Captcha di Wikipedia\" target=\"_blank\">Captcha</a>!  <a href=\"javascript:history.back();\">mundur satu halaman</a>  ";
...
$PMF_LANG["err_noMailAdress"] = "Alamat email anda tidak benar. <a href=\"javascript:history.back();\">kembali</a>";
...
$PMF_LANG["ad_passwd_remark"] = "PERHATIAN: Cookie harus disetel ulang!";
...
$LANG_CONF['records.attachmentsPath'] = array("input", "Lokasi dimana lampiran akan disimpan. Lokasi relatif berarti folder dalam web root");
...
$PMF_LANG['ad_layout_mode_auto'] = 'Otomatis (ikuti preferensi sistem pengunjung)';
$PMF_LANG['ad_layout_mode_dark'] = 'Gelap';
$PMF_LANG['ad_layout_mode_highContrast'] = 'Kontras tinggi';
$PMF_LANG['ad_layout_mode_light'] = 'Terang';
$PMF_LANG['ad_menu_pages'] = 'Halaman Khusus';
$PMF_LANG['ad_page_add'] = 'Tambah Halaman Khusus';
$PMF_LANG['ad_page_add_translation'] = 'Tambah Terjemahan';
$PMF_LANG['ad_page_author_email'] = 'Email Penulis';
$PMF_LANG['ad_page_author_name'] = 'Nama Penulis';
$PMF_LANG['ad_page_content'] = 'Isi Halaman';
$PMF_LANG['ad_page_created'] = 'Dibuat';
$PMF_LANG['ad_page_del'] = 'Apakah Anda yakin ingin menghapus halaman khusus ini?';
$PMF_LANG['ad_page_delete'] = 'Hapus';
$PMF_LANG['ad_page_delsuc'] = 'Halaman khusus berhasil dihapus.';
$PMF_LANG['ad_page_edit'] = 'Edit Halaman Khusus';
$PMF_LANG['ad_page_existing_translations'] = 'Terjemahan yang Ada';
$PMF_LANG['ad_page_insertfail'] = 'Terjadi kesalahan saat membuat halaman khusus.';
$PMF_LANG['ad_page_lang_cannot_change'] = 'Bahasa tidak dapat diubah setelah dibuat.';
$PMF_LANG['ad_page_no_available_languages'] = 'Semua bahasa yang tersedia sudah memiliki terjemahan untuk halaman ini.';
$PMF_LANG['ad_page_nodata'] = 'Tidak ada halaman khusus ditemukan';
$PMF_LANG['ad_page_nodelete'] = 'Tidak';
$PMF_LANG['ad_page_original_language'] = 'Bahasa Asli';
$PMF_LANG['ad_page_select_translation_language'] = 'Pilih Bahasa Terjemahan';
$PMF_LANG['ad_page_seo_description'] = 'Deskripsi Meta SEO';
$PMF_LANG['ad_page_seo_robots'] = 'Direktif Robots';
$PMF_LANG['ad_page_seo_title'] = 'Judul SEO';
$PMF_LANG['ad_page_set_active'] = 'Aktifkan halaman';
$PMF_LANG['ad_page_slug'] = 'Slug URL';
$PMF_LANG['ad_page_slug_exists'] = 'Slug ini sudah ada untuk bahasa ini';
$PMF_LANG['ad_page_slug_help'] = 'Pengidentifikasi ramah URL untuk halaman ini (mis. \'privacy-policy\')';
$PMF_LANG['ad_page_tab_content'] = 'Konten';
$PMF_LANG['ad_page_tab_seo'] = 'SEO';
$PMF_LANG['ad_page_tab_settings'] = 'Pengaturan';
$PMF_LANG['ad_page_title'] = 'Judul Halaman';
$PMF_LANG['ad_page_translate'] = 'Terjemahkan Halaman';
$PMF_LANG['ad_page_update'] = 'Perbarui';
$PMF_LANG['ad_page_updated'] = 'Diperbarui';
$PMF_LANG['ad_page_updatefail'] = 'Terjadi kesalahan saat memperbarui halaman khusus.';
$PMF_LANG['ad_page_updatesuc'] = 'Halaman khusus berhasil diperbarui.';
$PMF_LANG['ad_page_yesdelete'] = 'Ya, hapus!';
$PMF_LANG['ad_pmf_news'] = 'Berita phpMyFAQ';
$PMF_LANG['keycloakControlCenter'] = 'Keycloak';
$PMF_LANG['msgAboutThisPage'] = 'Tentang halaman ini';
$PMF_LANG['msgAccessibilityStatement'] = 'Informasi tentang aksesibilitas layanan';
$PMF_LANG['msgAdminHeaderLdap'] = 'Konfigurasi LDAP';
$PMF_LANG['msgAdminLdapGroupSettings'] = 'Pengaturan Grup LDAP';
$PMF_LANG['msgAdminLdapHealthCheck'] = 'Pemeriksaan Kesehatan LDAP';
$PMF_LANG['msgAdminLdapMapping'] = 'Pemetaan Atribut LDAP';
$PMF_LANG['msgAdminLdapOptions'] = 'Opsi LDAP';
$PMF_LANG['msgAdminLdapServers'] = 'Server LDAP';
$PMF_LANG['msgAdminLdapSettings'] = 'Pengaturan Umum LDAP';
$PMF_LANG['msgAdminLogExportCsv'] = 'Ekspor log admin sebagai CSV';
$PMF_LANG['msgAdminLogVerifyIntegrity'] = 'Verifikasi Integritas';
$PMF_LANG['msgAttention'] = 'Perhatian!';
$PMF_LANG['msgChangeLanguageHint'] = 'Silakan ganti bahasa di bagian administrasi untuk memproses pertanyaan-pertanyaan ini.';
$PMF_LANG['msgChat'] = 'Pesan';
$PMF_LANG['msgChatConversations'] = 'Percakapan';
$PMF_LANG['msgChatNewConversation'] = 'Percakapan baru';
$PMF_LANG['msgChatNoMessages'] = 'Belum ada pesan';
$PMF_LANG['msgChatSearchUsers'] = 'Cari pengguna...';
$PMF_LANG['msgChatSelectConversation'] = 'Pilih percakapan atau cari pengguna untuk mulai mengobrol';
$PMF_LANG['msgChatSend'] = 'Kirim';
$PMF_LANG['msgChatTypePlaceholder'] = 'Ketik pesan...';
$PMF_LANG['msgCommentEditorHint'] = 'Anda dapat menggunakan editor teks untuk memformat komentar Anda dengan tebal, miring, daftar, dan tautan.';
$PMF_LANG['msgConfirmAction'] = 'Konfirmasi Tindakan';
$PMF_LANG['msgConfirmUnstick'] = 'Apakah Anda benar-benar ingin menghapus entri ini dari daftar FAQ penting?';
$PMF_LANG['msgCookiePolicy'] = 'Kebijakan Cookie';
$PMF_LANG['msgCreated'] = 'Dibuat';
$PMF_LANG['msgDeletePage'] = 'Hapus Halaman Khusus';
$PMF_LANG['msgEmailTo'] = 'Email ke';
$PMF_LANG['msgFleschNotCalculated'] = 'Mulai mengetik untuk menghitung';
$PMF_LANG['msgFleschReadingEase'] = 'Skor Keterbacaan';
$PMF_LANG['msgFleschScaleHint'] = '0-29: Sangat Sulit | 30-49: Sulit | 50-59: Cukup Sulit | 60-69: Standar | 70-79: Cukup Mudah | 80-89: Mudah | 90-100: Sangat Mudah';
$PMF_LANG['msgFleschTooltip'] = 'Skor Flesch Reading Ease mengukur seberapa mudah teks Anda dibaca. Skor lebih tinggi berarti lebih mudah dibaca. Targetkan 60-70 untuk audiens umum.';
$PMF_LANG['msgGenerateVapidKeys'] = 'Hasilkan Kunci VAPID';
$PMF_LANG['msgImprint'] = 'Impresum';
$PMF_LANG['msgNoTranslationProvider'] = 'Tidak ada penyedia terjemahan yang dikonfigurasi';
$PMF_LANG['msgOpenQuestion'] = 'Pertanyaan terbuka';
$PMF_LANG['msgOtherQuestionDesc'] = 'Ada satu pertanyaan terbuka lagi dalam bahasa lain:';
$PMF_LANG['msgOtherQuestionsDesc'] = 'Ada total %d pertanyaan terbuka lagi dalam bahasa lain:';
$PMF_LANG['msgPushNewFaq'] = 'FAQ baru diterbitkan';
$PMF_LANG['msgPushNewQuestion'] = 'Pertanyaan terbuka baru dikirim';
$PMF_LANG['msgPushNotifications'] = 'Notifikasi Push';
$PMF_LANG['msgPushNotificationsDescription'] = 'Terima notifikasi browser saat FAQ baru diterbitkan atau pertanyaan dikirim.';
$PMF_LANG['msgPushNotificationsDisable'] = 'Nonaktifkan notifikasi push';
$PMF_LANG['msgPushNotificationsDisabled'] = 'Notifikasi push dinonaktifkan';
$PMF_LANG['msgPushNotificationsEnable'] = 'Aktifkan notifikasi push';
$PMF_LANG['msgPushNotificationsEnabled'] = 'Notifikasi push diaktifkan';
$PMF_LANG['msgPushNotificationsNotSupported'] = 'Notifikasi push tidak didukung oleh browser Anda';
$PMF_LANG['msgPushNotificationsPermissionDenied'] = 'Izin notifikasi push ditolak';
$PMF_LANG['msgSignInWithKeycloak'] = 'Masuk dengan Keycloak';
$PMF_LANG['msgStickyRemoved'] = 'Status "penting" berhasil dihapus.';
$PMF_LANG['msgTermsOfService'] = 'Ketentuan Layanan';
$PMF_LANG['msgThemeUploadNoZip'] = 'Silakan pilih file ZIP untuk diunggah.';
$PMF_LANG['msgToggleSidebar'] = 'Alihkan bilah samping';
$PMF_LANG['msgTooltipUnstick'] = 'Hapus status penting';
$PMF_LANG['msgTranslateWithAI'] = 'Terjemahkan dengan AI';
$PMF_LANG['msgTranslating'] = 'Menerjemahkan...';
$PMF_LANG['msgTranslation'] = 'Terjemahan';
$PMF_LANG['msgTranslationError'] = 'Terjemahan gagal';
$PMF_LANG['msgTranslationSuccess'] = 'Terjemahan berhasil diselesaikan';
$PMF_LANG['msgUpdated'] = 'Diperbarui';
$PMF_LANG['msgVapidKeysError'] = 'Gagal menghasilkan kunci VAPID.';
$PMF_LANG['msgVapidKeysGenerated'] = 'Kunci VAPID berhasil dihasilkan.';
$PMF_LANG['oauthControlCenter'] = 'OAuth 2.0';
$PMF_LANG['permission::addpage'] = 'Tambah halaman khusus';
$PMF_LANG['permission::delpage'] = 'Hapus halaman khusus';
$PMF_LANG['permission::editpage'] = 'Edit halaman khusus';
$PMF_LANG['pushControlCenter'] = 'Push';
$PMF_LANG['storage.testRedisConnection'] = 'Uji koneksi Redis';
$PMF_LANG['storageControlCenter'] = 'Penyimpanan';
