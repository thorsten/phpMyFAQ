<?php
/**
* $Id: rss.php,v 1.1 2004-11-05 23:06:22 thorstenr Exp $
*
...
if ($db->num_rows($result) > 0) {
    ...
    while ($row = $db->fetch_object($result)) {
        ...
        print "\t<item>\n";
        print "\t\t<title>[".$i.".] ".$row->visits." ".$PMF_LANG["msgViews"].":</title>\n";
        print "\t\t<description>".stripslashes(htmlspecialchars(makeShorterText($row->thema, 8)))."</description>\n";
