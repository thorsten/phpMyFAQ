...
vi.mock('./content', () => ({
  ...
  handleSaveShortcut: vi.fn(() => trackCall('handleSaveShortcut')),
  handleDirtyState: vi.fn(() => trackCall('handleDirtyState')),
  handleCharacterCounters: vi.fn(() => trackCall('handleCharacterCounters')),
  handleFaqCategoryTree: vi.fn(() => trackCall('handleFaqCategoryTree')),
  handleAttachmentDragAndDrop: vi.fn(() => trackCall('handleAttachmentDragAndDrop')),
