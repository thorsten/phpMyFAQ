  ...
  (function(e) {
    ...
    (s = function() {
        ...
        return (
          ...
          arguments.length > 1
            ? (arguments[0]
              ...
              arguments.length > 2 &&
                ((t = Array.prototype.slice.call(arguments, 1, -1)), t.unshift(e.prototype), r.extend.apply(r, t)))
          ...
          return this.format.replace(this.fre, function() {
            ...
            return (
              ...
              f === n
                ? ''
                : a && t && t[a]
                ? ((e = t[a]), e.get ? t[a].get(f) || f : t[a][f] || f)
                : (p(f) &&
                    (r.get('numberFormatter')
                      ? (f = r.get('numberFormatter')(f))
                      : (f = y(
                          f,
                          l,
                          r.get('numberDigitGroupCount'),
                          r.get('numberDigitGroupSep'),
                          r.get('numberDecimalMark')
                        ))),
                  f)
            );
          });
      ...
      (f = function(e, n) {
        var r;
        return n === 2
          ? ((r = t.floor(e.length / 2)), e.length % 2 ? e[r] : (e[r - 1] + e[r]) / 2)
          : e.length % 2
          ? ((r = (e.length * n + n) / 4), r % 1 ? (e[t.floor(r)] + e[t.floor(r) - 1]) / 2 : e[r - 1])
          : ((r = (e.length * n + 2) / 4), r % 1 ? (e[t.floor(r)] + e[t.floor(r) - 1]) / 2 : e[r - 1]);
      }),
      (l = function(e) {
        var t;
        switch (e) {
      ...
      (y = function(e, t, n, i, s) {
        var o, u;
        (e = (t === !1 ? parseFloat(e).toString() : e.toFixed(t)).split('')),
      ...
      (r.fn.simpledraw = function(t, i, s, o) {
        ...
        return (
          t === n && (t = r(this).innerWidth()),
          i === n && (i = r(this).innerHeight()),
          (u = r.fn.sparkline.canvas(t, i, this, o)),
          (a = r(this).data('_jqs_mhandler')),
          a && a.registerCanvas(u),
          u
        );
      }),
        ...
        mouseenter: function(t) {
          r(e.body).unbind('mousemove.jqs'),
            ...
            !this.tooltip &&
              ...
              ((this.tooltip = new E(this.options)), this.tooltip.updatePosition(t.pageX, t.pageY)),
            this.updateDisplay();
        },
        mouseleave: function() {
          r(e.body).unbind('mousemove.jqs');
      ...
      (E = o({
        ...
        updatePosition: function(e, t) {
          ...
          (t -= this.height + this.tooltipOffsetY),
            ...
            e < this.scrollLeft
              ? (e = this.scrollLeft)
              : e + this.width > this.scrollRight && (e = this.scrollRight - this.width),
          ...
          u = function() {
            ...
            s.get('disableInteraction')
              ...
              : ((l = r.data(this, '_jqs_mhandler')),
                l ? s.get('composite') || l.reset() : ((l = new w(this, s)), r.data(this, '_jqs_mhandler', l)));
            if (s.get('composite') && !r.data(this, '_jqs_vcanvas')) {
            ...
            (c = new r.fn.sparkline[s.get('type')](this, i, s, u, a)), c.render(), l && l.registerSparkline(c);
          };
          if (
            (r(this).html() && !s.get('disableHiddenCheck') && r(this).is(':hidden')) ||
            !r(this).parents('body').length
          ) {
            if (!s.get('composite') && r.data(this, '_jqs_pending'))
              for (a = B.length; a; a--) B[a - 1][0] == this && B.splice(a - 1, 1);
            B.push([this, u]), r.data(this, '_jqs_pending', !0);
          } else u.call(this);
        });
      }),
        ...
        for (t = 0, n = B.length; t < n; t++)
          (e = B[t][0]),
            ...
            !r(e)
              .parents()
              .is(':hidden')
              ? (B[t][1].call(e), r.data(B[t][0], '_jqs_pending', !1), i.push(t))
              : !r(e).closest('html').length &&
                !r.data(e, '_jqs_pending') &&
                (r.data(B[t][0], '_jqs_pending', !1), i.push(t));
        for (t = i.length; t; t--) B.splice(i[t - 1], 1);
      }),
        ...
        getTagSetting: function(e) {
          ...
          if (this.tagValCache.hasOwnProperty(e)) r = this.tagValCache.key;
            ...
            if (r === n || r === null) r = i;
              ...
              for (s = r.length; s--; ) r[s] = l(r[s].replace(/(^\s*)|(\s*$)/g, ''));
            } else if (r.substr(0, 1) === '{') {
      ...
      (r.fn.sparkline._base = o({
        ...
        initTarget: function() {
          ...
          (this.target = this.$el.simpledraw(this.width, this.height, this.options.get('composite'), e))
        ...
        setRegionHighlight: function(e, t, r) {
          var i = this.currentRegion,
            ...
            o;
          return t > this.canvasWidth || r > this.canvasHeight || t < 0 || r < 0
            ? null
            : ((o = this.getRegion(e, t, r)),
              i !== o
                ? (i !== n && s && this.removeHighlight(),
                  (this.currentRegion = o),
                  o !== n && s && this.renderHighlight(),
                  !0)
                : !1);
        },
        ...
        getCurrentRegionTooltip: function() {
          ...
          if (h && p) {
            d = [];
            for (c = s.length; c--; ) (v = s[c][p]), (b = r.inArray(v, h)) != -1 && (d[b] = s[c]);
            s = d;
          }
          (a = o.length), (y = s.length);
          for (c = 0; c < a; c++) {
            (g = o[c]), typeof g == 'string' && (g = new u(g)), (f = g.fclass || 'jqsfield');
            for (b = 0; b < y; b++)
        ...
        calcHighlightColor: function(e, n) {
          ...
          if (i) {
            ...
            if (s) {
              (u = []), (o = e.length === 4 ? 16 : 1);
              for (f = 0; f < 3; f++) u[f] = a(t.round(parseInt(s[f + 1], 16) * o * i), 0, 255);
              return 'rgb(' + u.join(',') + ')';
            }
          }
          return e;
      ...
      (r.fn.sparkline.line = x = o(r.fn.sparkline._base, {
        type: 'line',
        ...
        scanValues: function() {
          ...
          for (o = 0; o < n; o++)
            (u = e[o]),
              ...
              (l = a && e[o].split(':')),
              a && l.length === 2
                ? (r.push(Number(l[0])), i.push(Number(l[1])), s.push(Number(l[1])))
                : f
                ? (r.push(u[0]), i.push(u[1]), s.push(u[1]))
                : (r.push(o), e[o] === null || e[o] === 'null' ? i.push(null) : (i.push(Number(u)), s.push(Number(u))));
        ...
        processRangeOptions: function() {
          ...
          t !== n && (t < this.miny && (this.miny = t), r > this.maxy && (this.maxy = r)),
            e.get('chartRangeMin') !== n &&
              (e.get('chartRangeClip') || e.get('chartRangeMin') < this.miny) &&
              (this.miny = e.get('chartRangeMin')),
            e.get('chartRangeMax') !== n &&
              (e.get('chartRangeClip') || e.get('chartRangeMax') > this.maxy) &&
              (this.maxy = e.get('chartRangeMax')),
            e.get('chartRangeMinX') !== n &&
              (e.get('chartRangeClipX') || e.get('chartRangeMinX') < this.minx) &&
              (this.minx = e.get('chartRangeMinX')),
            e.get('chartRangeMaxX') !== n &&
              (e.get('chartRangeClipX') || e.get('chartRangeMaxX') > this.maxx) &&
        ...
        render: function() {
          ...
          this.scanValues(), this.processRangeOptions(), (P = this.xvalues), (H = this.yvalues);
          ...
          if (a) {
            ...
            if (_ || e.get('minSpotColor') || (e.get('spotColor') && H[h] === this.miny)) o -= t.ceil(a);
            if (_ || e.get('maxSpotColor') || (e.get('spotColor') && H[h] === this.maxy))
              (o -= t.ceil(a)), (p += t.ceil(a));
            if (_ || ((e.get('minSpotColor') || e.get('maxSpotColor')) && (H[0] === this.miny || H[0] === this.maxy)))
              (d += t.ceil(a)), (s -= t.ceil(a));
            if (
              _ ||
              e.get('spotColor') ||
              e.get('minSpotColor') ||
              (e.get('maxSpotColor') && (H[h] === this.miny || H[h] === this.maxy))
            )
              s -= t.ceil(a);
          }
          o--,
            e.get('normalRangeMin') !== n && !e.get('drawNormalOnTop') && this.drawNormalRange(d, p, o, s, c),
            (m = []),
            (g = [m]),
            (N = C = null),
            (k = H.length);
          for (B = 0; B < k; B++)
            (y = P[B]),
              ...
              (N = C),
              w === null
                ? B && (H[B - 1] !== null && ((m = []), g.push(m)), u.push(null))
                : (w < this.miny && (w = this.miny),
                  w > this.maxy && (w = this.maxy),
                  m.length || m.push([S, p + o]),
          ...
          for (B = 0; B < O; B++)
            (m = g[B]),
              m.length &&
                (e.get('fillColor') && (m.push([m[m.length - 1][0], p + o]), A.push(m.slice(0)), m.pop()),
                m.length > 2 && (m[0] = [m[0][0], m[1][1]]),
                L.push(m));
          O = A.length;
          for (B = 0; B < O; B++) i.drawShape(A[B], e.get('fillColor'), e.get('fillColor')).append();
          e.get('normalRangeMin') !== n && e.get('drawNormalOnTop') && this.drawNormalRange(d, p, o, s, c),
            (O = L.length);
          for (B = 0; B < O; B++) i.drawShape(L[B], e.get('lineColor'), n, e.get('lineWidth')).append();
          if (a && e.get('valueSpots')) {
            (M = e.get('valueSpots')), M.get === n && (M = new b(M));
            for (B = 0; B < k; B++)
              (D = M.get(H[B])),
                D &&
                  i
                    .drawCircle(
                      d + t.round((P[B] - this.minx) * (s / l)),
                      p + t.round(o - o * ((H[B] - this.miny) / c)),
                      a,
                      n,
                      D
                    )
          ...
          a &&
            ...
            i
              .drawCircle(
                d + t.round((P[P.length - 1] - this.minx) * (s / l)),
                p + t.round(o - o * ((H[h] - this.miny) / c)),
                a,
                n,
                e.get('spotColor')
              )
            ...
            this.maxy !== this.minyorg &&
              (a &&
                ...
                i
                  .drawCircle(
                    d + t.round((y - this.minx) * (s / l)),
                    p + t.round(o - o * ((this.minyorg - this.miny) / c)),
                    a,
                    n,
                    e.get('minSpotColor')
                  )
              ...
              a &&
                ...
                i
                  .drawCircle(
                    d + t.round((y - this.minx) * (s / l)),
                    p + t.round(o - o * ((this.maxyorg - this.miny) / c)),
                    a,
                    n,
                    e.get('maxSpotColor')
                  )
      ...
      (r.fn.sparkline.bar = T = o(r.fn.sparkline._base, S, {
        type: 'bar',
        init: function(e, i, s, o, u) {
          var f = parseInt(s.get('barWidth'), 10),
            p = parseInt(s.get('barSpacing'), 10),
            d = s.get('chartRangeMin'),
            v = s.get('chartRangeMax'),
            m = s.get('chartRangeClip'),
            g = Infinity,
            y = -Infinity,
            w,
            E,
          ...
          for (C = 0, k = i.length; C < k; C++) {
            (q = i[C]), (w = typeof q == 'string' && q.indexOf(':') > -1);
            if (w || r.isArray(q))
              (H = !0),
                w && (q = i[C] = c(q.split(':'))),
                (q = h(q, null)),
          ...
          (this.stacked = H),
            ...
            this.initTarget(),
            m && ((D = d === n ? -Infinity : d), (P = v === n ? Infinity : v)),
            (N = []),
            (x = H ? [] : N);
          var W = [],
            X = [];
          for (C = 0, k = i.length; C < k; C++)
            if (H) {
              (B = i[C]), (i[C] = I = []), (W[C] = 0), (x[C] = X[C] = 0);
              for (j = 0, F = B.length; j < F; j++)
                (q = I[j] = m ? a(B[j], D, P) : B[j]),
                  q !== null &&
                    (q > 0 && (W[C] += q),
                    g < 0 && y > 0 ? (q < 0 ? (X[C] += t.abs(q)) : (x[C] += q)) : (x[C] += t.abs(q - (q < 0 ? y : g))),
                    N.push(q));
            } else (q = m ? a(i[C], D, P) : i[C]), (q = i[C] = l(q)), q !== null && N.push(q);
          (this.max = _ = t.max.apply(t, N)),
            ...
            s.get('chartRangeMin') !== n &&
              (s.get('chartRangeClip') || s.get('chartRangeMin') < M) &&
              (M = s.get('chartRangeMin')),
            s.get('chartRangeMax') !== n &&
              (s.get('chartRangeClip') || s.get('chartRangeMax') > _) &&
              (_ = s.get('chartRangeMax')),
            (this.zeroAxis = A = s.get('zeroAxis', !0)),
            M <= 0 && _ >= 0 && A ? (O = 0) : A == 0 ? (O = M) : M > 0 ? (O = M) : (O = _),
            (this.xaxisOffset = O),
            ...
            M < O
              ? ((U = H && _ >= 0 ? y : _),
                ...
                R !== t.ceil(R) && ((this.canvasHeightEf -= 2), (R = t.ceil(R))))
              : (R = this.canvasHeight),
            (this.yoffset = R),
            r.isArray(s.get('colorMap'))
              ? ((this.colorMapByIndex = s.get('colorMap')), (this.colorMapByValue = null))
              : ((this.colorMapByIndex = null),
                (this.colorMapByValue = s.get('colorMap')),
                this.colorMapByValue &&
                  this.colorMapByValue.get === n &&
        ...
        getCurrentRegionFields: function() {
          var e = this.currentRegion,
            ...
            i;
          for (i = t.length; i--; )
            (r = t[i]), n.push({ isNull: r === null, value: r, color: this.calcColor(i, r, e), offset: e });
          return n;
        },
        calcColor: function(e, t, i) {
          var s = this.colorMapByIndex,
            ...
            f;
          return (
            this.stacked ? (a = u.get('stackedBarColor')) : (a = t < 0 ? u.get('negBarColor') : u.get('barColor')),
            t === 0 && u.get('zeroColor') !== n && (a = u.get('zeroColor')),
            o && (f = o.get(t)) ? (a = f) : s && s.length > i && (a = s[i]),
            r.isArray(a) ? a[e % a.length] : a
          );
        },
        renderRegion: function(e, i) {
          var s = this.values[e],
            ...
            l = this.stacked,
            c = this.target,
            h = e * this.totalBarWidth,
            p = this.canvasHeightEf,
            v = this.yoffset,
            m,
            g,
            y,
            ...
            T,
            N;
          (s = r.isArray(s) ? s : [s]), (S = s.length), (x = s[0]), (b = d(null, s)), (N = d(u, s, !0));
          if (b)
            return o.get('nullColor')
              ? ((y = i ? o.get('nullColor') : this.calcHighlightColor(o.get('nullColor'), o)),
                (m = v > 0 ? v - 1 : v),
                c.drawRect(h, m, this.barWidth - 1, 0, y, y))
              : n;
          w = v;
          for (E = 0; E < S; E++) {
            x = s[E];
            ...
            f > 0 ? (g = t.floor(p * (t.abs(x - u) / f)) + 1) : (g = 1),
              x < u || (x === u && v === 0) ? ((m = w), (w += g)) : ((m = v - g), (v -= g)),
              (y = this.calcColor(E, x, e)),
              i && (y = this.calcHighlightColor(y, o)),
              a.push(c.drawRect(h, m, this.barWidth - 1, g - 1, y, y));
          }
          return a.length === 1 ? a[0] : a;
        },
      })),
      (r.fn.sparkline.tristate = N = o(r.fn.sparkline._base, S, {
        type: 'tristate',
        init: function(e, t, i, s, o) {
      ...
      (r.fn.sparkline.discrete = C = o(r.fn.sparkline._base, S, {
        ...
        init: function(e, i, s, o, u) {
          C._super.init.call(this, e, i, s, o, u),
            ...
            s.get('chartRangeMin') !== n &&
              (s.get('chartRangeClip') || s.get('chartRangeMin') < this.min) &&
              (this.min = s.get('chartRangeMin')),
            s.get('chartRangeMax') !== n &&
              (s.get('chartRangeClip') || s.get('chartRangeMax') > this.max) &&
              (this.max = s.get('chartRangeMax')),
            this.initTarget(),
            this.target &&
              (this.lineHeight =
                s.get('lineHeight') === 'auto' ? t.round(this.canvasHeight * 0.3) : s.get('lineHeight'));
        },
        getRegion: function(e, n, r) {
        ...
        renderRegion: function(e, n) {
          ...
          return (
            ...
            n && (m = this.calcHighlightColor(m, i)),
            l.drawLine(g, d, g, d + h, m)
          );
        },
      })),
      (r.fn.sparkline.bullet = k = o(r.fn.sparkline._base, {
        type: 'bullet',
        init: function(e, r, i, s, o) {
          ...
          k._super.init.call(this, e, r, i, s, o),
            ...
            (u = t.min.apply(t, r)),
            (a = t.max.apply(t, r)),
            i.get('base') === n ? (u = u < 0 ? u : 0) : (u = i.get('base')),
            (this.min = u),
            (this.max = a),
            (this.range = a - u),
            (this.shapes = {}),
        ...
        renderRange: function(e, n) {
          ...
          return (
            n && (s = this.calcHighlightColor(s, this.options)),
            this.target.drawRect(0, 0, i - 1, this.canvasHeight - 1, s, s)
          );
        },
        ...
        render: function() {
          var e = this.values.length,
            ...
            n,
            r;
          if (!k._super.render.call(this)) return;
          for (n = 2; n < e; n++)
            (r = this.renderRange(n).append()), (this.shapes[r.id] = 'r' + n), (this.valueShapes['r' + n] = r.id);
          this.values[1] !== null &&
            ((r = this.renderPerformance().append()), (this.shapes[r.id] = 'p1'), (this.valueShapes.p1 = r.id)),
            this.values[0] !== null &&
              ((r = this.renderTarget().append()), (this.shapes[r.id] = 't0'), (this.valueShapes.t0 = r.id)),
            t.render();
        },
      })),
      (r.fn.sparkline.pie = L = o(r.fn.sparkline._base, {
        type: 'pie',
        init: function(e, n, i, s, o) {
          ...
          L._super.init.call(this, e, n, i, s, o),
            ...
            i.get('width') === 'auto' && (this.width = this.height);
        ...
        renderSlice: function(e, r) {
          ...
          m = l.length;
          for (v = 0; v < m; v++) {
            (p = h), (d = h), c > 0 && (d = h + f * (l[v] / c));
            if (e === v)
              return (
                (g = s.get('sliceColors')[v % s.get('sliceColors').length]),
                r && (g = this.calcHighlightColor(g, s)),
                i.drawPieSlice(o, o, o - u, p, d, n, g)
              );
            h = d;
          }
        },
        render: function() {
          var e = this.target,
            ...
            u,
            a;
          if (!L._super.render.call(this)) return;
          o && e.drawCircle(s, s, t.floor(s - o / 2), i.get('borderColor'), n, o).append();
          for (a = r.length; a--; )
            r[a] && ((u = this.renderSlice(a).append()), (this.valueShapes[a] = u.id), (this.shapes[u.id] = a));
          e.render();
        },
      })),
      (r.fn.sparkline.box = A = o(r.fn.sparkline._base, {
        type: 'box',
        ...
        render: function() {
          var e = this.target,
            ...
            l = s.get('chartRangeMax') === n ? t.max.apply(t, r) : s.get('chartRangeMax'),
            c = 0,
            h,
            p,
            d,
          ...
          if (s.get('raw'))
            s.get('showOutliers') && r.length > 5
              ? ((p = r[0]), (h = r[1]), (v = r[2]), (m = r[3]), (g = r[4]), (y = r[5]), (b = r[6]))
              : ((h = r[0]), (v = r[1]), (m = r[2]), (g = r[3]), (y = r[4]));
          else {
            r.sort(function(e, t) {
              return e - t;
            }),
            ...
            if (s.get('showOutliers')) {
              h = y = n;
              for (w = 0; w < i; w++)
                h === n && r[w] > v - d * s.get('outlierIQR') && (h = r[w]),
                  r[w] < g + d * s.get('outlierIQR') && (y = r[w]);
              (p = r[0]), (b = r[i - 1]);
            } else (h = r[0]), (y = r[i - 1]);
          }
              ...
              p < h &&
                e
                  .drawCircle(
                    ...
                    u / 2,
                    s.get('spotRadius'),
                    s.get('outlierLineColor'),
                    s.get('outlierFillColor')
                  )
                  .append(),
              b > y &&
                e
      ...
      (D = o({
        ...
        _calculatePixelDims: function(e, t, n) {
          ...
          (i = this._pxregex.exec(t)),
            i ? (this.pixelHeight = i[1]) : (this.pixelHeight = r(n).height()),
            (i = this._pxregex.exec(e)),
            i ? (this.pixelWidth = i[1]) : (this.pixelWidth = r(n).width());
        },
        _genShape: function(e, t) {
          var n = j++;
          return t.unshift(n), new _(this, n, e, t);
        },
      ...
      (P = o(D, {
        ...
        _drawShape: function(e, t, r, i, s) {
          var o = this._getContext(r, i, s),
            u,
            a;
          o.beginPath(), o.moveTo(t[0][0] + 0.5, t[0][1] + 0.5);
          for (u = 1, a = t.length; u < a; u++) o.lineTo(t[u][0] + 0.5, t[u][1] + 0.5);
          r !== n && o.stroke(),
            i !== n && o.fill(),
            this.targetX !== n &&
              this.targetY !== n &&
        ...
        _drawCircle: function(e, r, i, s, o, u, a) {
          ...
          f.beginPath(),
            f.arc(r, i, s, 0, 2 * t.PI, !1),
            this.targetX !== n &&
              this.targetY !== n &&
              f.isPointInPath(this.targetX, this.targetY) &&
              (this.currentTargetShapeId = e),
            o !== n && f.stroke(),
            u !== n && f.fill();
        },
      ...
      (H = o(D, {
        ...
        _drawShape: function(e, t, r, i, s) {
          var o = [],
            ...
            h,
            p;
          for (p = 0, h = t.length; p < h; p++) o[p] = '' + t[p][0] + ',' + t[p][1];
          return (
            (u = o.splice(0, 1)),
            (s = s === n ? 1 : s),
        ...
        appendShape: function(e) {
          ...
          return (
            this.rendered ? this.group.insertAdjacentHTML('beforeEnd', t) : (this.prerender += t),
