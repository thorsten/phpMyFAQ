...
if ($groupAction == 'delete_confirm' && $user->perm->checkRight($user->getUserId(), 'delgroup')) {
    ...
    if ($groupId <= 0) {
        ...
        <div class="row">
            <div class="col-lg-12">
                <p><?php echo $PMF_LANG['ad_group_deleteQuestion'];
        ?></p>
...
if ($groupAction == 'add' && $user->perm->checkRight($user->getUserId(), 'addgroup')) {
    ...
    ?>
        <header class="row">
            <div class="col-lg-12">
                <h2 class="page-header"><i class="fa fa-user fa-fw"></i> <?php echo $PMF_LANG['ad_group_add'];
    ?></h2>
            </div>
        </header>
...
getGroupList();
    ...
    ?>
                        ...
                        <div class="panel-body">
                            <select name="group_list_select" id="group_list_select" class="form-control"
                                    onchange="groupSelect(event)" size="<?php echo $groupSelectSize;
    ?>" tabindex="1">
                            </select>
                        </div>
    ...
    ?>"
                                              tabindex="2"><?php
                                        echo(isset($group_description) ? $group_description : '');
    ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
    ...
    ?>
                            ...
                            <li class="list-group-item checkbox" id="group_rights_table">
                                <label>
                                    <input id="group_right_<?php echo $right['right_id'];
    ?>" type="checkbox"
