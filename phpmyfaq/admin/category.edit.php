...
?>
        ...
        <header>
            <h2><?php print $PMF_LANG['ad_categ_edit_1'] . ' ' . $categoryData->name . ' ' . $PMF_LANG['ad_categ_edit_2']; ?></h2>
        </header>

        <form action="?action=updatecategory" method="post">
            <input type="hidden" name="id" value="<?php print $categoryData->id; ?>" />
            <input type="hidden" id="catlang" name="catlang" value="<?php print $categoryData->lang; ?>" />
            ...
            <p>
                ...
                <textarea id="description" name="description" rows="3" cols="80"
                          style="width: 300px;"><?php print $categoryData->description; ?></textarea>
            </p>
...
?>
            <p>
                ...
                <select name="restricted_users" size="1">
                    <?php print $user->getAllUserOptions($user_permission->user_id); ?>
                </select>
            </p>
<?php
