...
if ($user->perm->checkRight($user->getUserId(), 'editcateg')) {
    ...
    ?>
        ...
        <header class="row">
            <div class="col-lg-12">
                <h2 class="page-header"><i aria-hidden="true" class="fa fa-list fa-fw"></i> <?php echo $header;
    ?></h2>
            </div>
        </header>
    ...
    ?>:</label>
            ...
            <div class="form-group">
                <label class="col-lg-2 control-label"><?php echo $PMF_LANG['ad_categ_owner'];
    ?>:</label>
                <div class="col-lg-4">
...
<?php
    if ($faqConfig->get('security.permLevel') != 'basic') {
        ?>
            <div class="form-group">
                <label class="col-lg-2 control-label"><?php echo $PMF_LANG['ad_entry_grouppermission'];
        ?></label>
                <div class="col-lg-4">
                    <div class="radio">
...
<?php 
    ...
    ?>
            <div class="form-group">
                <label class="col-lg-2 control-label"><?php echo $PMF_LANG['ad_entry_userpermission'];
    ?></label>
                <div class="col-lg-4">
                    <label class="radio">
