...
?>
    ...
    <input type="hidden" name="catlang" id="catlang" value="<?php print $categoryData->lang; ?>" />
    ...
    <legend><?php print $PMF_LANG['ad_categ_edit_1']." <em>".$categoryData->name."</em> ".$PMF_LANG['ad_categ_edit_2']; ?></legend>
        ...
        <input type="text" id="name" name="name" size="30" style="width: 300px;" value="<?php print $categoryData->name; ?>" /><br />

        <label class="left"><?php print $PMF_LANG['ad_categ_desc']; ?>:</label>
    	<textarea id="description" name="description" rows="3" cols="80" style="width: 300px;"><?php print $categoryData->description; ?></textarea><br />
...
?>
        ...
        <input type="radio" id="grouppermission" name="grouppermission" class="active" value="all" <?php print ($allGroups ? 'checked="checked"' : ''); ?>/> <?php print $PMF_LANG['ad_entry_all_groups']; ?> <input type="radio" name="grouppermission" class="active" value="restricted" <?php print ($restrictedGroups ? 'checked="checked"' : ''); ?>/> <?php print $PMF_LANG['ad_entry_restricted_groups']; ?> <select name="restricted_groups" size="1"><?php print $user->perm->getAllGroupsOptions($groupPermission->group_id); ?></select><br />
<?php
    } else {
?>
...
?>
        ...
        <input type="radio" id="userpermission" name="userpermission" class="active" value="all" <?php print ($allUsers ? 'checked="checked"' : ''); ?>/> <?php print $PMF_LANG['ad_entry_all_users']; ?> <input type="radio" name="userpermission" class="active" value="restricted" <?php print ($restrictedUsers ? 'checked="checked"' : ''); ?>/> <?php print $PMF_LANG['ad_entry_restricted_users']; ?> <select name="restricted_users" size="1"><?php print $user->getAllUserOptions($userPermission->user_id); ?></select><br />
