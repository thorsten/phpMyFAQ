...
{ var frameId = 'jUploadFrame' + id; if(window.ActiveXObject) { var io = document.createElement("iframe"); io.setAttribute("id", frameId); io.setAttribute("name", frameId); if(typeof uri== 'boolean'){ io.src = 'javascript:false';}
