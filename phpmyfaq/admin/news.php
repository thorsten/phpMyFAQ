...
?>
        <header class="row">
            <div class="col-lg-12">
                <h2 class="page-header"><i class="fa fa-pencil"></i> <?php echo $PMF_LANG['ad_news_add']; ?></h2>
            </div>
        </header>
        ...
        <div class="row">
            <div class="col-lg-12">
                <form class="form-horizontal" id="faqEditor" name="faqEditor" action="?action=savenews" method="post" accept-charset="utf-8">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="dateStart"><?php echo $PMF_LANG['ad_news_from']; ?></label>
                        <div class="col-lg-2">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="dateEnd"><?php echo $PMF_LANG['ad_news_to']; ?></label>
                        <div class="col-lg-2">
...
?>
        <header class="row">
            <div class="col-lg-12">
                <h2 class="page-header"><i class="fa fa-pencil"></i> <?php echo $PMF_LANG['ad_news_edit']; ?></h2>
            </div>
        </header>
        ...
        <div class="row">
            <div class="col-lg-12">
                <form class="form-horizontal" action="?action=updatenews" method="post" accept-charset="utf-8">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="newsheader"><?php echo $PMF_LANG['ad_news_header']; ?></label>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="authorName"><?php echo $PMF_LANG['ad_news_author_name']; ?></label>
                        <div class="col-lg-4">
                            <input type="text" name="authorName" value="<?php echo $newsData['authorName']; ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="authorEmail"><?php echo $PMF_LANG['ad_news_author_email']; ?></label>
                        <div class="col-lg-4">
                            <input type="email" name="authorEmail" value="<?php echo $newsData['authorEmail']; ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="link"><?php echo $PMF_LANG['ad_news_link_url']; ?></label>
                        <div class="col-lg-4">
                            <input type="url" name="link" value="<?php echo $newsData['link']; ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="linkTitle"><?php echo $PMF_LANG['ad_news_link_title']; ?></label>
                        <div class="col-lg-4">
                            <input type="text" name="linkTitle" value="<?php echo $newsData['linkTitle']; ?>" class="form-control">
                        </div>
                    </div>
...
<?php
    ...
    if ('no' == $precheck) {
?>
    <div class="form-group"><?php echo $PMF_LANG["ad_news_del"]; ?></div>
