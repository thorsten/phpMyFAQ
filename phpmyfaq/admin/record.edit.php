<?php
/**
* $Id: record.edit.php,v 1.31 2006-06-19 20:05:18 matteo Exp $
*
...
<?php print $tree->printCategoryOptions($categories); ?>
    ...
    <textarea name="thema" id="thema" style="width: 565px; height: 50px;" cols="2" rows="50"><?php if (isset($thema)) { print $thema; } ?></textarea><br />
    
    <label class="left" for="content"><?php print $PMF_LANG["ad_entry_content"]; ?></label>
    <textarea id="content" name="content" cols="50" rows="10"><?php if (isset($content)) { print $content; } ?></textarea><br />
...
?>
    ...
    <input name="keywords" id="keywords" style="width: 565px;" value="<?php if (isset($keywords)) { print htmlspecialchars($keywords); } ?>" /><br />

    <label class="left" for="author"><?php print $PMF_LANG["ad_entry_author"]; ?></label>
    <input name="author" id="author" style="width: 565px;" value="<?php if (isset($author)) { print htmlspecialchars($author); } else { print $user->getUserData('display_name'); } ?>" /><br />

    <label class="left" for="email"><?php print $PMF_LANG["ad_entry_email"]; ?></label>
    <input name="email" id="email" style="width: 565px;" value="<?php if (isset($email)) { print htmlspecialchars($email); } else { print $user->getUserData('email'); } ?>" /><br />
...
?>
    ...
    <textarea name="changed" id="changed" style="width: 565px; height: 50px;" cols="2" rows="50"><?php if (isset($changed)) { print $changed; } ?></textarea><br />
