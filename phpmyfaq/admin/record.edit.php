                    ...
                    <div class="tab-content">
                                        ...
                                        <form id="selectRevision" name="selectRevision" method="post"
                                            ...
                                            <select name="revisionid_selected" onchange="this.form.submit();"
                                                ...
                                                <?php foreach ($revisions as $revisionData) { ?>
                                                    <option
                                                        value="<?= $revisionData['revision_id'] ?>" <?php if ($selectedRevisionId == $revisionData['revision_id']) {
                                                            echo 'selected';
                                                               }
                                                                ?>>
                                                        <?php printf(
                            ...
                            <form id="faqEditor" action="?action=<?= $queryString ?>" method="post"
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <small id="questionHelp"
                                        ...
                                        <?= Translation::get('msgNoHashAllowed') ?>
                                    </small>
                                </div>
                        ...
                        <div class="tab-pane" id="tab-meta-data">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <small id="tagsHelp"
                                           class="form-text visually-hidden"><?= Translation::get(
                                               'msgShowHelp'
                                           ) ?></small>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-notes-changelog">
                            ...
                            <h6 class="card-title">
                                <label for="notes">
                                    <?php printf(
                                        Translation::get('ad_admin_notes_hint'),
                                        Translation::get('ad_admin_notes')
                                    ) ?>
                                </label>
                            </h6>
                    ...
                    <form action="api/attachment.php?action=upload" enctype="multipart/form-data" method="post"
                        ...
                        <fieldset>
                            ...
                            <div class="mb-2">
                                ...
                                <input type="file" class="form-control" name="filesToUpload[]" id="filesToUpload"
                                       multiple>
