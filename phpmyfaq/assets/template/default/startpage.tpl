        ...
        <section class="well">
            <div id="social">
                <a href="{link_facebook}" target="_blank">
                    <img src="assets/img/facebook.png" alt="{writeFacebookMsgTag}" title="{writeFacebookMsgTag}" width="32" height="32" >
                </a>
                <a href="{link_twitter}" target="_blank">
                    <img src="assets/img/twitter.png" alt="{writeTwitterMsgTag}" title="{writeTwitterMsgTag}" width="32" height="32" >
                </a>
                <a href="{link_digg}" target="_blank">
                    <img src="assets/img/digg.png" alt="{writeDiggMsgTag}" title="{writeDiggMsgTag}" width="32" height="32" >
                </a>
                <a href="{link_email}">
