    <div id="register">
        ...
        <div class="required">
            ...
            <input type="text" name="lastname" id="lastname" value="{lastname_value}" class="inputfield" />
        </div><br />
        <div class="required">
            <label for="loginname">{loginname} {login_errorRegistration}</label>
            <input type="text" name="loginname" id="loginname" value="{loginname_value}" class="inputfield" />
        </div><br />
        <div class="required">
            <label for="email">{email} {email_errorRegistration}</label>
            <input type="email" name="email" id="email" value="{email_value}" class="inputfield" />
        </div>
        </fieldset>
