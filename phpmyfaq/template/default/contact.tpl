<h2>{msgContact}</h2>
            ...
            <div id="version"><a href="http://www.phpmyfaq.de"><img src="img/logo.png" width="88" height="31" alt="powered by phpMyFAQ {version}" title="powered by phpMyFAQ {version}" /></a></div>
