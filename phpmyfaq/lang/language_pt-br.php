...
$PMF_LANG['err_SaveEntries'] = 'Campos obrigatórios são <strong>Nome</strong>, <strong>E-mail</strong>, <strong>Categoria</strong>, <strong>Cabeçalho</strong> e <strong>Texto</strong>!<br /><br /><a href="nojavascript...history.back();">voltar</a><br /><br />';
...
$PMF_LANG['err_sendMail'] = 'Campos obrigatórios são <strong>nome</strong>, <strong>e-mail</strong> and <strong>questï¿½o</strong>!<br /><br /><a href="nojavascript...history.back();">voltar</a><br /><br />';
...
$PMF_LANG['ad_news_header'] = 'Cabeçalho do Artigo';
...
$PMF_LANG['ad_linkcheck_openurl_not_allowed'] = 'O <em>CABEÇALHO</em> método não é suportado pelo host <strong>%s</strong>, permitiu que métodos: <strong>%s</strong>.';
...
$PMF_LANG['ad_linkcheck_config_title'] = 'Configuração do Verificador de URL';
$PMF_LANG['ad_linkcheck_config_disabled'] = 'Verificador de URL desabilitado';
$PMF_LANG['ad_linkcheck_config_warnlist'] = 'URLs para avisar';
$PMF_LANG['ad_linkcheck_config_ignorelist'] = 'URLs para ignorar';
$PMF_LANG['ad_linkcheck_config_warnlist_description'] = 'URLs listadas com os itens abaixo serão emitidos, independentemente de aviso de validação. Use esse recurso para detectar URL´s prestes a ser extinta';
$PMF_LANG['ad_linkcheck_config_ignorelist_description'] = 'As URLs listadas abaixo, serão validadas, sem o uso do Verificador de URL´s. <br /> Use esta função para não utilizar o Verificador de URL´s';
$PMF_LANG['ad_linkcheck_config_th_id'] = 'ID#';
$PMF_LANG['ad_linkcheck_config_th_url'] = 'URL para correspondencia';
$PMF_LANG['ad_linkcheck_config_th_reason'] = 'Motivo correspondente';
$PMF_LANG['ad_linkcheck_config_th_owner'] = 'Entrada do proprietário';
$PMF_LANG['ad_linkcheck_config_th_enabled'] = 'Definir para permitir a entrada';
$PMF_LANG['ad_linkcheck_config_th_locked'] = 'Defina a propriedade de bloqueio';
$PMF_LANG['ad_linkcheck_config_th_chown'] = 'Definir para obter a propriedade';
...
$PMF_LANG['ad_user_loginname'] = 'Nome de Login:';
...
$LANG_CONF['main.maxAttachmentSize'] = array(0 => "input", 1 => "Tamanho máximo para anexos em Bytes (max. %sByte)");
$LANG_CONF['main.disableAttachments'] = array(0 => "checkbox", 1 => "Põe os links dos anexos abaixo das entradas?");
...
$LANG_CONF['main.numberOfShownNewsEntries'] = array(0 => "input", 1 => "Número de artigos novos");
