...
$PMF_LANG['msgNewContentAddon'] = 'A sua proposta não será publicada imediatamente e será avaliada pelos editores. Os campos obrigatórios são <strong>Nome</strong>, <strong>E-mail</strong>, <strong>Categoria</strong>, <strong>Titulo</strong> e <strong>Conteúdo</strong>. Por favor separe as palavras-chave somente com espaços.';
...
$PMF_LANG['msgNoQuestionsAvailable'] = 'Atualmente não existem perguntas disponiveis.';
$PMF_LANG['msgNewQuestion'] = 'Você pode adicionar aqui suas perguntas.';
...
$PMF_LANG['msgQuestionText'] = 'Aqui pode ver algumas perguntas de outros usuários. Se quiser contribuir com respostas para essas perguntas, elas serão entradas no FAQ.';
...
$LANG_CONF['records.disableAttachments'] = array(0 => 'checkbox', 1 => 'Colocar links para anexos no rodapé das entradas?');
...
$LANG_CONF['main.enableRewriteRules'] = array(0 => 'checkbox', 1 => 'Ativa o suporte ao mod_rewrite (padrão: desativado)');
$LANG_CONF['ldap.ldapSupport'] = array(0 => 'checkbox', 1 => 'Habilita o suporte ao LDAP? (padrão: desativado)');
...
$LANG_CONF['main.enableWysiwygEditor'] = array(0 => 'checkbox', 1 => 'Habilitar o editor WYSIWYG do pacote (padrão: ativado)');
...
$LANG_CONF['records.defaultAttachmentEncKey'] = array(0 => 'input', 1 => 'Chave padrão para criptografia de anexos<br><small>Ignorado quando os anexos estão desabilitados</small><br><small><font color="red">AVISO: Não altere esta chave depois de habilitar a opção de criptografia de anexos!!!</font></small>');
...
$LANG_CONF['main.enableWysiwygEditorFrontend'] = array(0 => 'checkbox', 1 => 'Ativar editor WYSIWYG no frontend (padrão: desativado)');
$LANG_CONF['main.enableGravatarSupport'] = array(0 => 'checkbox', 1 => 'Suporte para Gravatar (padrão: desativado)');
