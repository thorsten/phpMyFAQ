...
$PMF_LANG['msgFullCategories'] = 'Categorias com respostas';
$PMF_LANG['msgFullCategoriesIn'] = 'Categorias com respostas em ';
$PMF_LANG['msgSubCategories'] = 'Subcategorias';
$PMF_LANG['msgEntries'] = 'Respostas';
$PMF_LANG['msgEntriesIn'] = 'Respostas em ';
...
$PMF_LANG['msgVoteUseability'] = 'Avalie esta resposta:';
...
$PMF_LANG['msgS2FText2'] = 'Você encontrará a resposta no seguinte endereço:';
...
$PMF_LANG['msgNewContentAddon'] = 'A sua proposta não será publicada imediatamente, mas será avaliada pelos editores. Os campos obrigatórios são <strong>Nome</strong>, <strong>E-mail</strong>, <strong>Categoria</strong>, <strong>Cabeçalho</strong> e <strong>Conteúdo</strong>. Por favor separe as palavras chave por espaços apenas.';
...
$PMF_LANG['msgDate_User'] = 'Data / Usuáo';
$PMF_LANG['msgQuestion2'] = 'Questão';
$PMF_LANG['msg2answer'] = 'resposta';
$PMF_LANG['msgQuestionText'] = 'Aqui pode ver algumas questões de outros usuários. Pode contribuir com respostas a estas questões, as suas respostas serão inseridas no FAQ.';
...
$PMF_LANG['msgHomeArticlesOnline'] = ' respostas online';
$PMF_LANG['msgNoNews'] = 'Sem notícias disponiveis.';
$PMF_LANG['msgLatestArticles'] = 'Últimas Respostas';
$PMF_LANG['msgMailThanks'] = 'Obrigado por sua proposta para o FAQ.';
$PMF_LANG['msgMailCheck'] = 'Existe uma nova resposta no FAQ! Veja a seção de Administração';
...
$PMF_LANG['err_VoteTooMuch'] = '<p>Você já votou. <a href="nojavascript...history.back();">Clique aqui</a>, para voltar.</p>';
...
$PMF_LANG['err_sendMail'] = 'Campos obrigatórios são <strong>nome</strong>, <strong>e-mail</strong> and <strong>questão</strong>!<br /><br /><a href="nojavascript...history.back();">voltar</a><br /><br />';
$PMF_LANG['help_search'] = '<p><strong>Pesquisar respostas:</strong><br /></p>';
$PMF_LANG['ad'] = 'Seção Administração';
$PMF_LANG['ad_menu_user_administration'] = 'Administração de Usuários';
$PMF_LANG['ad_menu_entry_aprove'] = 'Aprovar Respostas';
$PMF_LANG['ad_menu_entry_edit'] = 'Editar Respostas';
...
$PMF_LANG['ad_cookie_no'] = 'Não existe nenhum cookie salvo. Com um cookie pode evitar fazer o login:';
...
$PMF_LANG['ad_entry_add'] = 'Adicionar uma Resposta';
$PMF_LANG['ad_csv_make'] = 'Um backup é uma imagem completa do conteúdo da base de dados. Um backup deve ser feito pelo menos uma vez por mês. O formato do backup é suportado nativamente pelo MySQL pelo que pode ser usado em aplicações externas tal como phpMyAdmin ou pela linha de comandos com o cliente mysql.';
...
$PMF_LANG['err_SaveQuestion'] = 'Campos obrigatórios: <strong>Nome</strong>, <strong>e-mail</strong> e <strong>a sua questão</strong>!<br /><br /><a href="nojavascript...history.back();">voltar atrás</a><br /><br />';
...
$PMF_LANG['ad_entry_new_revision'] = 'Criar nova revisdão?';
...
$PMF_LANG['ad_stat_choose'] = 'Escolhe o mês';
...
$PMF_LANG['ad_linkcheck_noReferenceURL'] = 'Verificação de links automática desativada (URL base não configurada)';
$PMF_LANG['ad_linkcheck_noAllowUrlOpen'] = 'Verificação de links automática desativada (a opção de PHP \'option allow_url_fopen\' não esta Habilidata)';
$PMF_LANG['ad_linkcheck_checkResult'] = 'Resultado da verificação de links automática';
$PMF_LANG['ad_linkcheck_checkSuccess'] = 'Nenhum erro!';
$PMF_LANG['ad_linkcheck_checkFailed'] = 'Falhou!';
$PMF_LANG['ad_linkcheck_failReason'] = 'Razões para falhar:';
$PMF_LANG['ad_linkcheck_noLinksFound'] = 'No URLs compatible with link verifier feature found.';
$PMF_LANG['ad_linkcheck_searchbadonly'] = 'Somente com links problemáticos';
...
$PMF_LANG['ad_linkcheck_openurl_notready'] = 'Verificador de Links não está pronto.';
...
$PMF_LANG['ad_entry_visibility'] = 'Publicado?';
...
$PMF_LANG['ad_user_deleteUser'] = 'Apagar Usuário';
...
$PMF_LANG['ad_export_type_choose'] = 'Escolha um formato suportado:';
...
$PMF_LANG['ad_export_gen_docbook'] = 'Criar arquivo Docbook';
$PMF_LANG['ad_news_data'] = 'Data';
$PMF_LANG['ad_news_author_name'] = 'Nome do autor:';
$PMF_LANG['ad_news_author_email'] = 'Email do autor:';
...
$PMF_LANG['admin_mainmenu_configuration'] = 'Configurações';
...
$PMF_LANG['ad_linkcheck_feedback_url-disabled'] = 'Desabilitado';
...
$PMF_LANG['msg_related_articles'] = 'Respostas relacionadas';
...
$PMF_LANG['msgUsersOnline'] = ' :: %d Visitante(s) e %d Registrado(s)';
...
$PMF_LANG['ad_conf_order_thema'] = 'Ttítulo';
...
$PMF_LANG['msgInstantResponse'] = 'Resposta Instantânea';
$PMF_LANG['msgInstantResponseMaxRecords'] = '. Find below the first %d records.';
$PMF_LANG['msgAllCatArticles'] = 'Perguntas nesta categoria';
$PMF_LANG['msgDescriptionInstantResponse'] = 'Digite sua dúvida e encontre respostas ...';
$PMF_LANG['msgTagSearch'] = 'Tagged entries';
$PMF_LANG['ad_pmf_info'] = 'Informações do phpMyFAQ';
$PMF_LANG['ad_online_info'] = 'Verificar versão online';
$PMF_LANG['ad_system_info'] = 'Informações do Sistemas';
$PMF_LANG['msgRegisterUser'] = 'Do you want to register?';
$PMF_LANG['ad_user_loginname'] = 'Nome de Usuário:';
$PMF_LANG['errorRegistration'] = 'Este campo é necessário!';
$PMF_LANG['submitRegister'] = 'Registro';
...
$PMF_LANG['ad_menu_searchstats'] = 'Buscar Estatísticas';
$PMF_LANG['ad_searchstats_search_term'] = 'Keyword';
$PMF_LANG['ad_searchstats_search_term_count'] = 'Contador';
$PMF_LANG['ad_searchstats_search_term_lang'] = 'Idioma';
$PMF_LANG['ad_searchstats_search_term_percentage'] = 'Porcentagem';
...
$PMF_LANG['ad_start_notactive'] = 'Aguardando ativação';
$PMF_LANG['msgTransToolAddNewTranslation'] = 'Adicionar nova tradução';
$PMF_LANG['msgTransToolLanguage'] = 'Traduções';
$PMF_LANG['msgTransToolActions'] = 'Ações';
$PMF_LANG['msgTransToolWritable'] = 'Escrita permitida';
$PMF_LANG['msgEdit'] = 'Editar';
$PMF_LANG['msgDelete'] = 'Deletar';
$PMF_LANG['msgYes'] = 'sim';
$PMF_LANG['msgNo'] = 'não';
$PMF_LANG['msgTransToolSureDeleteFile'] = 'Você tem certeza que deseja apagar esta tradução?';
$PMF_LANG['msgTransToolFileRemoved'] = 'Tradução removida com sucesso';
$PMF_LANG['msgTransToolErrorRemovingFile'] = 'Erro ao remover a tradução';
...
$PMF_LANG['msgTransToolFileSaved'] = 'Tradução salva com sucesso';
$PMF_LANG['msgTransToolErrorSavingFile'] = 'Erro ao salvar a tradução';
$PMF_LANG['msgLanguage'] = 'Idioma';
$PMF_LANG['msgTransToolLanguageCharset'] = 'Charset da tradução';
$PMF_LANG['msgTransToolLanguageDir'] = 'Direção da tradução';
$PMF_LANG['msgTransToolLanguageDesc'] = 'Descrição da tradução';
...
$PMF_LANG['msgTransToolCouldntCreateTrans'] = 'Erro ao criar tradução';
$PMF_LANG['msgAdding3Dots'] = 'adicionando ...';
$PMF_LANG['msgTransToolSendToTeam'] = 'Enviar para a equipe do phpMyFAQ';
$PMF_LANG['msgSending3Dots'] = 'enviando ...';
$PMF_LANG['msgTransToolFileSent'] = 'A tradução foi enviada com sucesso para a equipe phpMyFAQ.  Muito obrigado por compartilhar.';
...
$LANG_CONF['main.send2friendText'] = array(0 => "area", 1 => "Texto para página send2friend");
$LANG_CONF['main.maxAttachmentSize'] = array(0 => "input", 1 => "Tamanho máximo para anexos em Bytes (max. %sByte)");
$LANG_CONF['main.disableAttachments'] = array(0 => "checkbox", 1 => "Por os links dos anexos abaixo das entradas?");
...
$LANG_CONF['main.referenceURL'] = array(0 => "input", 1 => "URL base para confirmação de link (ex.: http://www.example.org/faq)");
