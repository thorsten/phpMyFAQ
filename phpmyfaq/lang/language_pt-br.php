...
$PMF_LANG['ad_pmf_info'] = 'Informação do phpMyFAQ';
...
$PMF_LANG['msgSendMailDespiteEverything'] = 'Não, ainda não existe uma resposta adequada (um email será enviado)';
...
$LANG_CONF['main.enableWysiwygEditor'] = array(0 => 'checkbox', 1 => 'Habilitar o editor WYSIWYG do pacote (padrão: habilitado)');
$LANG_CONF['records.attachmentsPath'] = array(0 => 'input', 1 => 'Caminho onde os anexos serão salvos.<br /><small>Caminho relativo significa uma pasta dentro da raiz da web</small>');
...
$LANG_CONF['search.numberSearchTerms'] = array(0 => 'input', 1 => 'Número de termos de busca listados');
$LANG_CONF['records.orderingPopularFaqs'] = array(0 => 'select', 1 => 'Ordenação das top faq\'s');
$LANG_CONF['main.optionalMailAddress'] = array(0 => 'checkbox', 1 => 'Email como campo obrigatório (padrão: desativado)');
...
$LANG_CONF['main.templateSet'] = array(0 => 'select', 1 => 'Template definida para uso');
$LANG_CONF['records.enableAttachmentEncryption'] = array(0 => 'checkbox', 1 => 'Habilitar criptografia dos anexos <br><small>Ignorado quando os anexos estão desabilitados</small>');
$LANG_CONF['records.defaultAttachmentEncKey'] = array(0 => 'input', 1 => 'Chave de criptografia de anexo padrão<br><small>Ignorado quando os anexos estão desabulitados</small><br><small><font color="red">AVISO: Do not change this once set and enabled file encryption!!!</font></small>');
$LANG_CONF['security.useSslForLogins'] = array(0 => 'checkbox', 1 => 'Permitir logins apenas com conexão segura? (padrão: desabilitado)');
...
$LANG_CONF['cache.varnishEnable'] = array(0 => 'checkbox', 1 => 'Habilitar suporte a Varnish >=3.0<br><small>Será preciso ter a extensão PECL varnish</small>');
...
$LANG_CONF['records.enableCloseQuestion'] = array(0 => 'checkbox', 1 => 'Fechar pergunta aberta após respondê-la?');
$LANG_CONF['records.enableDeleteQuestion'] = array(0 => 'checkbox', 1 => 'Apagar pergunta aberta após repondê-la?');
...
$LANG_CONF['main.maintenanceMode'] = array(0 => 'checkbox', 1 => 'FAQ em modo de manutenção');
...
$LANG_CONF['search.enableRelevance'] = array(0 => 'checkbox', 1 => 'Ativar suporte à relevância? (padrão: desabilitado)');
$LANG_CONF['socialnetworks.enableTwitterSupport'] = array(0 => 'checkbox', 1 => 'Suporte ao Twitter (padrão: desativado)');
