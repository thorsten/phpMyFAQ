...
$LANG_CONF['main.languageDetection'] = array("checkbox", "Habilita negociação automática de conteúdo");
...
$LANG_CONF['main.contactInformations'] = array('area', 'Contato');
...
$LANG_CONF['main.referenceURL'] = array('input', 'Suporte URL para verificação de link (e.g.: http://www.example.org/faq/)');
...
$LANG_CONF['cache.varnishEnable'] = array('checkbox', 'Habilitar suporte a Varnish >=3.0<br><small>É necessário ter a extensão PECL varnish instalada</small>');
$LANG_CONF['cache.varnishHost'] = array('input', 'Host Varnish');
$LANG_CONF['cache.varnishPort'] = array('input', 'Porta Varnish');
$LANG_CONF['cache.varnishSecret'] = array('input', 'Senha Varnish');
...
$LANG_CONF['records.autosaveActive'] = array('checkbox', 'Ativar gravação automática do FAQ');
$LANG_CONF['records.autosaveSecs'] = array('input', 'Intervalo para gravação automática em segundos (padrão 180)');
