<?php
/**
* $Id: language_ar.php,v 1.15 2007-03-11 21:09:54 thorstenr Exp $
*
...
// Help
$PMF_LANG["msgHelpText"] = "<p>طريقة بناء برنامج الاسئلة المتكررة سهل جدا , وتسطيع أن تبحث عن الأسئلة إما �?ي   . <a href=\"".$_SERVER["PHP_SELF"]."?sid=".isset($_GET["sid"])."&amp;aktion=anzeigen\">التصني�?ات</a> أو تستعمل <a
...
$LANG_CONF["detection"] = array(0 => "checkbox", 1 => "ت�?عيل خاصية تبادل المحتوى التلقائي ؟");
...
$LANG_CONF["spamCheckBannedWords"] = array(0 => "checkbox", 1 => "�?حص محتويات النماذج العامة ضد الكلمات الممنوعة(الأصل : نشط) ");
