...
$LANG_CONF['main.maxAttachmentSize'] = array(0 => "input", 1 => "أقصى حجم للمرفقات بالبايت (max. %sبايت)");
$LANG_CONF['main.disableAttachments'] = array(0 => "checkbox", 1 => "ضع روابط المرفقات أسفل المداخلات ؟");
