...
href=\"".$_SERVER["PHP_SELF"]."?sid=".isset($_GET["sid"])."&amp;aktion=search\">محرك بحث الموقع</a> للبحث بكلمة معينة .</p>";
...
$LANG_CONF["language"] = array(0 => "select", 1 => "ملف اللغة");
$LANG_CONF["detection"] = array(0 => "checkbox", 1 => "تفعيل خاصية تبادل المحتوى التلقائي ؟");
$LANG_CONF["title"] = array(0 => "input", 1 => "عنوان البرنامج ");
$LANG_CONF["version"] = array(0 => "print", 1 => "نسخة البرنامج");
$LANG_CONF["metaDescription"] = array(0 => "input", 1 => "وصف الصفحة");
$LANG_CONF["metaKeywords"] = array(0 => "input", 1 => "كلمات البحث لمحركات البحث");
$LANG_CONF["metaPublisher"] = array(0 => "input", 1 => "إسم الناشر");
$LANG_CONF["adminmail"] = array(0 => "input", 1 => "البريد الإلكتروني للمشرف");
$LANG_CONF["msgContactOwnText"] = array(0 => "area", 1 => "معلومات الإتصال");
$LANG_CONF["copyright_eintrag"] = array(0 => "area", 1 => "حقوق النشر في صفحة البداية");
$LANG_CONF["send2friend_text"] = array(0 => "area", 1 => "نص لصفحة أرسل إلي صديق");
$LANG_CONF["attmax"] = array(0 => "input", 1 => "أقصى حجم للمرفقات بالبايت (max. ".ini_get("upload_max_filesize")."بايت)");
$LANG_CONF["disatt"] = array(0 => "checkbox", 1 => "ضع روابط المرفقات أسفل المداخلات ؟");
$LANG_CONF["tracking"] = array(0 => "checkbox", 1 => "استخدم خاصية التتبع ؟");
$LANG_CONF["enableadminlog"] = array(0 => "checkbox", 1 => "استخدم خاصية سجل المشرفين ؟");
$LANG_CONF["ipcheck"] = array(0 => "checkbox", 1 => "Do you want the IP to be checked when checking the UINs in admin.php?");
$LANG_CONF["numRecordsPage"] = array(0 => "input", 1 => "عدد المواضيع المعروضة بالصفحة الواحدة");
$LANG_CONF["numNewsArticles"] = array(0 => "input", 1 => "عدد مقالات الأخبار");
$LANG_CONF["bannedIP"] = array(0 => "area", 1 => "حجب ومنع هذة العناوين");
