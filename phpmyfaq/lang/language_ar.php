...
$PMF_LANG['plmsgHomeArticlesOnline']['2'] = 'There are %d FAQs online';
$PMF_LANG['plmsgHomeArticlesOnline']['3'] = 'There are %d FAQs online';
$PMF_LANG['plmsgHomeArticlesOnline']['4'] = 'There are %d FAQs online';
$PMF_LANG['plmsgHomeArticlesOnline']['5'] = 'There are %d FAQs online';
$PMF_LANG['plmsgViews']['0'] = '%d view';
$PMF_LANG['plmsgViews']['1'] = '%d views';
$PMF_LANG['plmsgViews']['2'] = '%d views';
$PMF_LANG['plmsgViews']['3'] = '%d views';
$PMF_LANG['plmsgViews']['4'] = '%d views';
$PMF_LANG['plmsgViews']['5'] = '%d views';
$PMF_LANG['plmsgGuestOnline']['0'] = '%d Guest';
$PMF_LANG['plmsgGuestOnline']['1'] = '%d Guests';
$PMF_LANG['plmsgGuestOnline']['2'] = '%d Guests';
$PMF_LANG['plmsgGuestOnline']['3'] = '%d Guests';
$PMF_LANG['plmsgGuestOnline']['4'] = '%d Guests';
$PMF_LANG['plmsgGuestOnline']['5'] = '%d Guests';
$PMF_LANG['plmsgRegisteredOnline']['0'] = ' and %d Registered';
$PMF_LANG['plmsgRegisteredOnline']['1'] = ' and %d Registered';
$PMF_LANG['plmsgRegisteredOnline']['2'] = ' and %d Registered';
$PMF_LANG['plmsgRegisteredOnline']['3'] = ' and %d Registered';
$PMF_LANG['plmsgRegisteredOnline']['4'] = ' and %d Registered';
$PMF_LANG['plmsgRegisteredOnline']['5'] = ' and %d Registered';
$PMF_LANG['plmsgSearchAmount']['0'] = '%d search result';
$PMF_LANG['plmsgSearchAmount']['1'] = '%d search results';
$PMF_LANG['plmsgSearchAmount']['2'] = '%d search results';
$PMF_LANG['plmsgSearchAmount']['3'] = '%d search results';
$PMF_LANG['plmsgSearchAmount']['4'] = '%d search results';
$PMF_LANG['plmsgSearchAmount']['5'] = '%d search results';
$PMF_LANG['plmsgPagesTotal']['0'] = ' %d Page';
$PMF_LANG['plmsgPagesTotal']['1'] = ' %d Pages';
$PMF_LANG['plmsgPagesTotal']['2'] = ' %d Pages';
$PMF_LANG['plmsgPagesTotal']['3'] = ' %d Pages';
$PMF_LANG['plmsgPagesTotal']['4'] = ' %d Pages';
$PMF_LANG['plmsgPagesTotal']['5'] = ' %d Pages';
$PMF_LANG['plmsgVotes']['0'] = '%d Vote';
$PMF_LANG['plmsgVotes']['1'] = '%d Votes';
$PMF_LANG['plmsgVotes']['2'] = '%d Votes';
$PMF_LANG['plmsgVotes']['3'] = '%d Votes';
$PMF_LANG['plmsgVotes']['4'] = '%d Votes';
$PMF_LANG['plmsgVotes']['5'] = '%d Votes';
$PMF_LANG['plmsgEntries']['0'] = '%d FAQ';
$PMF_LANG['plmsgEntries']['1'] = '%d FAQs';
$PMF_LANG['plmsgEntries']['2'] = '%d FAQs';
$PMF_LANG['plmsgEntries']['3'] = '%d FAQs';
$PMF_LANG['plmsgEntries']['4'] = '%d FAQs';
$PMF_LANG['plmsgEntries']['5'] = '%d FAQs';
