...
$PMF_LANG["ad_entry_content"] = "ıçerik:";
...
$LANG_CONF['main.titleSSS'] = array(0 => "input", 1 => "SSS Başlığı");
...
$PMF_LANG["ad_xmlrpc_button"] = "Web servisimden son phpMySSS versiyon numarasını al";
...
$LANG_CONF["spam.enableCatpchaCode"] = array(0 => "checkbox", 1 => "Form gönderimini CAPTCHA ile koru (varsayılan: aktif).");
...
$PMF_LANG['ad_menu_linkconfig'] = 'URL Kontrol Edici';
$PMF_LANG['ad_linkcheck_config_title'] = 'URL Kontrol Edici Ayarları';
$PMF_LANG['ad_linkcheck_config_disabled'] = 'URL Kontrol Edici özelliği kapalı';
$PMF_LANG['ad_linkcheck_config_warnlist'] = 'Uyarılacak URL\'ler';
$PMF_LANG['ad_linkcheck_config_ignorelist'] = 'Gözardı edilecek URL\'ler';
$PMF_LANG['ad_linkcheck_config_warnlist_description'] = 'Aşağıdakiler ile öneklenmiş URL\'ler için geçerli olsalar da olmasalar da uyarı yaratılacaktır.<br />Bu özelliği kısa süre içinde çalışmaz duruma gelecek URL\'ler için kullanın.';
$PMF_LANG['ad_linkcheck_config_ignorelist_description'] = 'Aşağıdaki listedekiler ile tam olarak aynı URL\'ler kontrol edilmeden geçerli kabul edileceklerdir.<br />Bu özelliği URL kontrol edicisinin onaylayamadığı URL\'leri gözardı etmek için kullanın.';
$PMF_LANG['ad_linkcheck_config_th_id'] = 'ID#';
$PMF_LANG['ad_linkcheck_config_th_url'] = 'Eşleştirilecek URL';
$PMF_LANG['ad_linkcheck_config_th_reason'] = 'Eşleşme nedeni';
$PMF_LANG['ad_linkcheck_config_th_owner'] = 'Girdi sahibi';
$PMF_LANG['ad_linkcheck_config_th_enabled'] = 'Girdileri aktifleştirmek için ayarla';
$PMF_LANG['ad_linkcheck_config_th_locked'] = 'Sahiplik kilitlemek için ayarla';
$PMF_LANG['ad_linkcheck_config_th_chown'] = 'Sahiplik almak için ayarla';
...
$PMF_LANG['captchaError'] = 'Lütfen doğru doğrulama (CAPTCHA) kodunu giriniz!';
...
$PMF_LANG['stickyRecordsHeader'] = 'Yapışkan SSSler';
...
$PMF_LANG['msgTransToolFilename'] = 'Dosya adı';
