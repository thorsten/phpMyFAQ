...
$PMF_LANG["msgPrevious"] = "trang trước";
$PMF_LANG["msgNext"] = "trang kế";
$PMF_LANG["msgCategoryUp"] = "one category up";
$PMF_LANG["msgLastUpdateArticle"] = "Cập nhật: ";
...
$PMF_LANG["msgCommentHeader"] = "Bình luận / Nhận xét";
$PMF_LANG["msgYourComment"] = "Nhận xét";
$PMF_LANG["msgCommentThanks"] = "Cảm ơn những nhận xét của bạn!";
$PMF_LANG["msgSeeXMLFile"] = "mở XML-File";
$PMF_LANG["msgSend2Friend"] = "Gửi e-mail";
$PMF_LANG["msgS2FName"] = "Tên:";
$PMF_LANG["msgS2FEMail"] = "E-mail:";
$PMF_LANG["msgS2FFriends"] = "Bạn của bạn:";
$PMF_LANG["msgS2FEMails"] = ". địa chỉ e-mail:";
$PMF_LANG["msgS2FText"] = "Văn bản sau đây sẽ được gửi đi:";
...
// Contact
$PMF_LANG["msgContactEMail"] = "Gửi e-mail đến quản trị viên của FAQ.";
$PMF_LANG["msgMessage"] = "Nội dung:";
...
$PMF_LANG["ad_menu_passwd"] = "Thay đổi mật mã";
$PMF_LANG["ad_menu_logout"] = "Thoát";
$PMF_LANG["ad_menu_startpage"] = "Trang chủ";

// Nachrichten
$PMF_LANG["ad_msg_identify"] = "Xin nhập vào tên và mật mã.";
$PMF_LANG["ad_msg_passmatch"] = "Mật mã và lặp lại mật mã phải trùng khớp nhau!";
$PMF_LANG["ad_msg_savedsuc_1"] = "Xác lập cá nhân của ";
$PMF_LANG["ad_msg_savedsuc_2"] = "đã được lưu trữ.";
$PMF_LANG["ad_msg_mysqlerr"] = "Do có lỗi trong cơ sở dữ liệu, các xác lập cá nhân không lưu trữ được.";
...
$PMF_LANG["ad_news_updatesuc"] = "Tin tức/bài đã được cập nhật.";
$PMF_LANG["ad_news_del"] = "Bạn có chắc chắn muốn xoá mục này?";
$PMF_LANG["ad_news_yesdelete"] = "Vâng, xoá đi!";
$PMF_LANG["ad_news_nodelete"] = "Không!";
$PMF_LANG["ad_news_delsuc"] = "Mục tin đã bị xoá.";
$PMF_LANG["ad_news_updatenews"] = "Cập nhật tin tức";
...
$PMF_LANG["ad_categ_update"] = "Cập nhật";
$PMF_LANG["ad_categ_delete"] = "Xoá";
$PMF_LANG["ad_categ_updatecateg"] = "Cập nhật Chuyên mục";
...
$PMF_LANG["ad_categ_updated"] = "Chuyên mục đã được cập nhật.";
$PMF_LANG["ad_categ_del_yes"] = "Vâng, xoá!";
$PMF_LANG["ad_categ_del_no"] = "Không!";
$PMF_LANG["ad_categ_deletesure"] = "Bạn chắc chắn muốn xoá chuyên mục này?";
...
// Passwd
$PMF_LANG["ad_passwd_cop"] = "Thay đổi mật mã";
$PMF_LANG["ad_passwd_old"] = "Mật mã cũ";
$PMF_LANG["ad_passwd_new"] = "Mật mã mới";
...
// Auth
$PMF_LANG["ad_auth_insert"] = "Nhập vào tên và mật mã.";
$PMF_LANG["ad_auth_user"] = "Tên đăng nhập:";
$PMF_LANG["ad_auth_passwd"] = "Mật mã:";
$PMF_LANG["ad_auth_ok"] = "OK";
$PMF_LANG["ad_auth_reset"] = "Xoá";
$PMF_LANG["ad_auth_fail"] = "Tên hoặc mật mã không hợp lệ.";
$PMF_LANG["ad_auth_sess"] = "ID của phiên làm việc hết giá trị.";
...
." Chú ý rằng  lúc đó dữ liệu hiện hành sẽ bị ghi đè lên.";
$PMF_LANG["ad_csv_file"] = "File";
$PMF_LANG["ad_csv_ok"] = "OK";
$PMF_LANG["ad_csv_linklog"] = "Sao lưu LOG";
...
$PMF_LANG["ad_menu_backup"] = "Sao lưu";
$PMF_LANG["ad_logout"] = "Phiên làm việc đã kết thúc.";
$PMF_LANG["ad_news_add"] = "Thêm tin tức";
...
$PMF_LANG["ad_stat_vpd"] = "khách/ngày";
...
$PMF_LANG["msgMainCategory"] = "Chuyên mục chính";

// Added v1.2.4 - 30.01.2003 - Thorsten
$PMF_LANG["ad_passwdsuc"] = "Mật mã của bạn đã thay đổi.";

// Added v1.3.0 - 04.03.2003 - Thorsten
$PMF_LANG["msgPDF"] = "Xem dưới dạng PDF";
$PMF_LANG["ad_xml_head"] = "Sao lưu XML";
...
$PMF_LANG["rightsLanguage"]['adduser'] = "thêm ngư�?i dùng";
$PMF_LANG["rightsLanguage"]['edituser'] = "sửa ngư�?i dùng";
$PMF_LANG["rightsLanguage"]['deluser'] = "xoá ngư�?i dùng";
$PMF_LANG["rightsLanguage"]['addbt'] = "thêm dữ liệu";
$PMF_LANG["rightsLanguage"]['editbt'] = "sửa dữ liệu";
$PMF_LANG["rightsLanguage"]['delbt'] = "xoá dữ liệu";
$PMF_LANG["rightsLanguage"]['viewlog'] = "xem log";
$PMF_LANG["rightsLanguage"]['adminlog'] = "xem admin log";
$PMF_LANG["rightsLanguage"]['delcomment'] = "xoá l�?i bình";
$PMF_LANG["rightsLanguage"]['addnews'] = "thêm tin tức";
$PMF_LANG["rightsLanguage"]['editnews'] = "sửa  tin tức";
$PMF_LANG["rightsLanguage"]['delnews'] = "xoá  tin tức";
$PMF_LANG["rightsLanguage"]['addcateg'] = "thêm chuyên mục";
$PMF_LANG["rightsLanguage"]['editcateg'] = "sửa chuyên mục";
$PMF_LANG["rightsLanguage"]['delcateg'] = "xoá chuyên mục";
$PMF_LANG["rightsLanguage"]['passwd'] = "thay đổi mật mã";
$PMF_LANG["rightsLanguage"]['editconfig'] = "sửa cấu hình";
$PMF_LANG["rightsLanguage"]['addatt'] = "thêm file đính kèm";
$PMF_LANG["rightsLanguage"]['delatt'] = "xoá file đính kèm";
$PMF_LANG["rightsLanguage"]['backup'] = "tạo bản lưu trữ";
$PMF_LANG["rightsLanguage"]['restore'] = "phục hồi bản lưu trữ";
$PMF_LANG["rightsLanguage"]['delquestion'] = "xoá câu h�?i ch�? trả l�?i";
