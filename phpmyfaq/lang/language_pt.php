<?php
/**
 * $Id: language_pt.php,v 1.30 2007-03-29 19:31:56 thorstenr Exp $
 *
...
// Help
$PMF_LANG["msgHelpText"] = "<p>As FAQ (<strong>F</strong>requently <strong>A</strong>sked <strong>Q</strong>uestions em ingl&ecirc;s) t&ecirc;m uma estrutura bastante simples. Pode procurar nas <strong><a href=\"?action=show\">categorias</a></strong> ou procure no <strong><a href=\"?action=search\">motor de busca das FAQ</a></strong>.</p>";
...
$PMF_LANG["msgMailCheck"] = "Existe um novo registo no FAQ!Veja a se&ccedil;&atilde;o de Administra&ccedil;&atilde;o";
...
$PMF_LANG["err_SaveEntries"] = "Campos obrigat&oacute;rios s&atilde;o <strong>Nome</strong>, <strong>Email</strong>, <strong>Categoria</strong>, <strong>Cabe&ccedil;alho</strong> e <strong>Texto</strong>!<br /><br /><a href=\"javascript:history.back();\">voltar</a><br /><br />";
$PMF_LANG["err_SaveComment"] = "Campos obrigat&oacute;rios s&atilde;o <strong>Nome</strong>, <strong>Email</strong> e <strong>Coment&aacute;rio</strong>!<br /><br /><a href=\"javascript:history.back();\">voltar</a><br /><br />";
...
$PMF_LANG["err_sendMail"] = "Campos obrigat&oacute;rios s&atilde;o <strong>nome</strong>, <strong>email</strong> and <strong>quest&atilde;o</strong>!<br /><br /><a href=\"javascript:history.back();\">voltar</a><br /><br />";
...
$LANG_CONF['main.language'] = array(0 => "select", 1 => "Ficheiro de Linguagem");
...
$LANG_CONF["main.enableUserTracking"] = array(0 => "checkbox", 1 => "usar Tracking?");
$LANG_CONF["main.enableAdminLog"] = array(0 => "checkbox", 1 => "usar Adminlog?");
$LANG_CONF["main.ipCheck"] = array(0 => "checkbox", 1 => "Conferir o IP ao verificar o UINs no admin.php?");
$LANG_CONF["main.numberOfRecordsPerPage"] = array(0 => "input", 1 => "N&uacute;mero de t&oacute;picos mostrados por p&aacute;gina");
$LANG_CONF["main.numberOfShownNewsEntries"] = array(0 => "input", 1 => "N&uacute;ero de artigos de not&iacute;cias");
$LANG_CONF['main.bannedIPs'] = array(0 => "area", 1 => "Banir estes IPs");
$LANG_CONF["main.enableRewriteRules"] = array(0 => "checkbox", 1 => "Activar suporte de  mod_rewrite? (por defeito: desactivado)");
...
$LANG_CONF["spam.enableCatpchaCode"] = array(0 => "checkbox", 1 => "Usar c&oacute;digo catpcha para permitir submeter formul&aacute;rios p&uacute;blicos (por defeito: activado).");
