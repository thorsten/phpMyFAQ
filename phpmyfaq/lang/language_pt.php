...
$PMF_LANG['rightsLanguage']['add_user'] = 'adicionar utilizador';
$PMF_LANG['rightsLanguage']['edit_user'] = 'editar utilizador';
$PMF_LANG['rightsLanguage']['delete_user'] = 'apagar utilizador';
$PMF_LANG['rightsLanguage']['add_faq'] = 'adicionar registo';
$PMF_LANG['rightsLanguage']['edit_faq'] = 'editar registo';
$PMF_LANG['rightsLanguage']['delete_faq'] = 'apagar registo';
...
$LANG_CONF['main.contactInformations'] = array('area', 'Informação de contacto');
...
$LANG_CONF['main.referenceURL'] = array('input', 'URL-base para verificação de <em>links</em> <small>( ex.: http://www.example.org/faq/ )</small>');
...
$LANG_CONF['records.autosaveActive'] = array('checkbox', 'Ativar a autogravação de registos');
$LANG_CONF['records.autosaveSecs'] = array('input', 'Intervalo para autogravação <small>(segundos)</small>, <small>(pré-definição: 180)</small>');
