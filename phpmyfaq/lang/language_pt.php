...
$LANG_CONF['security.ipCheck'] = array(0 => "checkbox", 1 => "Conferir o IP ao verificar o UINs no <em>admin.php</em> ?");
...
$LANG_CONF['security.ldapSupport'] = array(0 => "checkbox", 1 => "Activar o suporte para LDAP? <small>(pré-definição: desactivado)</small>");
...
$LANG_CONF['records.enableAttachmentEncryption'] = array(0 => "checkbox", 1 => "Activar a cifragem (encriptação) de anexos<br><small>(não será usada caso a opção de anexação de ficheiros se encontrar desactivada)</small>");
$LANG_CONF['records.defaultAttachmentEncKey'] = array(0 => "input", 1 => 'Chave pré-definida para cifragem (encriptação) dos anexos <br><small>(não será usada caso a opção de encriptação de anexos se encontrar desactivada).</small><br><small style="color: red"><strong>Atenção</strong>: <strong>Não alterar</strong> depois da chave ter sido definida e a opção de encriptação de anexos ter sido activada.</small>');
...
$LANG_CONF['security.useSslForLogins'] = array(0 => 'checkbox', 1 => "Permitir a validação apenas no modo seguro? (<small>HTTPS</small>) <small>(pré-definição: desactivada)</small>");
