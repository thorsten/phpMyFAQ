...
$PMF_LANG['err_SaveEntries'] = 'Campos obrigatórios: <strong>Nome</strong>, <strong><em>E-mail</em></strong>, <strong>Questão</strong> e, quando exigido, o código <strong><a href="http://en.wikipedia.org/wiki/Captcha" title="Informação sobre Captcha na Wikipedia - versão em inglês" target="_blank"><em>Captcha</em></a></strong>.';
$PMF_LANG['err_SaveComment'] = 'Campos obrigatórios: <strong>Nome</strong>, <strong><em>E-mail</em></strong>, <strong>Comentário</strong> e, quando exigido, o código <strong><a href="http://en.wikipedia.org/wiki/Captcha" title="Informação sobre Captcha na Wikipedia - versão em inglês" target="_blank"><em>Captcha</em></a></strong>.';
...
$PMF_LANG['ad_news_add'] = 'Gravar a notícia';
$PMF_LANG['ad_news_id'] = '#';
...
$PMF_LANG['ad_passwd_change'] = 'Alteração de \'password\'';
...
$PMF_LANG['ad_csv_restore'] = 'Através deste formulário pode restaurar o conteúdo da base de dados usando um <em>backup</em> efectuado previamente pelo phpMyFAQ.<br />Atenção: os dados existentes <strong>serão apagados</strong>.';
...
$PMF_LANG['ad_entry_intlink'] = 'Seleccione um registo de FAQ para o inserir como <em>link</em>…';
...
$PMF_LANG['ad_categ_remark_overview'] = '<em>Nota</em>: só se pode obter e apresentar a <em>ordenação&nbsp;correcta</em> das categorias caso <em>todas existam</em> no idioma actual (primeira coluna).';
...
$LANG_CONF['main.defaultAttachmentEncKey'] = array(0 => "input", 1 => 'Chave pré-definida para cifragem (encriptação) dos anexos <br><small>(não será usada caso a opção de encriptação de anexos se encontrar desactivada).</small><br><small style="color: red"><strong>Atenção</strong>: <strong>Não alterar</strong> depois da chave ter sido definida e a opção de encriptação de anexos ter sido activada.</small>');
