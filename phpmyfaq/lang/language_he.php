...
$PMF_LANG["msgOpenQuestions"] = "פתח שאלות";
$PMF_LANG["msgHelp"] = "עזרה";
$PMF_LANG["msgContact"] = "תוכן";
...
// Contentpages
$PMF_LANG["msgFullCategories"] = "קטגוריות עם רשומות";
$PMF_LANG["msgFullCategoriesIn"] = "קטגוריות עם רשומות פנימיות ";
...
$PMF_LANG["msgAuthor"] = "כותב:";
$PMF_LANG["msgPrinterFriendly"] = "גרסה להדפסה";
$PMF_LANG["msgPrintArticle"] = "הדפס רשומה זאת";
...
$PMF_LANG["msgVoteBad"] = "לגמרי לא שימושי";
...
$PMF_LANG["msgWriteComment"] = "להעיר על ערך זה";
$PMF_LANG["msgShowCategory"] = "לראות מידע";
$PMF_LANG["msgCommentBy"] = "להעיר על";
$PMF_LANG["msgCommentHeader"] = "להעיר על ערך זה";
$PMF_LANG["msgYourComment "] = "הערותיך:";
$PMF_LANG["msgCommentThanks"] = "תודה רבה על ההערות:";
...
$PMF_LANG["msgS2FText2"] = "תמצא את הרשומה בכתובת הבאה:";
...
// Search
$PMF_LANG["msgSearchWord"] = "מילת מפתח";
$PMF_LANG["msgSearchFind"] = "חפש תוצאות ל";
$PMF_LANG["msgSearchAmount"] = "חפש תוצאה";
$PMF_LANG["msgSearchAmounts"] = "חפש תוצאות";
$PMF_LANG["msgSearchCategory"] = "קטגוריה: ";
$PMF_LANG["msgSearchContent"] = "תוכן: ";

// new Content
$PMF_LANG["msgNewContentHeader"] = "הצע לנו שאלה נפוצה: ";
$PMF_LANG["msgNewContentAddon"] = "הצעתך לא תתפרסם מיד, רק לאחר אישור המנהלים. שדות נחוצים <strong>שמך</strong>, <strong>כתובת אמייל</strong>, <strong>קאטגוריה</strong>, <strong>כותרת</strong> ו <strong>רשומה</strong>. הפרד בין המילים בעזרת מקש spacebar בלבד.";
$PMF_LANG["msgNewContentName"] = "שמך:";
$PMF_LANG["msgNewContentMail"] = "כתובת הדואל שלך:";
$PMF_LANG["msgNewContentCategory"] = "איזו קטגוריה לבחור?";
$PMF_LANG["msgNewContentTheme"] = "כותרת:";
$PMF_LANG["msgNewContentArticle"] = "השאלה הנפוצה שלך:";
$PMF_LANG["msgNewContentKeywords"] = "מילות מפתח:";
$PMF_LANG["msgNewContentLink"] = "קישור לשאלה זאת";
$PMF_LANG["msgNewContentSubmit"] = "שלח";
$PMF_LANG["msgInfo"] = "עוד מידע:";
$PMF_LANG["msgNewContentThanks"] = "תודה על הצעתך!";
$PMF_LANG["msgNoQuestionsAvailable"] = "אין כרגע שאלות ממתינות.";

// ask Question
$PMF_LANG["msgNewQuestion"] = "שאל את שאלתך מתחת:";
$PMF_LANG["msgAskCategory"] = "שאלתך לגבי קטגוריה:";
...
$PMF_LANG["msgQuestionText"] = "כאן תוכל לראות שאלות שנשאלו על ידי משתמשים אחרים. אם הינך יודע את התשובה לשאלה, תשובתך תתווסף לשאלות הנפוצות.";
...
// Contact
$PMF_LANG["msgContactEMail"] = "שלח דואל למנהל:";
$PMF_LANG["msgMessage"] = "הודעתך:";

// Startseite
$PMF_LANG["msgNews"] = "חדשות ";
$PMF_LANG["msgTopTen"] = "עשרת הגדולים";
$PMF_LANG["msgHomeThereAre"] = "ישנם ";
$PMF_LANG["msgHomeArticlesOnline"] = " רשומות מחוברות";
$PMF_LANG["msgNoNews"] = "אין חדשות.";
$PMF_LANG["msgLatestArticles"] = "חמשת השאלות שנשלחו לאחרונה:";

// E-Mailbenachrichtigung
$PMF_LANG["msgMailThanks"] = "תודה רבה על הצעתך למאגר.";
$PMF_LANG["msgMailCheck"] = "יש שאלה נפוצה חדשה!\n אנא בדוק את אזור הניהול!";
$PMF_LANG["msgMailContact"] = "שאלתך נשלחה למנהל.";

// Fehlermeldungen
$PMF_LANG["err_noDatabase"] = "אין בסיס נתונים זמין.";
$PMF_LANG["err_noHeaders"] = "לא נמצאו קטגוריות.";
$PMF_LANG["err_noArticles"] = "<p>לא נמצאו רשומות.</p>";
$PMF_LANG["err_badID"] = "<p>מספר שגוי.</p>";
$PMF_LANG["err_noTopTen"] = "<p>אין עשרה גדולים עדיין.</p>";
$PMF_LANG["err_nothingFound"] = "<p>אף רשומה לא נמצאה.</p>";
$PMF_LANG["err_SaveEntries"] = "שדות נחוצים הם <strong>שמך</strong>, <strong>הדואל שלך</strong>, <strong>קטגוריה</strong>, <strong>כותרת</strong> ו<strong>הרשומה שלך</strong>!<br /><br />\n<a href=\"javascript:history.back();\">הקודם</a><br /><br />\n";
...
// Hilfe zur Suche
$PMF_LANG["help_search"] = "<p><strong>חפש רשומות:</strong><br />עם ערך כמו <strong style=\"color: Red;\">מילה 1 מילה 2</strong> הנך יכול לבצע חיפוש לשניים או יותר קריטריונים.</p><p><strong>הערה:</strong> קריטריוני החיפוש שלך חייבים להכיל 4 או יותר אותיות אחרת בקשתך תידחה.</p>";

// Menü
$PMF_LANG["ad"] = "אזור הניהול";
$PMF_LANG["ad_menu_user_administration"] = "ניהול משתמשים";
$PMF_LANG["ad_menu_entry_aprove"] = "אשר רשומה";
$PMF_LANG["ad_menu_entry_edit"] = "ערוך רשומה";
...
$PMF_LANG["ad_menu_cookie"] = "קוקיס";
$PMF_LANG["ad_menu_session"] = "ראה session";
...
$PMF_LANG["ad_msg_noauth"] = "אינך מאושר.";
...
$PMF_LANG["ad_user_rights"] = "זכויות משתמשים";
...
$PMF_LANG["ad_user_rights"] = "זכויות";
...
// Beitragsverwaltung
$PMF_LANG["ad_entry_aor"] = "ניהול רשומות";
$PMF_LANG["ad_entry_id"] = "מספר";
$PMF_LANG["ad_entry_topic"] = "נושא";
$PMF_LANG["ad_entry_action"] = "פעולה";
$PMF_LANG["ad_entry_edit_1"] = "ערוך רשומה";
$PMF_LANG["ad_entry_edit_2"] = "";
$PMF_LANG["ad_entry_theme"] = "מוטיב:";
...
$PMF_LANG["ad_entry_date"] = "מידע:";
$PMF_LANG["ad_entry_changed"] = "שונה?";
...
$PMF_LANG["ad_entry_back"] = "חזור לכתבה";
...
$PMF_LANG["ad_entry_del_1"] = "האם אתה בטוח שהנושא";
$PMF_LANG["ad_entry_del_2"] = "של";
$PMF_LANG["ad_entry_del_3"] = "צריך להמחק?";
$PMF_LANG["ad_entry_delsuc"] = "הנושא נמחק <strong>בהצלחה</strong>.";
$PMF_LANG["ad_entry_delfail"] = "הנושא <strong>לא נמחק</strong>!";
$PMF_LANG["ad_entry_back"] = "חזור";


// Newsverwaltung
 $PMF_LANG["ad_news_header"] = "כותרת המאמר";
$PMF_LANG["ad_news_text"] = "רשום כאן רשומה";
...
$PMF_LANG["ad_news_link_faq"] = "קשר בתוך השאלה הנפוצה";
...
$PMF_LANG["ad_news_del"] = "האם אתה בטוח שברצונך למחוק את קטע החדשות הנל?";
$PMF_LANG["ad_news_yesdelete"] = "כן, מחק!";
$PMF_LANG["ad_news_nodelete"] = "לא!";
$PMF_LANG["ad_news_delsuc"] = "קטע חדשות נמחק.";
...
$PMF_LANG["ad_categ_remark"] = "שים לב שרשומות לא יהיו ניתנות לצפייה יותר, אם אתה מוחק את הקטגוריה שלהן. אתה חייב לציין קטגוריה לכתבה או למחוק אותה..";
...
// Cookies
$PMF_LANG["ad_cookie_cookiesuc 	"] = "הקוקי נוצרה <strong>בהצלחה</strong>.";
$PMF_LANG["ad_cookie_already"] = "הקוי נוצרה כבר, כעת יש לך את האפשרויות הבאות: ";
$PMF_LANG["ad_cookie_again"] = "לייצור את הקוקי שוב";
$PMF_LANG["ad_cookie_delete"] = "למחוק את הקוקי";
$PMF_LANG["ad_cookie_no"] = "אין קוקי שמורה. עם עוגיה אתה יכול לשמור את המידע לכניסה שלך, לכן אינך צריך לזכור את פרטי ההתחברות שלך. כעת נסה את האופציות הבאות:";
$PMF_LANG["ad_cookie_set"] = "צור עוגייה";
$PMF_LANG["ad_cookie_deleted"] = "העוגייה נמחקה בהצלחה.";

// Adminlog
$PMF_LANG["ad_adminlog"] = "רישום מנהל";
...
$PMF_LANG["ad_passwd_remark"] = "<strong>לתשומת לבך:</strong><br />קוקי צריכה להווצר שוב!";
...
$PMF_LANG["ad_sess_sid"] = "Session מספר";
$PMF_LANG["ad_sess_ip"] = "IP";
$PMF_LANG["ad_sess_time"] = "זמן";
$PMF_LANG["ad_sess_pageviews"] = "צפיות בעמוד";
$PMF_LANG["ad_sess_search"] = "חפש";
$PMF_LANG["ad_sess_sfs"] = "חפש sessions";
...
$PMF_LANG["ad_sess_ai_artikel"] = "רשומה:";
$PMF_LANG["ad_sess_ai_sb"] = "מחרוזת חיפוש:";
$PMF_LANG["ad_sess_ai_sid"] = "Session מספר:";
$PMF_LANG["ad_sess_back"] = "חזור";

// Statistik
$PMF_LANG["ad_rs"] = "סטטיסטיקת רייטינג";
...
$PMF_LANG["ad_auth_sess"] = "מספר הסשן נשלח.";
...
$PMF_LANG["ad_entryins_suc"] = "הרשומה נשמרה בהצלחה.";
...
$PMF_LANG["ad_entry_add"] = "צור רשומה";
...
$PMF_LANG["ad_log_sess"] = "פקיעת הסשן.";
$PMF_LANG["ad_log_edit"] = "טופס עריכת משתמשים למשתמשים הבאים: ";
$PMF_LANG["ad_log_crea"] = "טופס כתבה חדשה.";
$PMF_LANG["ad_log_crsa"] = "צור רשומה חדשה.";
...
$PMF_LANG["ad_log_bede"] = "מחק את הרשומות הבאות: ";

$PMF_LANG["ad_start_visits"] = "ביקורים";
$PMF_LANG["ad_start_articles"] = "כתבות";
...
$PMF_LANG["err_NotAuth"] = "<strong>אינך מאושר.</strong>";
...
$PMF_LANG["ad_export_latest"] = "5 הרשומות האחרונות RSS-Feed";
$PMF_LANG["ad_export_pdf"] = "יצא בPDF את כל הרשומות";
$PMF_LANG["ad_export_generate"] = "בנה RSS-Feed";

$PMF_LANG["rightsLanguage"][0] = "הוסף משתמש";
$PMF_LANG["rightsLanguage"][1] = "ערוך משתמש";
$PMF_LANG["rightsLanguage"][2] = "מחק משתמש";
$PMF_LANG["rightsLanguage"][3] = "הוסף רשומה";
$PMF_LANG["rightsLanguage"][4] = "ערוך רשומה";
$PMF_LANG["rightsLanguage"][5] = "מחק רשומה";
$PMF_LANG["rightsLanguage"][6] = "ראה רישום";
$PMF_LANG["rightsLanguage"][7] = "ראה רישום מנהל";
$PMF_LANG["rightsLanguage"][8] = "מחק הערה";
$PMF_LANG["rightsLanguage"][9] = "הוסף חדשות";
$PMF_LANG["rightsLanguage"][10] = "ערוך חדשות";
$PMF_LANG["rightsLanguage"][11] = "מחק חדשות";
$PMF_LANG["rightsLanguage"][12] = "הוסף קטגוריה";
$PMF_LANG["rightsLanguage"][13] = "ערוך קטגוריה";
$PMF_LANG["rightsLanguage"][14] = "מחק קטגוריה";
$PMF_LANG["rightsLanguage"][15] = "שנה סיסמא";
$PMF_LANG["rightsLanguage"][16] = "ערוך הגדרות";
$PMF_LANG["rightsLanguage"][17] = "הוסף קובץ";
$PMF_LANG["rightsLanguage"][18] = "מחק קובץ";
$PMF_LANG["rightsLanguage"][19] = "צור גיבוי";
$PMF_LANG["rightsLanguage"][20] = "שחזר גיבוי";
$PMF_LANG["rightsLanguage"][21] = "מחק שאלות פתוחות";
...
$LANG_CONF["language"] = array(0 => "checkbox", 1 => "קובץ שפה");
$LANG_CONF["detection"] = array(0 => "checkbox", 1 => "אפשר העברת נתונים אוטומטית");
...
$PMF_LANG["ad_categ_change"] = "שונה עם";
...
$PMF_LANG["lostpwd_text_2"] = "אנא ערוך סיסמה אישית חדשה באזור הניהול של השאלות הנפוצות שלך.";
