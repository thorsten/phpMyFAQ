...
$LANG_CONF["detection"] = array(0 => "checkbox", 1 => "Automatisk språkdetektering");
...
$LANG_CONF["ldap_support"] = array(0 => "checkbox", 1 => "Vill du aktivera stöd för LDAP? (förvalt: inaktivt)");
...
$LANG_CONF["spamCheckBannedWords"] = array(0 => "checkbox", 1 => "Kontrollera det publika formuläret mot listan på förbjudna ord (standard: på).");
