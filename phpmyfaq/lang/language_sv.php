...
$LANG_CONF['main.ipCheck'] = array(0 => "checkbox", 1 => "Kolla IP-adressen när UIN kollas i admin.php?");
...
$LANG_CONF['main.bannedIPs'] = array(0 => "area", 1 => "Blockera följande IP-adresser");
...
$PMF_LANG['ad_linkcheck_config_th_id'] = 'Id nr';
...
$LANG_CONF['main.maxAttachmentSize'] = array(0 => "input", 1 => "maxstorlek för bilagor i Byte (max. %s Byte)");
...
$LANG_CONF['main.enableAttachmentEncryption'] = array(0 => "checkbox", 1 => "Aktivera kryptering av bilagor <br><small>Ignoreras om bilagor ej är aktiverade</small>");
$LANG_CONF['main.defaultAttachmentEncKey'] = array(0 => "input", 1 => 'Standardkrypteringsnyckel  <br><small>Ignoreras om kryptyering ej är aktiverat</small><br><small><font color="red">VARNING: Ändra inte denna när väl kryptering är aktiverad!!!</font></small>');
$LANG_CONF['main.useSslForLogins'] = array(0 => 'checkbox', 1 => "Tillåt bara inloggning via SSL? (standard: ej aktiverad)");
...
$PMF_LANG['main.orderingPopularFaqs.visits'] = 'Lista mest besökta inlägg';
$PMF_LANG['main.orderingPopularFaqs.voting'] = 'Lista högst rankade inlägg';
...
$LANG_CONF['main.numberSearchTerms'] = array(0 => 'input', 1 => 'Antal söktermer');
$LANG_CONF['main.orderingPopularFaqs'] = array(0 => "select", 1 => "Sortera de mest populära inläggen");
$LANG_CONF['main.optionalMailAddress'] = array(0 => 'checkbox', 1 => 'E-post-adress är obligatorisk (standard: valfri)');
$LANG_CONF['main.useAjaxSearchOnStartpage'] = array(0 => 'checkbox', 1 => 'Omedelbar respons på startsida (standard: avaktiverad)');
...
$LANG_CONF['main.attachmentsPath'] = array(0 => "input", 1 => "Sökväg där bifogade filer ska sparas. <br /><small>Relativ sökväg betyder en sökväg inom webbroten</small>");
...
$LANG_CONF['main.permLevel'] = array(0 => "select", 1 => "Åtkomstnivå");