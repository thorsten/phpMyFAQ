...
$PMF_LANG['msgHelpText'] = '<p>Kysymyksen (<strong>F</strong>requently <strong>A</strong>sked <strong>Q</strong>uestions) rakenne on melko yksinkertainen. Voit joko selata <strong><a href="?action=show">kategorioita</a></strong> tai anna <strong><a href="?action=search">FAQ hakukoneen</a></strong> etsiä avainsanoja.</p>';
...
$PMF_LANG['ad_rs'] = 'Arvostelustatistiikat';
...
$PMF_LANG['admin_mainmenu_logout'] = 'Uloskirjautuminen';
...
$PMF_LANG['ad_menu_searchstats'] = 'Etsintästatistiikka';
...
$PMF_LANG['msgChooseLanguageToTranslate'] = 'Valitse käännöskieli';
$PMF_LANG['msgLangDirIsntWritable'] = 'Hakemisto <strong>/lang</strong> ei ole kirjoitettavissa.';
$PMF_LANG['ad_menu_translations'] = 'Käyttöliittymän kääntäminen';
...
$PMF_LANG['records.orderingPopularFaqs.visits'] = 'Listaa näytetyimmät FAQ-tietueet';
$PMF_LANG['records.orderingPopularFaqs.voting'] = 'Listaa äänestetyimmät FAQ-tietueet';
...
$PMF_LANG['searchControlCenter'] = 'Etsi';
...
$PMF_LANG['securityControlCenter'] = 'Turvamääritykset';
