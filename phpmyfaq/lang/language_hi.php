...
// Help
$PMF_LANG["msgHelpText"] = "<p>FAQ का संरचना (<strong>F</strong>requently <strong>A</strong>sked <strong>Q</strong>uestions) बहुत ही आसान. या तो आप <strong><a href=\"".$_SERVER["PHP_SELF"]."?action=show\">वर्गों</a></strong> में खोज सकते हैं या फिर <strong><a href=\"".$_SERVER["PHP_SELF"]."?action=search\">सहायता केंद्र खोजक </a></strong> को कुंजी शब्दों के लिए खोजने दें .</p>";
...
$PMF_LANG["err_noArticles"] = "<p>कोई भी लेख उपलब्ध नहीं है.</p>";
$PMF_LANG["err_badID"] = "<p>क्षमा करें, गलत ID.</p>";
$PMF_LANG["err_noTopTen"] = "<p>अभी सर्वोत्तम १० उपलब्ध नहीं है.</p>";
$PMF_LANG["err_nothingFound"] = "<p>कोई भी लेख उपलब्ध नहीं है.</p>";
...
$PMF_LANG["ad_attach_4"] = "जोड़ी जाने वाली फाइल का साइज़ ".$PMF_CONF['main.maxAttachmentSize']." बिट्स से कम होना चाहिए.";
...
$LANG_CONF['main.maxAttachmentSize'] = array(0 => "input", 1 => "फाइल जोड़ने के लिए अधिकतम साइज़ (अधिकतम. ".ini_get("upload_max_filesize")."बाइट्स)");
$LANG_CONF["main.disableAttachments"] = array(0 => "checkbox", 1 => "फाइलों को एंट्री के निचे जोडें?");
...
$LANG_CONF['main.permLevel'] = array(0 => "input", 1 => "आज्ञा समतल");
...
$PMF_LANG['ad_menu_linkconfig'] = 'URL जांचकर्ता';
$PMF_LANG['ad_linkcheck_config_title'] = 'URL जांचकर्ता सरंचना';
$PMF_LANG['ad_linkcheck_config_disabled'] = 'URL जांचकर्ता सुविधा असक्रिय है';
$PMF_LANG['ad_linkcheck_config_warnlist'] = 'URLs जिनके लिए चेतावनी देनी है';
$PMF_LANG['ad_linkcheck_config_ignorelist'] = 'URLs जिन्हें अनदेखा करना है';
...
$PMF_LANG['ad_linkcheck_config_ignorelist_description'] = 'समुचित URLs जो नीचे दिए गए हैं उन्हें बिना जांच के ही सही मान लिया जाएगा.<br />इस सुविधा का प्रयोग उन URLs के लिए करें जो URL जांचकर्ता द्वारा जांचे नहीं जा सकते';
$PMF_LANG['ad_linkcheck_config_th_id'] = 'ID#';
$PMF_LANG['ad_linkcheck_config_th_url'] = 'URL जो मिलाना है';
$PMF_LANG['ad_linkcheck_config_th_reason'] = 'मिलाने का कारण';
$PMF_LANG['ad_linkcheck_config_th_owner'] = 'एंट्री करने वालाr';
$PMF_LANG['ad_linkcheck_config_th_enabled'] = 'एंट्री के लिए सक्रिय करें';
$PMF_LANG['ad_linkcheck_config_th_locked'] = 'स्वामित्व बंद करने के लिए सक्रिय करें';
$PMF_LANG['ad_linkcheck_config_th_chown'] = 'स्वामित्व पाने के लिए सक्रिय करें';
...
$PMF_LANG['ad_news_set_active'] = 'सक्रिया करें:';
