...
$PMF_LANG['ad_visits_per_day'] = '一日の訪問数';
...
$PMF_LANG['ad_instance_email'] = '管理者あてメール';
$PMF_LANG['ad_instance_admin'] = '管理者ログインID';
...
$PMF_LANG['ad_instance_button'] = 'インスタンスを保存する';
$PMF_LANG['ad_instance_error_cannotdelete'] = 'Could not delete instance ';
$PMF_LANG['ad_instance_config'] = 'インスタンス設定';
