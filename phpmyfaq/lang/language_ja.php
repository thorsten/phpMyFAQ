...
$PMF_LANG['ad_menu_linkconfig'] = 'URLによる認証';
$PMF_LANG['ad_linkcheck_config_title'] = 'URL 認証設定';
$PMF_LANG['ad_linkcheck_config_disabled'] = 'URL 認証機能を無効にしました';
$PMF_LANG['ad_linkcheck_config_warnlist'] = '警告する URL';
$PMF_LANG['ad_linkcheck_config_ignorelist'] = '無視する URL';
$PMF_LANG['ad_linkcheck_config_warnlist_description'] = '下の一覧に一致する URL は、検査無く警告対象と見なされます。<br />この機能は間もなく無効となるURLのために使用してください';
$PMF_LANG['ad_linkcheck_config_ignorelist_description'] = '下の一覧に一致する URL は検査なく有効(警告、無効)とみなされます。<br />この機能は、「警告するURL」で有効としないURLを除外する場合に使用してください';
$PMF_LANG['ad_linkcheck_config_th_id'] = 'ID#';
$PMF_LANG['ad_linkcheck_config_th_url'] = '一致する URL';
$PMF_LANG['ad_linkcheck_config_th_reason'] = '一致させる理由';
...
$LANG_CONF['search.useAjaxSearchOnStartpage'] = array(0 => "checkbox", 1 => "スタートページに即時応答機能を表示する (初期値:無効)");
