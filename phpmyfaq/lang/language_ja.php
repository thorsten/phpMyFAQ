...
$LANG_CONF['main.attachmentsPath'] = array(0 => "input", 1 => "添付ファイルを保存するパスを指定してください。<br /><small>相対パスの場合は、Webサーバのルートフォルダ配下となります</small>");
...
$LANG_CONF['main.defaultAttachmentEncKey'] = array(0 => "input", 1 => "標準の添付暗号化鍵 <br><small>添付の暗号化が無効の場合は無視</small><br><small><font color=&quot;red&quot;>警告: 一度設定しファイルが暗号化されている場合、既存設定の変更はしないでください!!!</font></small>");
