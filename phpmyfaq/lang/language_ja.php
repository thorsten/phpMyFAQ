...
$PMF_LANG['msgVoteThanks'] = '投票ありがとうございました';
$PMF_LANG['msgYouCan'] = '';
...
$PMF_LANG['msgCommentThanks'] = 'コメントありがとうございました';
...
$PMF_LANG['msgS2FThx'] = '推薦ありがとうございました';
$PMF_LANG['msgS2FMailSubject'] = '推薦';
...
$PMF_LANG['msgNewContentThanks'] = '提案ありがとうございました';
...
$PMF_LANG['msgAskThx4Mail'] = '<h2>質問ありがとうございました</h2>';
...
$PMF_LANG['msgMailThanks'] = 'FAQ 提案ありがとうございました。';
...
$PMF_LANG['err_noVote'] = '<p><strong>評価点数を選択してください。</strong> 評価をするためには<a href="nojavascript...history.back();">ここ</a>をクリックしてください。</p>';
...
$PMF_LANG['ad_entry_savedfail'] = '申し訳ありません。 <strong>データベースエラー</strong> が発生しました。';
...
$PMF_LANG['ad_cookie_cookiesuc'] = 'Cookieは <strong>正常に設定</strong>されました。';
...
$PMF_LANG['ad_export_1'] = 'RSS フィード作成';
...
$PMF_LANG['msgSelectCategories'] = '検索中 ...';
...
$PMF_LANG['ad_linkcheck_feedback_url-disabled'] = '無効';
...
$PMF_LANG['msgNewTranslationName'] = 'お名前:';
$PMF_LANG['msgNewTranslationMail'] = 'メールアドレス:';
...
$PMF_LANG['msgUserData'] = '登録にはユーザー情報がが必要です。';
$PMF_LANG['captchaError'] = '正しいコードを入れてください。';
$PMF_LANG['msgRegError'] = 'Following errors occured. Please correct them:';
$PMF_LANG['successMessage'] = '登録は正常に行われました。確認メールを送信しましたので、確認して下さい。';
$PMF_LANG['msgRegThankYou'] = '登録ありがとうございます。';
$PMF_LANG['emailRegSubject'] = '[%sitename%] 登録: 新規ユーザー';
$PMF_LANG['msgMostPopularSearches'] = '最も人気がある検索は以下の通りです。';
...
$PMF_LANG['ad_menu_stopwordsconfig'] = '言語の停止設定';
$PMF_LANG['ad_config_stopword_input'] = '新規の言語の停止設定をして下さい。';
...
$PMF_LANG['msgTransToolWritable'] = '編集可能';
$PMF_LANG['msgEdit'] = '編集';
...
$LANG_CONF['main.ldapSupport'] = array(0 => "checkbox", 1 => "LDAP のサポートを使用しますか? (デフォルト: 無効)");
...
$LANG_CONF['records.defaultActivation'] = array(0 => "checkbox", 1 => "Activate a new records (デフォルト: 無効)");
$LANG_CONF['records.defaultAllowComments'] = array(0 => "checkbox", 1 => "Allow comments for new records (デフォルト: 無効)");
$LANG_CONF['main.enableWysiwygEditor'] = array(0 => "checkbox", 1 => "Enable bundled WYSIWYG editor デフォルト: 無効)");
