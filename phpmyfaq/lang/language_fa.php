...
$PMF_LANG['msgHelpText'] = '<p>چهار چوب <strong>F</strong>requently <strong>A</strong>sked <strong>Q</strong>uestions یعنی پرسش‌های متداول، بسیار ساده است. شما میتوانید در <strong><a href=\"?action=show\">موضوعات </a></strong>جستجو کنید یا میتوانید به <strong><a href=\"?action=search\">موتور جستجوی پرسش‌های متداول </a></strong> اجازه بدهید که به دنبال کلیدواژه‌ها جستجو کند.</p>';
