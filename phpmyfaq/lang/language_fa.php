...
$PMF_LANG["msgXMLExport"] = "فایل ایکس‌ام‌ال";
...
$PMF_LANG["msgNewContentAddon"] = "پیشنهاد شما منتشر نخواهد شد, ولی به ادمین سیستم اطلاع داده خواهد شد. کادرهای لازم عبارتند از <strong>نام شما</strong>, <strong>آدرس ایمیل شما</strong>, <strong>موضوع</strong>, <strong>سرتیتر</strong> و <strong>و متن سئوال</strong>. لطفا کلیدواژه‌ها را با فاصله از هم جدا کنید.";
...
$PMF_LANG["ad_attach_2"] = "لطفاً در تنظیمات یک لینک برای الصاقی‌ها انتخاب کنید.";
