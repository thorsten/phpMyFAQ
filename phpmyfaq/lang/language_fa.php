...
$PMF_LANG["msgPage"] = "ص�?حه ";
$PMF_LANG["msgPages"] = " ص�?حه‌ها";
...
$PMF_LANG["msgMakeXMLExport"] = "به صورت �?ایل ایکس‌ام‌ال";
$PMF_LANG["msgAverageVote"] = "امتیاز متوسط";
$PMF_LANG["msgVoteUseability"] = "لط�?اً به این مطلب امتیاز بدهید";
$PMF_LANG["msgVoteFrom"] = "از";
$PMF_LANG["msgVoteBad "] = "بی‌�?ایده";
$PMF_LANG["msgVoteGood"] = "بسیار م�?ید";
...
$PMF_LANG["msgSeeXMLFile"] = " به صورت �?ایل ایکس‌ام‌ال ";
...
$PMF_LANG["msgS2FMessage"] = "توضیح اضا�?ی برای دوستان شما";
...
// ask Question
$PMF_LANG["msgNewQuestion"] = "سئوال خود را در �?رم زیر مطرح کنید:";
...
$PMF_LANG["msgMailCheck"] = "مطلب جدید در FAQ وجود دارد! لط�?اً به بخش ادمین مراجعه کنید";
$PMF_LANG["msgMailContact"] = "پیام شما به ادمین سایت ارسال شد.";

// Fehlermeldungen
$PMF_LANG["err_noDatabase"] = "ارتباط با دیتابیس وجود ندارد.";
$PMF_LANG["err_noHeaders"] = "موضوعی یا�?ت نشد.";
...
$PMF_LANG["err_SaveComment"] = "کادرهای اجباری <strong>نام شما </strong>, <strong>ایمیل شما </strong>, <strong>نظر شما </strong> و, اگر خواسته شده باشه, <strong><a href=\"http://en.wikipedia.org/wiki/Captcha\" title=\"Read more on Captcha at Wikipedia\" target=\"_blank\">Captcha</a> کد </strong>هستند!<br /><br /><a href=\"javascript:history.back();\">یک ص�?حه برگرد</a><br /><br />";
...
$PMF_LANG["err_sendMail"] = "کادرهای اجباری <strong>نام شما</strong>, <strong>ایمیل شما</strong>, <strong>سئوال شما</strong> و, اگر تقاضا شده باشد, <strong><a href=\"http://en.wikipedia.org/wiki/Captcha\" title=\"Read more on Captcha at Wikipedia\" target=\"_blank\">Captcha</a> کد </strong>!";
...
$PMF_LANG["ad_menu_categ_add"] = "موضوع اضا�?ه کنید";
$PMF_LANG["ad_menu_categ_edit"] = "اصلاح موضوع";
$PMF_LANG["ad_menu_news_add"] = "اضا�?ه کردن خبر";
...
$PMF_LANG["ad_menu_startpage"] = "ص�?حه شروع";

// Nachrichten
$PMF_LANG["ad_msg_identify"] = "لط�?اً مشخصات شناسایی.";
$PMF_LANG["ad_msg_passmatch"] = "هر دو پسورد باید <strong> یکسان باشند</strong>!";
$PMF_LANG["ad_msg_savedsuc_1"] = "پرو�?ایل ";
$PMF_LANG["ad_msg_savedsuc_2"] = "با مو�?قیت ثبت شد.";
...
$PMF_LANG["ad_entry_active"] = "�?عال؟";
$PMF_LANG["ad_entry_date"] = "تاریخ:";
$PMF_LANG["ad_entry_changed"] = "تغییر با�?ته?";
...
$PMF_LANG["ad_entry_commentdelsuc"] = "نظر با <strong>مو�?قیت</strong> پاک شد.";
$PMF_LANG["ad_entry_back"] = "برگرد به مطلب";
$PMF_LANG["ad_entry_commentdelfail"] = "نظر <strong>پاک نشد</strong>.";
$PMF_LANG["ad_entry_savedsuc"] = "تغییرات با <strong>مو�?قیت</strong> ثبت شد.";
$PMF_LANG["ad_entry_savedfail"] = "متاس�?انه, یک <strong>اشکال در دیتابیس</strong> رخ داد.";
$PMF_LANG["ad_entry_del_1"] = "آیا مطمئنید؟";
$PMF_LANG["ad_entry_del_2"] = "از";
$PMF_LANG["ad_entry_del_3"] = "باید پاک شود?";
$PMF_LANG["ad_entry_delsuc"] = "مورد با <strong>مو�?قیت</strong> پاک شد.";
...
// Kategorieverwaltung
$PMF_LANG["ad_categ_new"] = "اضا�?ه کردن موضوع";
...
$PMF_LANG["ad_categ_add"] = "اضا�?ه کردن موضوع";
...
$PMF_LANG["ad_config_saved"] = "تنظیمات با مو�?قیت ذخیره شدند.";
$PMF_LANG["ad_menu_editconfig"] = "اصلاح تنظیمات";
$PMF_LANG["ad_att_none"] = "الصاقی موجود نیست";
$PMF_LANG["ad_att_att"] = "الصاقی:";
$PMF_LANG["ad_att_add"] = "الصاق �?ایل";
$PMF_LANG["ad_entryins_suc"] = "مطلب با مو�?قیت ثبت شد.";
$PMF_LANG["ad_entryins_fail"] = "اشکالی به وجود آمد.";
$PMF_LANG["ad_att_del"] = "پاک کن";
$PMF_LANG["ad_att_nope"] = "الصاقیها �?قط در زمان اصلاح میتوانند اض�?ه شوند.";
$PMF_LANG["ad_att_delsuc"] = "الصاقی با مو�?قیت اضا�?ه شد.";
$PMF_LANG["ad_att_delfail"] = "هنگام اضا�?ه کردن الصاقی مشکلی رخ داد.";
$PMF_LANG["ad_entry_add"] = "ایجاد مطلب";

// Added v0.85 - 08.06.2001 - Bastian - Admin
$PMF_LANG["ad_csv_make"] = "> یک پشتیبان تصویر کاملی از محتویات دیتابیس است. �?رمت پشتیبان SQL transaction است, که با ابزاری مثل phpMyAdmin یا خط �?رمان sql متواند دوباره به دیتابیس وارد شود. ایجاد حداقل یک پشتیبان در ماه توصیه میشود.";
$PMF_LANG["ad_csv_link"] = "دانلود پشتیبان";
$PMF_LANG["ad_csv_head"] = "ساخت پشتیبان";
$PMF_LANG["ad_att_addto"] = "اضا�?ه کردن یک الصاقی به این موضوع";
$PMF_LANG["ad_att_addto_2"] = "";
$PMF_LANG["ad_att_att"] = "�?ایل:";
...
$PMF_LANG['msgAdvancedSearch'] = 'جستجوی پیشر�?ته';
