...
$PMF_LANG["rightsLanguage"]['adduser'] = "사용자 추가";
$PMF_LANG["rightsLanguage"]['edituser'] = "사용자 수정";
...
$LANG_CONF['main.currentVersion'] = array(0 => "print", 1 => "FAQ 버전");
...
$LANG_CONF["main.send2friendText"] = array(0 => "area", 1 => "친구에게 보내기 페이지를 위한 텍스트");
$LANG_CONF['records.maxAttachmentSize'] = array(0 => "input", 1 => "최대 첨부 파일 사이즈(Bytes) (최대 %sByte)");
$LANG_CONF["records.disableAttachments"] = array(0 => "checkbox", 1 => "내용의 아래에 첨부파일 링크걸기");
...
$LANG_CONF["security.ipCheck"] = array(0 => "checkbox", 1 => "admin.php에서 UINs를 체크할 때 IP주소를 체크할지의 여부");
$LANG_CONF["records.numberOfRecordsPerPage"] = array(0 => "input", 1 => "페이지당 표시할 글의 수");
