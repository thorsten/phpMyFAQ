...
$LANG_CONF['main.permLevel'] = array(0 => "select", 1 => "Επίπεδο δικαιωμάτων");
...
$LANG_CONF['main.useSslForLogins'] = array(0 => 'checkbox', 1 => "Να επιτρέπονται συνδέσεις μόνο μέσω σίγουρης σύνδεσης; (προεπιλογή: απενεργοποιημένο)");
