...
$LANG_CONF['main.attachmentsPath'] = array(0 => "input", 1 => "Κατάλογος για αποθήκευση των συννημένων>");
...
$LANG_CONF['main.enableAttachmentEncryption'] = array(0 => "checkbox", 1 => "Ενεργοποίηση κρυπτόγράφησης συννημένων");
$LANG_CONF['main.defaultAttachmentEncKey'] = array(0 => "input", 1 => 'Προεπιλεγμένη κρυπτογράφηση <br><small><font color="red">ΠΡΟΣΟΧΗ: Μην μεταβάλεται αυτή τη λειτουργία άν έχετε ενεργοποιήση την κρυπτογράφηση αρχείων!!!</font></small>');
