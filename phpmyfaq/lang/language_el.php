...
$PMF_LANG['ad_menu_linkconfig'] = 'Ελεγκτής URL';
$PMF_LANG['ad_linkcheck_config_title'] = 'Ρυθμίσεις ελεγκτή URL';
$PMF_LANG['ad_linkcheck_config_disabled'] = 'Ελεγκτής URL απενεργοποιήθηκε';
$PMF_LANG['ad_linkcheck_config_warnlist'] = 'URLs για προειδοποίηση';
$PMF_LANG['ad_linkcheck_config_ignorelist'] = 'URLs για αγνόηση';
$PMF_LANG['ad_linkcheck_config_warnlist_description'] = 'URLs προτασσόμενα τα παρακάτω αντικείμενα θα μεταχειρίζονται με προειδοποίηση';
$PMF_LANG['ad_linkcheck_config_ignorelist_description'] = 'Τα παρακάτω URLs θα μεταχειρίζονται ως έγκυρα χωρίς έλεγχο.<br />Χρησιμοποιήστε αυτή την λειτουργία για να επιτρέπετε URLs που δεν αναγωρίζονται με επιτυχία από τον ελεγκτή URL.';
$PMF_LANG['ad_linkcheck_config_th_id'] = 'ID#';
$PMF_LANG['ad_linkcheck_config_th_url'] = 'URL για ταίριασμα';
$PMF_LANG['ad_linkcheck_config_th_reason'] = 'Ταίριασμα τεκμηρίου';
$PMF_LANG['ad_linkcheck_config_th_owner'] = 'Ιδιοκτήτης καταχώρησης';
$PMF_LANG['ad_linkcheck_config_th_enabled'] = 'Για ενεργοποίηση καταχώρησης';
$PMF_LANG['ad_linkcheck_config_th_locked'] = 'Για κλείδωμα ιδιοκτησίας';
$PMF_LANG['ad_linkcheck_config_th_chown'] = 'Για απόκτηση ιδιοκτησίας';
