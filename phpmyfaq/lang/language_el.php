...
$PMF_LANG['ad_news_link_url'] = 'Σύνδεσμος: (<strong>χωρίς https://</strong>)!';
...
$PMF_LANG['rightsLanguage::add_user'] = 'προσθήκη χρήστη';
$PMF_LANG['rightsLanguage::edit_user'] = 'μεταβολή χρήστη';
$PMF_LANG['rightsLanguage::delete_user'] = 'διαγραφή χρήστη';
$PMF_LANG['rightsLanguage::add_faq'] = 'προσθήκη καταχώρησης';
$PMF_LANG['rightsLanguage::edit_faq'] = 'μεταβολή καταχώρησης';
$PMF_LANG['rightsLanguage::delete_faq'] = 'διαγραγή καταχωρήσης';
...
$LANG_CONF['main.contactInformations'] = array("area", "Πληροφορίες επικοινωνίας");
...
$LANG_CONF['main.urlValidateInterval'] = array("input", "Διάστημα ανάμεσα σε AJAX αναγνωρίσεις (σε δευτερόλεπτα)");
