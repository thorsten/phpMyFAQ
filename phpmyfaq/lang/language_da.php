<?php
/**
 * $Id: language_da.php,v 1.26.2.1 2007-06-23 13:51:30 thorstenr Exp $
 *
 * Danish language file
 *
 * @author      Max Andersen <max@militant.dk>
 * @author      Poul Melgaard <pcm@surfray.com>
 * @author      Tommy Ipsen <tip@sam.sdu.dk>
 * @since       2004-06-24
...
$PMF_LANG["msgS2FText2"] = "Du vil finde indl&aelig;get p&aring; den f&oslash;lgende adresse:";
...
$PMF_LANG["err_SaveEntries"] = "N&oslash;dvendige felter: <strong>dit navn</strong>, <strong>din e-mail-adresse</strong>, <strong>kategori</strong>, <strong>overskrift</strong> and <strong>dit indl&aelig;g</strong>!<br /><br />\n<a href=\"javascript:history.back();\">én side tilbage</a><br /><br />\n";
...
$PMF_LANG["ad_menu_entry_edit"] = "Ret sp&oslash;rgsm&aring;l";
...
$PMF_LANG["ad_categ_remark"] = "V&aelig;r opm&aelig;rksom p&aring; at de eksisterende data ikke vil v&aelig;re tilg&aelig;ngelige mere, hvis du sletter en kategori. Du m&aring; tildele en ny katefori for artiklen eller slette artiklen.";
...
$LANG_CONF["main.enableAdminLog"] = array(0 => "checkbox", 1 => "benyt Adminlog?");
$LANG_CONF["main.ipCheck"] = array(0 => "checkbox", 1 => "Do you want the IP to be checked when checking the UINs in admin.php?");
$LANG_CONF["main.numberOfRecordsPerPage"] = array(0 => "input", 1 => "Antal viste emner pr. side");
...
$LANG_CONF["main.enableRewriteRules"] = array(0 => "checkbox", 1 => "Aktiver underst&oslash;ttelse af mod_rewrite? (default: sl&aring;et fra)");
$LANG_CONF["main.ldapSupport"] = array(0 => "checkbox", 1 => "Aktiver underst&oslash;ttelse af LDAP? (default: sl&aring;et fra)");
...
$PMF_LANG["lostpwd_err_2"] = "Fejl: Wrong entries!";
