<?php
/**
* $Id: language_da.php,v 1.19 2007-03-29 12:03:46 thorstenr Exp $
*
...
$PMF_LANG["msgPrevious"] = "foreg&aring;ende";
$PMF_LANG["msgNext"] = "n&aelig;ste";
$PMF_LANG["msgKategoriUp"] = "en kategori op";
...
$PMF_LANG["msgVoteBad"] = "fuldst&aelig;ndig <br />ubrugeligt";
$PMF_LANG["msgVoteGood"] = "yderst<br />brugbart";
...
$PMF_LANG["msgS2FEMail"] = "Din e-mail addresse:";
$PMF_LANG["msgS2FFriends"] = "Dine venners:";
$PMF_LANG["msgS2FEMails"] = ". e-mail addresser:";
$PMF_LANG["msgS2FText"] = "Den f&oslash;lgende tekst vil blive sendt:";
$PMF_LANG["msgS2FText2"] = "Du vil finde indl&aelig;get p&aring; den f&oslash;lgende addresse:";
...
$PMF_LANG["msgSearchAmount"] = " s&oslash;ge resultat";
$PMF_LANG["msgSearchAmounts"] = " s&oslash;ge resultater";
...
$PMF_LANG["msgAskCategory  "] = "V&aelig;g kategori:";
$PMF_LANG["msgAskYourQuestion"] = "Dit sp&oslash;rgsm&aring;l:";
$PMF_LANG["msgAskThx4Mail"] = "<h2>Tak for din email!</h2>";
...
// Help
$PMF_LANG["msgHelpText"] = "<p>Strukturen af denne FAQ (<strong>F</strong>requently <strong>A</strong>sked <strong>Q</strong>uestions) er ret simpel. Du kan enten s&oslash;ge i <strong><a href=\"".$_SERVER["PHP_SELF"]."?sid=".isset($_GET["sid"])."&amp;action=show\">kategorierne</a></strong> eller lade <strong><a href=\"".$_SERVER["PHP_SELF"]."?sid=".isset($_GET["sid"])."&amp;action=search\">FAQ maskinen</a></strong> s&oslash;ge efter n&oslash;gleord.</p>";

// Contact
$PMF_LANG["msgContactEMail"] = "send email til webmaster:";
...
$PMF_LANG["err_SaveEntries"] = "N&oslash;dvendige felter: <strong>dit navn</strong>, <strong>din email addresse</strong>, <strong>kategori</strong>, <strong>overskrift</strong> and <strong>dit indl&aelig;g</strong>!<br /><br />\n<a href=\"javascript:history.back();\">̩n side tilbage</a><br /><br />\n";
$PMF_LANG["err_SaveComment"] = "N&oslash;dvendige felter: <strong>dit navn</strong>, <strong>din email addresse</strong> og <strong>dine kommentarer</strong>!<br /><br />\n<a href=\"javascript:history.back();\">̩n side tilbage</a><br /><br />\n";
$PMF_LANG["err_VoteTooMuch"] = "<p>Vi t&aelig;ller ikke dobbelt stemmer. <a href=\"javascript:history.back();\">Klik her</a>, to go back.</p>";
...
$PMF_LANG["err_noMailAdress"] = "din email addresse er ikke korrekt.<br /><a href=\"javascript:history.back();\">tilbage</a>";
$PMF_LANG["err_sendMail"] = "N&oslash;dvendige felter: <strong>dit navn</strong>, <strong>din email addresse</strong> og <strong>dit sp&oslash;rgsm&aring;l</strong>!<br /><br />\n<a href=\"javascript:history.back();\">̩n side tilbage</a><br /><br />\n";
...
$PMF_LANG["ad_menu_passwd"] = "Skift kodeord";
$PMF_LANG["ad_menu_logout"] = "Log af";
$PMF_LANG["ad_menu_startpage"] = "Startside";

// Nachrichten
$PMF_LANG["ad_msg_identify"] = "Profilnavn.";
$PMF_LANG["ad_msg_passmatch"] = "Begge kodeord skal v&aelig;re <strong>ens</strong>!";
...
$PMF_LANG["ad_gen_reset"] = "T&oslash;m";
...
$PMF_LANG["ad_user_add"] = "Tilf&oslash;j bruger";
$PMF_LANG["ad_user_profou"] = "Brugerprofil";
$PMF_LANG["ad_user_name"] = "Navn";
$PMF_LANG["ad_user_password"] = "Kodeord";
...
$PMF_LANG["ad_entry_edit_1"] = "Ret felt";
...
$PMF_LANG["ad_entry_del_1"] = "Er du sikker p&aring; at emnet";
...
$PMF_LANG["ad_categ_remark"] = "V&aelig;r opm&aelig;rksom p&aring; at de eksisterende data ikke vil v&aelig;re tilg&aelig;ngelige mere, hvis du sletter en kategori. Du m&aring; tildele en yny katefori for artiklen eller slette artiklen.";
$PMF_LANG["ad_categ_edit_1"] = "Ret";
$PMF_LANG["ad_categ_edit_2"] = "Kategori";
$PMF_LANG["ad_categ_add"] = "Tilf&oslash;j Kategori";
$PMF_LANG["ad_categ_added"] = "Kategorien tilf&oslash;jet.";
...
// Passwd
$PMF_LANG["ad_passwd_cop"] = "Skift kodeord";
$PMF_LANG["ad_passwd_old"] = "Gammelt kodeord:";
$PMF_LANG["ad_passwd_new"] = "Nyt kodeord:";
$PMF_LANG["ad_passwd_con"] = "Bekr&aelig;ft:";
$PMF_LANG["ad_passwd_change"] = "Skift kodeord";
$PMF_LANG["ad_passwd_suc"] = "Kodeord skiftet.";
$PMF_LANG["ad_passwd_remark"] = "<strong>SE HER:</strong><br />Cookie skal s&aelig;ttes igen!";
$PMF_LANG["ad_passwd_fail"] = "Det gamle kodeord <strong>skal</strong> angives korrekt og begge kodeord skal v&aelig;re <strong>ens</strong>.";

// Adduser
$PMF_LANG["ad_adus_adduser"] = "Tilf&oslash;j bruger";
$PMF_LANG["ad_adus_name"] = "Navn:";
$PMF_LANG["ad_adus_password"] = "Kodeord:";
$PMF_LANG["ad_adus_add"] = "Tilf&oslash;j bruger";
$PMF_LANG["ad_adus_suc"] = "Bruger <strong>tilf&oslash;jet</strong>.";
...
// Auth
$PMF_LANG["ad_auth_insert"] = "Skriv venligst brugernavn og kodeord.";
$PMF_LANG["ad_auth_user"] = "Brugernavn:";
$PMF_LANG["ad_auth_passwd"] = "Kodeord:";
$PMF_LANG["ad_auth_ok"] = "OK";
$PMF_LANG["ad_auth_reset"] = "T&oslash;m";
$PMF_LANG["ad_auth_fail"] = "Brugernavn eller kodeord ikke korrekt.";
...
$PMF_LANG["ad_config_reset"] = "T&oslash;m";
...
$PMF_LANG["ad_entryins_suc"] = "Felt gemt.";
...
$PMF_LANG["ad_entry_add"] = "Opret";

// Added v0.85 - 08.06.2001 - Bastian - Admin
$PMF_LANG["ad_csv_make"] = "En sikkerhedskopi er et komplet billede af databasens indhold. En sikkerhedskopi burde foretages mindst 1 gang om m&aring;neden. Sikkerhedskopi-formatet en en MySQL transaktionsfil, som kan importeres ved hj&aelig;lp af v&aelig;rkt&oslash;jer som phpMyAdmin eller mysql kommadolinie v&aelig;rkt&oslash;jet.";
$PMF_LANG["ad_csv_link"] = "Hent sikkerhedskopi";
$PMF_LANG["ad_csv_head"] = "Lav sikkerhedskopi";
$PMF_LANG["ad_att_addto"] = "Tilf&oslash;j en vedh&aelig;ftning til emnet";
$PMF_LANG["ad_att_addto_2"] = "";
$PMF_LANG["ad_att_att"] = "Fil:";
$PMF_LANG["ad_att_butt"] = "OK";
$PMF_LANG["ad_att_suc"] = "Filen er tilf&oslash;jet.";
$PMF_LANG["ad_att_fail"] = "En fejl opstod ved tilf&oslash;jelsen af filen.";
$PMF_LANG["ad_att_close"] = "Luk dette vindue";

// Added v0.85 - 08.07.2001 - Bastian - Admin
$PMF_LANG["ad_csv_restore"] = "Med denne form kan du genskabe indoldet af databasen, lavet med phpMyFAQ. V&aelig;r opm&aelig;rksom p&aring; at eksisterende data vil blive overskrevet.";
...
$PMF_LANG["ad_menu_categ_edit"] = "Kategori Adminstration";
$PMF_LANG["ad_menu_stat"] = "Statistik";
...
$PMF_LANG["ad_ques_take"] = "Ret sp&oslash;rgsm&aring;l";
$PMF_LANG["no_cats"] = "Ingen kategorier fundet.";

// Added v1.1 - 17.01.2002 - Bastian
$PMF_LANG["ad_log_lger"] = "Forkert brugernavn eller kodeord.";
...
$PMF_LANG["ad_user_chpw"] = "Du kan kun skifte kodeord p&aring; eksisterende bruger via \"Skift kodeord\".";

// Added v1.1 - 30.01.2002 - Bastian
$PMF_LANG["ad_categ_paste"] = "s&;aeligt ind";
...
$PMF_LANG["msgPreviusPage"] = "foreg&aring;ende side";
...
$PMF_LANG["ad_passwdsuc"] = "Dit kodeord er skiftet.";
...
$PMF_LANG["ad_entry_email"] = "email adresse:";
$PMF_LANG["ad_entry_allowComments"] = "tillad kommentarer";
$PMF_LANG["msgWriteNoComment"] = "Du kan ikke kommentere dette indl&aelig;g";
$PMF_LANG["ad_user_realname"] = "rigtigt navn:";
$PMF_LANG["ad_export_generate_pdf"] = "generer PDF fil";
$PMF_LANG["ad_export_full_faq"] = "Din FAQ som en PDF fil: ";
$PMF_LANG["err_bannedIP"] = "Din IP address er blevet forment adgang.";
$PMF_LANG["err_SaveQuestion"] = "N&oslash;dvendige felter: <strong>dit navn</strong>, <strong>din email addresse</strong> og <strong>dit sp&oslash;rgsm&aring;l</strong>.<br /><br /><a href=\"javascript:history.back();\">̩n side tilbage</a><br /><br />\n";
