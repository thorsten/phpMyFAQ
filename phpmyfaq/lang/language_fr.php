...
$PMF_LANG['msgFullCategoriesIn'] = 'Catégories avec entrées dans ';
...
$PMF_LANG['rightsLanguage']['edit_faq'] = 'editer un article';
...
$LANG_CONF['main.metaPublisher'] = array("input", "Nom du publieur");
$LANG_CONF['main.administrationMail'] = array("input", "Adresse Email de l'administrateur");
$LANG_CONF['main.contactInformations'] = array('area', "Informations de contact");
$LANG_CONF['main.send2friendText'] = array('area', "Texte pour la page send2friend");
$LANG_CONF['records.maxAttachmentSize'] = array("input", "Taille maximum des pièces jointes en Octets (max. %s Octets)");
$LANG_CONF['records.disableAttachments'] = array("checkbox", "Lier les pièces jointes et les articles");
$LANG_CONF['main.enableUserTracking'] = array("checkbox", "Utiliser le Tracking ?");
$LANG_CONF['main.enableAdminLog'] = array("checkbox", "Utiliser l'Adminlog ?");
$LANG_CONF['security.ipCheck'] = array("checkbox", "Désirez-vous vérifier l'adresse IP afin d'identifier le UINs dans admin.php?");
$LANG_CONF['records.numberOfRecordsPerPage'] = array("input", "Nombre de topics affichés par page");
...
$LANG_CONF['main.referenceURL'] = array("input", "URL pour vérifcation des liens (e.g. : https://www.example.org/faq/)");
...
$LANG_CONF['records.numberOfRelatedArticles'] = array("input", "Nombre d'entrées liées");
...
$LANG_CONF['spam.enableSafeEmail'] = array("checkbox", "Affichage sécurisé de l'e-mail utilisateur (défaut : activé).");
...
$LANG_CONF['main.templateSet'] = array("select", "Template à utiliser");
$LANG_CONF['records.enableAttachmentEncryption'] = array("checkbox", "Activer les attachements cryptés<br><small>Ignoré si les attachements sont désactivés</small>");
$LANG_CONF['records.defaultAttachmentEncKey'] = array("input", "Clé de cryptage par défaut<br><small>Ignoré si le cryptage des attachements est désactivé</small><br><small><font color=\"red\">ATTENTION : Ne pas modifier une fois que le cryptage des fichiers a été activé !!!</font></small>");
$LANG_CONF['security.useSslForLogins'] = array("checkbox", "Autoriser uniquement les connections sécurisées ? (défaut : désactivé)");
...
$LANG_CONF['records.orderingPopularFaqs'] = array("select", "Trié par FAQ les plus populaires");
$LANG_CONF['main.optionalMailAddress'] = array("checkbox", "Adresse email comme champ obligatoire (défaut : désactivé)");
...
$LANG_CONF['main.enableWysiwygEditor'] = array("checkbox", "Activer l'éditeur WYSIWYG (défaut: activé)");
...
$LANG_CONF['socialnetworks.enableTwitterSupport'] = array("checkbox", "Support Twitter (défaut: désactivé)");
...
$LANG_CONF['records.randomSort'] = array('checkbox', 'Trier aléatoirement les FAQs  (défaut : désactivé)');
$LANG_CONF['main.enableWysiwygEditorFrontend'] = array('checkbox', 'Activer l\'éditeur WYSIWYG intégré en frontend (défaut : désactivé)');
