 ...
 * @author    Agnese Morettini <agnese.morettini@gmail.com>
...
$PMF_LANG['msgFullCategories'] = 'Elenco categorie';
...
$PMF_LANG['msgNewContentAddon'] = 'La tua proposta non sarà pubblicata subito, ma sarà pubblicata dall\'amministratore dopo la sua validazione.<br />I campi richiesti sono il <strong>tuo nome</strong>, il <strong>tuo indirizzo e-mail</strong>, la <strong>categoria</strong>, la <strong>domanda</strong> e il <strong>testo</strong>.<br />Ricordati di separare le parole chiave con uno spazio.';
...
$PMF_LANG['msgNewContentTheme'] = 'Domanda:';
$PMF_LANG['msgNewContentArticle'] = 'Risposta:';
...
$PMF_LANG['msgNoQuestionsAvailable'] = 'Al momento non ci sono domande in attesa di approvazione.';
$PMF_LANG['msgNewQuestion'] = 'Scrivi la tua domanda qui sotto:';
$PMF_LANG['msgAskCategory'] = 'Categoria:';
...
$PMF_LANG['msgContactEMail'] = 'Invia un\'e-mail al webmaster:';
...
$PMF_LANG['msgMailCheck'] = 'C\'è una nuova proposta per una FAQ! Controlla la sezione \'Amministrazione\'.';
...
$PMF_LANG['msgShowMore'] = 'mostra di più';
$PMF_LANG['msgQuestionAnswered'] = 'Domanda con risposta';
$PMF_LANG['msgMessageQuestionAnswered'] = 'È stata appena fornita una risposta ala tua domanda su %s. Eccola:';
$PMF_LANG['ad_stopwords_desc'] = 'Seleziona una lingua da aggiungere o modifica la lista di parole vietate.';
$PMF_LANG['ad_visits_per_day'] = 'Visite giornaliere';
$PMF_LANG['ad_instance_add'] = 'Aggiungi una nuova installazione phpMyFAQ multisito';
$PMF_LANG['ad_instance_error_notwritable'] = 'La cartella /multisite non è scrivibile.';
$PMF_LANG['ad_instance_url'] = 'URL dell\'installazione';
$PMF_LANG['ad_instance_path'] = 'Percorso dell\'installazione';
$PMF_LANG['ad_instance_name'] = 'Nome dell\'installazione';
$PMF_LANG['ad_instance_email'] = 'E-mail da amministratore';
$PMF_LANG['ad_instance_admin'] = 'Username da amministratore';
$PMF_LANG['ad_instance_password'] = 'Password da amministratore';
$PMF_LANG['ad_instance_hint'] = 'Attenzione: Saranno necessari alcuni minuti per creare una nuova installazione di phpMyFAQ!';
$PMF_LANG['ad_instance_button'] = 'Salva installazione';
$PMF_LANG['ad_instance_error_cannotdelete'] = 'Non è stato possibile eliminare l\'installazione';
$PMF_LANG['ad_instance_config'] = 'Configurazione dell\'installazione';
$PMF_LANG['msgAboutThisNews'] = 'Su queste news';
$PMF_LANG['msgAccessDenied'] = 'Accesso vietato.';
$PMF_LANG['msgSeeFAQinFrontend'] = 'Vedi la FAQ nel frontend';
$LANG_CONF['records.randomSort'] = array(0 => 'checkbox', 1 => 'Ordina le FAQ in modo casuale (Valore predefinito: disattivato)');
$LANG_CONF['main.enableWysiwygEditorFrontend'] = array(0 => 'checkbox', 1 => 'Abilita l\'editor di gruppo WYSIWYG nel frontend (Valore predefinito: disattivato)');
$LANG_CONF['main.enableGravatarSupport'] = array(0 => 'checkbox', 1 => 'Supporto Gravatar(Valore predefinito: disattivato)');
