...
$LANG_CONF['main.contactInformations'] = array("area", "Testo per la pagina dei <em>Contatti</em>");
...
$LANG_CONF['main.referenceURL'] = array("input", "<em>Base URL</em> dell'installazione di phpMyFAQ, es: http://www.example.org/faq/ (&egrave; necessaria per la verifica dei links)");
...
$LANG_CONF['spam.enableCaptchaCode'] = array('checkbox', 'Usa un codice <a href="http://it.wikipedia.org/wiki/Captcha" title="Vai alla definizione di Wikipedia" target="_blank">captcha</a> per permettere la sottomissione delle form pubbliche (predefinito: abilitato).');
...
$LANG_CONF['records.autosaveActive'] = array('checkbox', 'Attiva salvataggio automatico FAQ');
$LANG_CONF['records.autosaveSecs'] = array('input', 'Intervallo per salvataggio automatico in secondi, default 180');
...
$LANG_CONF['main.templateSet'] = array('select', 'Template impostato per essere usato');
