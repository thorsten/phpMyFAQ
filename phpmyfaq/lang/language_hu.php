...
// Help
$PMF_LANG["msgHelpText"] = "<p>A GYIK (<strong>GY</strong>akran <strong>I</strong>smételt <strong>K</strong>érdések) használata meglehetősen egyszerű. Kereshetsz a <strong><a href=\"".$_SERVER["PHP_SELF"]."?sid=".isset($_GET["sid"])."&amp;action=show\">kategóriákban</a></strong> vagy <strong><a href=\"".$_SERVER["PHP_SELF"]."?sid=".isset($_GET["sid"])."&amp;action=search\">kulcsszavakra</a></strong>.</p>";
...
$PMF_LANG["ad_attach_4"] = "A csatolt fájlnak kisebbnek kell lennie mint ".$PMF_CONF["attmax"]." byte.";
...
$PMF_LANG["rightsLanguage"][0] = "felhasználó hozzáadása";
$PMF_LANG["rightsLanguage"][1] = "felhasználó szerkesztése";
$PMF_LANG["rightsLanguage"][2] = "felhasználó törlése";
$PMF_LANG["rightsLanguage"][3] = "bejegyzés hozzáadása";
$PMF_LANG["rightsLanguage"][4] = "bejegyzés szerkesztése";
$PMF_LANG["rightsLanguage"][5] = "bejegyzés törlése";
$PMF_LANG["rightsLanguage"][6] = "log megnézése";
$PMF_LANG["rightsLanguage"][7] = "admin log megnézése";
$PMF_LANG["rightsLanguage"][8] = "megjegyzés törlése";
$PMF_LANG["rightsLanguage"][9] = "hír hozzáadása";
$PMF_LANG["rightsLanguage"][10] = "hír szerkesztése";
$PMF_LANG["rightsLanguage"][11] = "hír törlése";
$PMF_LANG["rightsLanguage"][12] = "kategória hozzáadása";
$PMF_LANG["rightsLanguage"][13] = "kategória szerkesztése";
$PMF_LANG["rightsLanguage"][14] = "kategória törlése";
$PMF_LANG["rightsLanguage"][15] = "jelszó megváltoztatása";
$PMF_LANG["rightsLanguage"][16] = "beállítások szerkesztése";
$PMF_LANG["rightsLanguage"][17] = "fájl csatolása";
$PMF_LANG["rightsLanguage"][18] = "csatolt fájl törlése";
$PMF_LANG["rightsLanguage"][19] = "backup készítése";
$PMF_LANG["rightsLanguage"][20] = "backup visszaállítása";
$PMF_LANG["rightsLanguage"][21] = "nyitott kérdések törlése";
