...
$PMF_LANG["msgVoteUseability"] = "Ohodnoťte tento FAQ:";
...
$PMF_LANG["msgNewContentAddon"] = "Váš návrh nebude publikovaný ihneď, po obdržaní bude schválený administrátorom. Povinné políčka sú <strong>Vaše meno</strong>, <strong>Váš e-mail</strong>, <strong>category</strong>, <strong>Titulok</strong> a <strong>Váš záznam</strong>. Prosím oddeľte kľúčové slová iba medzerou.";
...
$PMF_LANG["err_sendMail"] = "Povinné polia sú <strong>Vaše meno</strong>, <strong>Váš e-mail</strong>, <strong>your question</strong> a, na požiadanie, <strong><a href=\"http://en.wikipedia.org/wiki/Captcha\" title=\"Čítajte viac na Captcha at Wikipedia\" target=\"_blank\">Captcha</a> code</strong>!<br /><br /><a href=\"javascript:history.back();\">o jednu stránku späť</a><br /><br />";
...
$LANG_CONF['main.language'] = array(0 => "Vyberte", 1 => "Language-File");
$LANG_CONF["main.languageDetection"] = array(0 => "checkbox", 1 => "Povoliť automatický obsah jednania");
$LANG_CONF['main.titleFAQ'] = array(0 => "vstup", 1 => "Názov FAQ");
$LANG_CONF['main.currentVersion'] = array(0 => "tlačiť", 1 => "Verzia FAQ");
$LANG_CONF["main.metaDescription"] = array(0 => "vstup", 1 => "Popis stránky");
$LANG_CONF["main.metaKeywords"] = array(0 => "vstup", 1 => "Kľúčové slová pre Spiders");
$LANG_CONF["main.metaPublisher"] = array(0 => "vstup", 1 => "Meno vydavateľa");
...
$PMF_LANG['ad_menu_linkconfig'] = 'URL Overovateľ';
$PMF_LANG['ad_linkcheck_config_title'] = 'URL nastavenia overovateľa';
$PMF_LANG['ad_linkcheck_config_disabled'] = 'URL overovateľ funkcie nepovolený';
$PMF_LANG['ad_linkcheck_config_warnlist'] = 'URL na varovanie';
$PMF_LANG['ad_linkcheck_config_ignorelist'] = 'URL na ignorovanie';
$PMF_LANG['ad_linkcheck_config_warnlist_description'] = 'URL s uvedenými položkami bude strážená bez ohľadu na to, či je platná.<br />Funkcia určená pre včasné odhaľovanie nefunkčných URL';
$PMF_LANG['ad_linkcheck_config_ignorelist_description'] = 'Presne zadané URL budú posudzované ako platné bez kontroly platnosti.<br />Funkcia určená pre vynechanie URL, pri ktorej zlyhá kontrola platnosti počas URL overovača';
$PMF_LANG['ad_linkcheck_config_th_id'] = 'ID#';
$PMF_LANG['ad_linkcheck_config_th_url'] = 'URL na prepojenie';
$PMF_LANG['ad_linkcheck_config_th_reason'] = 'Dôvod prepojenia';
$PMF_LANG['ad_linkcheck_config_th_owner'] = 'Entry owner';
$PMF_LANG['ad_linkcheck_config_th_enabled'] = 'Nastaviť povolenie pre vstup';
$PMF_LANG['ad_linkcheck_config_th_locked'] = 'Nastaviť uzamknutie vlastníctva';
$PMF_LANG['ad_linkcheck_config_th_chown'] = 'Nastaviť získanie vlastníctva';
...
$LANG_CONF['records.orderby'] = array(0 => 'zvoľte', 1 => 'Triedenie záznamov (podľa zakladateľa)');
...
$LANG_CONF['main.templateSet'] = array(0 => "zvoľte", 1 => "Šablóna nastavená na použitie");
