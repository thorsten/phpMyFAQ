...
$PMF_LANG['ad_menu_linkconfig'] = 'URL tikrintuvė';
$PMF_LANG['ad_linkcheck_config_title'] = 'URL tikrintuvės konfigūracija';
$PMF_LANG['ad_linkcheck_config_disabled'] = 'URL tikrintuvės funkcija išjungta';
$PMF_LANG['ad_linkcheck_config_warnlist'] = 'URL, apie kuriuos įspėti';
$PMF_LANG['ad_linkcheck_config_ignorelist'] = 'URL, kuriuos ignoruoti';
$PMF_LANG['ad_linkcheck_config_warnlist_description'] = 'Apie URL su priešdėliu iš žemiau pateikto sąrašo bus įspėjama nesvarbu ar jis teisingas.<br />Naudokite šią funkciją aptikti URL, kurie greit bus nefunkcionalūs';
$PMF_LANG['ad_linkcheck_config_ignorelist_description'] = 'Bus manoma, kad tikslūs URL išvardinti žemiau yra teisingi be tikrinimo.<br />Naudokite šią funkciją praleisti URL, kurių tikrinimas nepavyksta naudojant URL tikrintuvę';
$PMF_LANG['ad_linkcheck_config_th_id'] = 'Nr.';
$PMF_LANG['ad_linkcheck_config_th_url'] = 'URL turi atitikti';
$PMF_LANG['ad_linkcheck_config_th_reason'] = 'Atitikimo priežastis';
$PMF_LANG['ad_linkcheck_config_th_owner'] = 'Įrašo valdytojas';
$PMF_LANG['ad_linkcheck_config_th_enabled'] = 'Nustatykite, įrašui įjungti';
$PMF_LANG['ad_linkcheck_config_th_locked'] = 'Nustatykite, valdytojui užfiksuoti';
$PMF_LANG['ad_linkcheck_config_th_chown'] = 'Nustatykite, valdytojui perimti';
