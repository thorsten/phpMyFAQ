...
$PMF_LANG['msgMailCheck'] = 'Det er et nytt innlegg i FAQ! Kontroller administratorsiden!';
...
$PMF_LANG['err_SaveEntries'] = 'Nødvendige felter: <strong>ditt navn</strong>, <strong>din e-postadresse</strong>, <strong>kategori</strong>, <strong>overskrift</strong> og <strong>ditt innlegg</strong>!<br /><br /><a href="nojavascript...history.back();">en side tilbake</a><br /><br />';
$PMF_LANG['err_SaveComment'] = 'Nødvendige felter: <strong>ditt navn</strong>, <strong>din e-postadresse</strong> og <strong>dine kommentarer</strong>!<br /><br /><a href="nojavascript...history.back();">en side tilbake</a><br /><br />';
...
$PMF_LANG['ad_entry_edit_1'] = 'Rediger spørsmål/svar 1';
$PMF_LANG['ad_entry_edit_2'] = 'Rediger spørsmål/svar 2';
...
$PMF_LANG['ad_log_crsa'] = 'Ny registrering gjort.';
...
$PMF_LANG['rightsLanguage']['addglossary'] = 'legg til ordlisteelement';
$PMF_LANG['rightsLanguage']['editglossary'] = 'rediger ordlisteelement';
$PMF_LANG['rightsLanguage']['delglossary'] = 'slett ordlisteelement';
...
$PMF_LANG['ad_linkcheck_feedback_url-linkbad'] = 'Lenker ikke OK';
...
$PMF_LANG['ad_categ_remark_overview'] = 'Den riktige rangen av kategorier som vises vil bli vist om alle kategorier er definert for selve språket (første kolonne).';
...
$PMF_LANG['msgTranslate'] = 'Foreslå en oversettelse for';
$PMF_LANG['msgTranslateSubmit'] = 'Start oversettelse...';
$PMF_LANG['msgNewTranslationThanks'] = 'Takk for oversettelsesforslaget!';
...
$PMF_LANG['msgInstantResponseMaxRecords'] = '. Finn under de første %d understående oppføringene.';
$PMF_LANG['msgAllCatArticles'] = 'poster i denne kategorien';
$PMF_LANG['msgDescriptionInstantResponse'] = 'Bare skriv og finn svarene ...';
...
$PMF_LANG['successMessage'] = 'Din registrering var vellykket. Du vil snart motta en bekreftelsesmail med dine innloggingsdata!';
...
$PMF_LANG['ad_config_stopword_input'] = 'Legg til nytt stoppord';
...
$PMF_LANG['ad_sess_noentry'] = 'Ingen poster';
...
$LANG_CONF['records.maxAttachmentSize'] = array(0 => "input", 1 => "maksimum størrelse for vedlegg i byte (maks. %sByte)");
...
$LANG_CONF['main.urlValidateInterval'] = array(0 => "input", 1 => "Intervall mellom AJAX lenkegodkjenning (i sekunder)");
$LANG_CONF['records.enableVisibilityQuestions'] = array(0 => "checkbox", 1 => "Deaktiver visning av nye spørsmål?");
...
$LANG_CONF['records.defaultActivation'] = array(0 => 'checkbox', 1 => 'Aktiver nye oppføringer (standard: deaktivert)');
...
$LANG_CONF['records.attachmentsPath'] = array(0 => 'input', 1 => 'Stien der vedleggene lagres.<br /><small>Relativ sti der vi mener en mappe i Rot-treet</small>');
$PMF_LANG['msgTransToolNoteFileSaving'] = 'Vær oppmerksom på at ingen filer vil bli skrevet til før du klikker lagre knappen';
$PMF_LANG['msgTransToolPageBufferRecorded'] = 'Sidebuffer %d korrekt registrert';
$PMF_LANG['msgTransToolErrorRecordingPageBuffer'] = 'Sidebuffer %d registrert feil';
...
$PMF_LANG['records.orderingPopularFaqs.visits'] = 'List opp mest besøkte oppføringer';
$PMF_LANG['records.orderingPopularFaqs.voting'] = 'List opp fleste stemte oppføringer';
...
$LANG_CONF['search.useAjaxSearchOnStartpage'] = array(0 => 'checkbox', 1 => 'Umiddelbar respons på startsiden (standard: deaktivert)');
...
$LANG_CONF['main.templateSet'] = array(0 => "select", 1 => "Malen er tatt i bruk");
$LANG_CONF['records.enableAttachmentEncryption'] = array(0 => "checkbox", 1 => "Aktiver vedleggsbeskyttelse <br><small>Ignorert når vedlegg er deaktivert</small>");
$LANG_CONF['records.defaultAttachmentEncKey'] = array(0 => "input", 1 => 'Standard krypteringsnøkkel for vedlegg <br><small>Ignorert om kryptering for vedlegg ikke er aktivert</small><br><small><font color="red">WARNING: Do not change this once set and enabled file encryption!!!</font></small>');
...
$PMF_LANG['socialNetworksControlCenter'] = 'Sosiale nettverk konfigurator';
$LANG_CONF['search.relevance'] = array(0 => 'select', 1 => 'Sorter etter relevans');
$LANG_CONF['search.enableRelevance'] = array(0 => 'checkbox', 1 => 'Aktiver relevanse hjelp? (default: disabled)');
$LANG_CONF['socialnetworks.enableTwitterSupport'] = array(0 => 'checkbox', 1 => 'Twitter støtte (default: deactivated)');
$LANG_CONF['socialnetworks.twitterConsumerKey'] = array(0 => 'input', 1 => 'Twitter forbrukernøkkel');
$LANG_CONF['socialnetworks.twitterConsumerSecret'] = array(0 => 'input', 1 => 'Twitter forbruker hemmelighet');
$LANG_CONF['socialnetworks.twitterAccessTokenKey'] = array(0 => 'input', 1 => 'Twitter tilgangsnøkkel');
$PMF_LANG['ad_menu_attachments'] = 'FAQ Vedlegg';
$PMF_LANG['ad_menu_attachment_admin'] = 'Vedleggsadministrasjon';
...
$PMF_LANG['msgAttachmentsWannaDelete'] = 'Er du sikker på at du vil slette dette vedlegget?';
$PMF_LANG['msgAttachmentsDeleted'] = 'Vedlegg <strong>sukessfullt</strong> slettet.';
...
$PMF_LANG['msgRegistrationCredentials'] = 'For å registrere vær så snill og skriv inn virkelig navn, brukernavn og en gyldig e-post adresse!';
$PMF_LANG['msgRegistrationNote'] = 'Etter vellykket registrering vil du motta et svar etter at administrator har godkjent din registrering.';
$PMF_LANG['ad_entry_changelog_history'] = 'Endringslogg historie';
$LANG_CONF['socialnetworks.twitterAccessTokenSecret'] = array(0 => 'input', 1 => 'Twitter tilgangsnøkkel hemmelighet');
$LANG_CONF['socialnetworks.enableFacebookSupport'] = array(0 => 'checkbox', 1 => 'Facebook støtte (default: deactivated)');
$LANG_CONF['security.ssoSupport'] = array(0 => 'checkbox', 1 => 'Påloggingstøtte (default: deactivated)');
$LANG_CONF['security.ssoLogoutRedirect'] = array(0 => 'input', 1 => 'Pålogging etter utlogging omdirrigering til URL');
$LANG_CONF['main.dateFormat'] = array(0 => 'input', 1 => 'Datoformat (default: Y-m-d H:i)');
$PMF_LANG['securityControlCenter'] = 'Sikkerhetskonfigurasjon';
$PMF_LANG['ad_search_delsuc'] = 'Søketermen er slettet.';
$PMF_LANG['ad_search_delfail'] = 'Søketermen er ikke slettet.';
$PMF_LANG['msg_about_faq'] = 'Om denne FAQ';
$PMF_LANG['msgTableOfContent'] = 'Innholdsfortegnelse';
$PMF_LANG['msgExportAllFaqs'] = 'Skriv ut alle som PDF';
$PMF_LANG['ad_online_verification'] = 'Online verifiseringssjekk';
$PMF_LANG['ad_verification_button'] = 'Trykk for å verifisere din phpMyFAQ installasjon';
$PMF_LANG['ad_verification_notokay'] = 'Din versjon av phpMyFAQ har lokale endringer:';
$PMF_LANG['ad_verification_okay'] = 'Din versjon av phpMyFAQ ble suksessfullt verifisert.';
$PMF_LANG['cacheControlCenter'] = 'Cache konfigurasjon';
$PMF_LANG['ad_menu_searchfaqs'] = 'Søk etter FAQ';
$PMF_LANG['msg2answerFAQ'] = 'Besvart';
$PMF_LANG['headerUserControlPanel'] = 'Kontrollpanel';
$PMF_LANG['rememberMe'] = 'Husk meg';
$PMF_LANG['ad_menu_instances'] = 'FAQ Multisider';
$PMF_LANG['ad_record_inactive'] = 'FAQ er inaktiv';
$PMF_LANG['msgMode'] = 'Modus';
$PMF_LANG['msgMaintenanceMode'] = 'FAQ er satt i vedlikeholds';
$PMF_LANG['msgOnlineMode'] = 'FAQ er online';
$LANG_CONF['security.enableLoginOnly'] = array(0 => 'checkbox', 1 => 'Komplett sikker FAQ (default: deactivated)');
$LANG_CONF['security.useSslOnly'] = array(0 => 'checkbox', 1 => 'FAQ med kun SSL (default: deactivated)');
$LANG_CONF['cache.varnishEnable'] = array(0 => 'checkbox', 1 => 'Aktiver akselerator >=3.0 støtter<br><small>Du vil trenge akselerator PECL extensions</small>');
$LANG_CONF['cache.varnishHost'] = array(0 => 'input', 1 => 'Akselerator host');
$LANG_CONF['cache.varnishPort'] = array(0 => 'input', 1 => 'Akselerator port');
$LANG_CONF['cache.varnishSecret'] = array(0 => 'input', 1 => 'Akselerator secret');
$LANG_CONF['cache.varnishTimeout'] = array(0 => 'input', 1 => 'Akselerator timeout');
$LANG_CONF['records.enableCloseQuestion'] = array(0 => 'checkbox', 1 => 'Lukk åpne spørsmål?');
$LANG_CONF['records.enableDeleteQuestion'] = array(0 => 'checkbox', 1 => 'Slett åpne  spørsmål, eller at svar er gitt?');
$LANG_CONF['records.autosaveActive'] = array(0 => 'checkbox', 1 => 'Aktiver FAQ autolagring');
$LANG_CONF['records.autosaveSecs'] = array(0 => 'input', 1 => 'Interval for autolagring i sekunder, standart 180');
$LANG_CONF['main.maintenanceMode'] = array(0 => 'checkbox', 1 => 'Sett FAQ i vedlikeholdsmodus');
$PMF_LANG['msgShowMore'] = 'vis mer';
$PMF_LANG['msgQuestionAnswered'] = 'Spørsmål besvart';
$PMF_LANG['msgMessageQuestionAnswered'] = 'Ditt spørsmål i %s ble besvart. Du kan se på det her:';
$PMF_LANG['ad_stopwords_desc'] = 'Vær snill og velg et språk for å legge til eller endre stoppord.';
$PMF_LANG['ad_visits_per_day'] = 'Besøk pr dag';
$PMF_LANG['ad_instance_add'] = 'Legg til ny phpMyFAQ multiside forekomst';
$PMF_LANG['ad_instance_error_notwritable'] = 'Katalogen /multisite er ikke skrivbar.';
$PMF_LANG['ad_instance_url'] = 'Forekomst URL';
$PMF_LANG['ad_instance_path'] = 'Forekomst sti';
$PMF_LANG['ad_instance_name'] = 'Forekomst navn';
$PMF_LANG['ad_instance_email'] = 'Din administrator e-post';
$PMF_LANG['ad_instance_admin'] = 'Administrator påloggingsnavn';
$PMF_LANG['ad_instance_password'] = 'Administrator passord';
$PMF_LANG['ad_instance_hint'] = 'Forsiktig: Det vil ta noen sekunder å opprette en ny phpMyFAQ forekomst!';
$PMF_LANG['ad_instance_button'] = 'Lagre forekomst';
$PMF_LANG['ad_instance_error_cannotdelete'] = 'Kunne ikke slette forekomst ';
$PMF_LANG['ad_instance_config'] = 'Forekomstkonfigurator';
$PMF_LANG['msgAboutThisNews'] = 'Om denne nyhet';
$PMF_LANG['msgAccessDenied'] = 'Ingen tilgang.';
$PMF_LANG['msgSeeFAQinFrontend'] = 'Se FAQ';
$LANG_CONF['records.randomSort'] = array(0 => 'checkbox', 1 => 'Sorter FAQ tilfeldig (default: deactivated)');
$LANG_CONF['main.enableWysiwygEditorFrontend'] = array(0 => 'checkbox', 1 => 'Aktiver WYSIWYG editor (default: disabled)');
$LANG_CONF['main.enableGravatarSupport'] = array(0 => 'checkbox', 1 => 'Gravatar Støtte (default: disabled)');