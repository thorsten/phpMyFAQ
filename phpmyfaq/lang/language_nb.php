...
$PMF_LANG['ad_att_close'] = 'Lukk dette vindue';
...
$PMF_LANG['ad_menu_linkconfig'] = 'Lenkekontrollør';
$PMF_LANG['ad_linkcheck_config_title'] = 'Konfigurasjon av Lenkekontrollør';
$PMF_LANG['ad_linkcheck_config_disabled'] = 'Lenkekontrollør er deaktivert';
$PMF_LANG['ad_linkcheck_config_warnlist'] = 'URL\'er å advare';
$PMF_LANG['ad_linkcheck_config_ignorelist'] = 'URL\'er for ignorering';
$PMF_LANG['ad_linkcheck_config_warnlist_description'] = 'Nettadresseprefikser med elementer vist nedenfor vil bli advart uansett om den er gyldig eller ei. <br /> Bruk denne funksjonen til å oppdage snart-å-være avdramatiserte nettadresser';
$PMF_LANG['ad_linkcheck_config_ignorelist_description'] = 'De eksakte webadressene nedenfor vil antas gyldig uten validering. <br /> Bruk denne funksjonen til å utelate nettadresser som ikke klarer validering ved bruk av lenkekontrolløren';
$PMF_LANG['ad_linkcheck_config_th_id'] = 'ID# ';
$PMF_LANG['ad_linkcheck_config_th_url'] = 'URL\'er å matche';
$PMF_LANG['ad_linkcheck_config_th_reason'] = 'Grunn til sjekk';
$PMF_LANG['ad_linkcheck_config_th_owner'] = 'Eier av oppføring';
$PMF_LANG['ad_linkcheck_config_th_enabled'] = 'Aktiver oppføring';
$PMF_LANG['ad_linkcheck_config_th_locked'] = 'Lås eierskap';
$PMF_LANG['ad_linkcheck_config_th_chown'] = 'Krev eierskap';
...
$LANG_CONF['main.permLevel'] = array(0 => "select", 1 => "Tilgangsnivå");
...
$LANG_CONF['main.attachmentsPath'] = array(0 => "input", 1 => "Stien der vedleggene lagres.<br /><small>Relativ sti der vi mener en mappe i Rot-treet</small>");
...
$PMF_LANG['main.orderingPopularFaqs.visits'] = 'List opp mest besøkte oppføringer';
$PMF_LANG['main.orderingPopularFaqs.voting'] = 'List opp fleste stemte oppføringer';
...
$LANG_CONF['main.numberSearchTerms'] = array(0 => 'input', 1 => 'Antall søkeord vist');
$LANG_CONF['main.orderingPopularFaqs'] = array(0 => "select", 1 => "Sortering av topp-faq's");
$LANG_CONF['main.optionalMailAddress'] = array(0 => 'checkbox', 1 => 'e-post adresse som obligatorisk felt (standard: deaktivert)');
$LANG_CONF['main.useAjaxSearchOnStartpage'] = array(0 => 'checkbox', 1 => 'Umiddelbar respons på startsiden (standard: deaktivert)');
...
$LANG_CONF['main.enableAttachmentEncryption'] = array(0 => "checkbox", 1 => "Aktiver vedleggsbeskyttelse <br><small>Ignorert når vedlegg er deaktivert</small>");
$LANG_CONF['main.defaultAttachmentEncKey'] = array(0 => "input", 1 => 'Standard krypteringsnøkkel for vedlegg <br><small>Ignorert om kryptering for vedlegg ikke er aktivert</small><br><small><font color="red">WARNING: Do not change this once set and enabled file encryption!!!</font></small>');
$LANG_CONF['main.useSslForLogins'] = array(0 => 'checkbox', 1 => "Bare tillat pålogginger over sikker tilkobling? (Standard: deaktivert)");
