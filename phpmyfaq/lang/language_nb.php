...
// Help
$PMF_LANG["msgHelpText"] = "<p>Strukturen i denne OSS (<strong>O</strong>fte <strong>S</strong>tilte <strong>S</strong>pøsrmål) / FAQ (<strong>F</strong>requently <strong>A</strong>sked <strong>Q</strong>uestions) er virkelig enkel. Du kan enten søke i <strong><a href=\"".$_SERVER["PHP_SELF"]."?sid=".isset($_GET["sid"])."&amp;action=show\">kategoriene</a></strong> eller etter <strong><a href=\"".$_SERVER["PHP_SELF"]."?sid=".isset($_GET["sid"])."&amp;action=search\">nøkkelord</a></strong>.</p>";
...
$PMF_LANG["msgMailCheck"] = "Det er et nytt innlegg i OSS!\nKontroller administratorsiden!";
...
$LANG_CONF["language"] = array(0 => "select", 1 => "Språkfil");
$LANG_CONF["detection"] = array(0 => "checkbox", 1 => "Aktiver automatisk forhandling av tegnsett");
$LANG_CONF["title"] = array(0 => "input", 1 => "Tittel for OSS/FAQ");
$LANG_CONF["version"] = array(0 => "print", 1 => "FAQ versjon");
$LANG_CONF["metaDescription"] = array(0 => "input", 1 => "Beskrivelse av siden");
$LANG_CONF["metaKeywords"] = array(0 => "input", 1 => "Nøkkel for søkemaskiner");
$LANG_CONF["metaPublisher"] = array(0 => "input", 1 => "Utgiversnavn");
$LANG_CONF["adminmail"] = array(0 => "input", 1 => "Administrators e-postadresse");
