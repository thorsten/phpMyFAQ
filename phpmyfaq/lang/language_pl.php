...
$LANG_CONF['main.enableAttachmentEncryption'] = array(0 => "checkbox", 1 => "Włącz szyfrowanie <br><small>Ignorowane jest wyłączone</small>");
$LANG_CONF['main.defaultAttachmentEncKey'] = array(0 => "input", 1 => 'Domyślny klucz szyfrowania załączników<br><small>Ignored if attachment encryption is disabled</small><br><small><font color="red"> OSTRZEŻENIE: Nie należy zmieniać to raz ustawić na włączone szyfrowanie plików!</font></small>');
$LANG_CONF['main.useSslForLogins'] = array(0 => 'checkbox', 1 => "Pozwalaj tylko na bezpieczne połączenie logowania? (Domyślnie: wyłączone)");
...
$PMF_LANG['main.orderingPopularFaqs.visits'] = 'lista najczęściej odwiedzanych wpisów';
$PMF_LANG['main.orderingPopularFaqs.voting'] = 'lista najczęściej ocenianych zapisów';
...
$LANG_CONF['main.orderingPopularFaqs'] = array(0 => "select", 1 => "Sortowanie FAQ wg najlepszych");
