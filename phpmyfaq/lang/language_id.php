...
$PMF_LANG['ad_menu_linkconfig'] = 'Verifikasi URL';
$PMF_LANG['ad_linkcheck_config_title'] = 'Konfigurasi Verifikasi URL';
$PMF_LANG['ad_linkcheck_config_disabled'] = 'Fitur Verifikasi URL tidak diaktifkan';
$PMF_LANG['ad_linkcheck_config_warnlist'] = 'URL yang diperingatkan';
$PMF_LANG['ad_linkcheck_config_ignorelist'] = 'URL yang diabaikan';
$PMF_LANG['ad_linkcheck_config_warnlist_description'] = 'Awalan URL dengan item berikut akan menampilkan peringatan validitasnya.<br />Gunakan fitur ini untuk mendeteksi URL yang cepat kadaluarsa';
$PMF_LANG['ad_linkcheck_config_ignorelist_description'] = 'URL yang tertulis di bawah ini diasumsikan valid tanpa validasi.<br />Gunakan fitur ini untuk meluluskan URL pada verifikasi meskipun gagal diverifikasi';
$PMF_LANG['ad_linkcheck_config_th_id'] = 'ID#';
$PMF_LANG['ad_linkcheck_config_th_url'] = 'URL yang cocok';
$PMF_LANG['ad_linkcheck_config_th_reason'] = 'Alasan kecocokan';
$PMF_LANG['ad_linkcheck_config_th_owner'] = 'Pemilik entri';
$PMF_LANG['ad_linkcheck_config_th_enabled'] = 'Jadikan entri aktif';
$PMF_LANG['ad_linkcheck_config_th_locked'] = 'Kunci pemelikikan';
$PMF_LANG['ad_linkcheck_config_th_chown'] = 'Ambil kepemilikan';
