...
class DefaultDataSeeder
{
    ...
    private static function buildDefaultConfig(): array
    {
        $config = [
            ...
            'storage.redisDsn' => 'tcp://redis:6379?database=1',
            'storage.redisPrefix' => 'pmf:config:',
            'storage.redisConnectTimeout' => '1.0',
            'storage.cacheAdapter' => 'filesystem',
            'storage.cacheRedisDsn' => 'tcp://redis:6379?database=2',
            'storage.cacheRedisPrefix' => 'pmf:cache:',
            'storage.cacheRedisConnectTimeout' => '1.0',
            'storage.cacheDefaultTtl' => '3600',
