...
class MetaData
{
    ...
    public function save(): void
    {
        ...
        $faqPermission->add(FaqPermission::USER, $faqId, $userPermissions);
        ...
        if ($this->configuration->get(item: 'security.permLevel') !== 'basic') {
            ...
            $faqPermission->add(FaqPermission::GROUP, $faqId, $groupPermissions);
