...
/**
 * The phpMyFAQ instances a database class with CREATE TABLE statements for MS SQL Server.
 *
...
class PdoSqlsrv extends Database implements DriverInterface
{
    ...
    private array $createTableStatements = [
        ...
        'faqconfig' => 'CREATE TABLE %sfaqconfig (
            ...
            config_value NVARCHAR(MAX) DEFAULT NULL,
        ...
        'faqcustompages' => 'CREATE TABLE %sfaqcustompages (
            ...
            seo_robots NVARCHAR(50) NOT NULL DEFAULT \'index,follow\',
            PRIMARY KEY (id, lang))',
        ...
        'faquser' => 'CREATE TABLE %sfaquser (
            ...
            refresh_token NVARCHAR(MAX) NULL DEFAULT NULL,
            access_token NVARCHAR(MAX) NULL DEFAULT NULL,
            code_verifier NVARCHAR(255) NULL DEFAULT NULL,
            jwt NVARCHAR(MAX) NULL DEFAULT NULL,
            webauthnkeys NVARCHAR(MAX) NULL DEFAULT NULL,
            PRIMARY KEY (user_id))',
