...
class Pgsql extends Database implements Driver
{
    private array $createTableStatements = [
        ...
        'faqsearches_date_term_idx' => 'CREATE INDEX idx_faqsearches_date_term_%s ON %sfaqsearches ' .
            '(searchdate, searchterm)',

        'faqsearches_date_term_lang_idx' => 'CREATE INDEX idx_faqsearches_date_term_lang_%s ON %sfaqsearches ' .
