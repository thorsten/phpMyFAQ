...
final class UserController extends AbstractAdministrationApiController
{
     ...
     * @throws Exception
     */
    #[Route(path: 'user/users', name: 'admin.api.user.users', methods: ['GET'])]
     ...
     * @throws Exception
     */
    #[Route(path: 'user/users.csv', name: 'admin.api.user.users.csv', methods: ['GET'])]
     ...
     */
    #[Route(path: 'user/data/{userId}', name: 'admin.api.user.data', methods: ['GET'])]
     ...
     * @throws Exception
     */
    #[Route(path: 'user/permissions/{userId}', name: 'admin.api.user.permissions', methods: ['GET'])]
     ...
     * @throws \Exception
     */
    #[Route(path: 'user/activate', name: 'admin.api.user.activate', methods: ['PUT'])]
     ...
     * @throws \Exception
     */
    #[Route(path: 'user/add', name: 'admin.api.user.add', methods: ['POST'])]
     ...
     */
    #[Route(path: 'user/edit', name: 'admin.api.user.edit', methods: ['PUT'])]
     ...
     * @throws \Exception
     */
    #[Route(path: 'user/update-rights', name: 'admin.api.user.update-rights', methods: ['PUT'])]
