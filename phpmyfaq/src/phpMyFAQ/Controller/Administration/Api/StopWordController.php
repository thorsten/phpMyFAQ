...
{
    #[Route(path: 'stopwords', name: 'admin.api.stopwords', methods: ['GET'])]
    ...
    #[Route(path: 'stopword/delete', name: 'admin.api.stopword.delete', methods: ['DELETE'])]
     ...
     * @throws \Exception
     */
    #[Route(path: 'stopword/save', name: 'admin.api.stopword.save', methods: ['POST'])]
