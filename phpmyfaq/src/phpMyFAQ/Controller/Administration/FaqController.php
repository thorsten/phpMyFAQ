...
final class FaqController extends AbstractAdministrationController
{
    ...
    public function edit(Request $request): Response
    {
        ...
        return $this->render('@admin/content/faq.editor.twig', [
            ...
            ...$this->getBaseTemplateVars(),
            'header' =>
                Translation::get(languageKey: 'ad_entry_edit_1')
                . ' '
                . Translation::get(languageKey: 'ad_entry_edit_2'),
            'editExistingFaq' => true,
            'currentRevision' => sprintf('%s 1.%d', Translation::get(languageKey: 'msgRevision'), $selectedRevisionId),
    ...
    private function getBaseTemplateVars(): array
    {
        ...
        return [
            ...
            'ad_entry_changelog' => Translation::get(languageKey: 'ad_entry_changelog'),
            'ad_entry_changed' => Translation::get(languageKey: 'ad_entry_changed'),
            'ad_admin_notes_hint' => Translation::get(languageKey: 'ad_admin_notes_hint'),
            'ad_admin_notes' => Translation::get(languageKey: 'ad_admin_notes'),
            'ad_entry_changelog_history' => Translation::get(languageKey: 'ad_entry_changelog_history'),
            'ad_gen_reset' => Translation::get(languageKey: 'ad_gen_reset'),
            'ad_entry_save' => Translation::get(languageKey: 'ad_entry_save'),
            'ad_entry_status' => Translation::get(languageKey: 'ad_entry_status'),
            'ad_entry_visibility' => Translation::get(languageKey: 'ad_entry_visibility'),
            'ad_entry_not_visibility' => Translation::get(languageKey: 'ad_entry_not_visibility'),
            'ad_entry_new_revision' => Translation::get(languageKey: 'ad_entry_new_revision'),
            'ad_gen_yes' => Translation::get(languageKey: 'ad_gen_yes'),
            'ad_gen_no' => Translation::get(languageKey: 'ad_gen_no'),
            'ad_entry_allowComments' => Translation::get(languageKey: 'ad_entry_allowComments'),
            'ad_entry_solution_id' => Translation::get(languageKey: 'ad_entry_solution_id'),
            'ad_att_addto' => Translation::get(languageKey: 'ad_att_addto'),
            'ad_att_addto_2' => Translation::get(languageKey: 'ad_att_addto_2'),
            'ad_att_att' => Translation::get(languageKey: 'ad_att_att'),
            'ad_att_butt' => Translation::get(languageKey: 'ad_att_butt'),
            'ad_changerev' => Translation::get(languageKey: 'ad_changerev'),
            'ad_view_faq' => Translation::get(languageKey: 'ad_view_faq'),
        ];
    }
}
