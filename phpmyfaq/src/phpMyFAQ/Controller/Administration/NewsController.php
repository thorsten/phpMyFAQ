...
final class NewsController extends AbstractAdministrationController
{
    ...
    private function getBaseTemplateVars(): array
    {
        ...
        return [
            ...
            'ad_news_link_title' => Translation::get(key: 'ad_news_link_title'),
            'ad_news_link_target' => Translation::get(key: 'ad_news_link_target'),
            'ad_news_link_window' => Translation::get(key: 'ad_news_link_window'),
            'ad_news_link_faq' => Translation::get(key: 'ad_news_link_faq'),
            'ad_news_link_parent' => Translation::get(key: 'ad_news_link_parent'),
            'selectLanguage' => LanguageHelper::renderSelectLanguage($language, false, [], 'langTo'),
            'ad_news_expiration_window' => Translation::get(key: 'ad_news_expiration_window'),
            'ad_news_from' => Translation::get(key: 'ad_news_from'),
            'ad_news_to' => Translation::get(key: 'ad_news_to'),
            'ad_entry_back' => Translation::get(key: 'ad_entry_back'),
            'ad_menu_news_add' => Translation::get(key: 'ad_menu_news_add'),
            'ad_news_headline' => Translation::get(key: 'ad_news_headline'),
            'ad_news_date' => Translation::get(key: 'ad_news_date'),
            'ad_news_update' => Translation::get(key: 'ad_news_update'),
            'ad_news_delete' => Translation::get(key: 'ad_news_delete'),
            'ad_news_nodata' => Translation::get(key: 'ad_news_nodata'),
            'ad_news_edit' => Translation::get(key: 'ad_news_edit'),
            'ad_news_header' => Translation::get(key: 'ad_news_header'),
            'ad_news_text' => Translation::get(key: 'ad_news_text'),
            'ad_news_allowComments' => Translation::get(key: 'ad_news_allowComments'),
            'msgLanguage' => Translation::get(key: 'msgLanguage'),
            'ad_entry_comment' => Translation::get(key: 'ad_entry_comment'),
            'ad_entry_commentby' => Translation::get(key: 'ad_entry_commentby'),
            'newsCommentDate' => Translation::get(key: 'newsCommentDate'),
            'ad_news_insertfail' => Translation::get(key: 'ad_news_insertfail'),
            'msgNews' => Translation::get(key: 'msgNews'),
            'ad_news_data' => Translation::get(key: 'ad_news_data'),
            'ad_news_del' => Translation::get(key: 'ad_news_del'),
            'ad_news_nodelete' => Translation::get(key: 'ad_news_nodelete'),
            'ad_news_yesdelete' => Translation::get(key: 'ad_news_yesdelete'),
