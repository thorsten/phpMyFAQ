...
final class NewsController extends AbstractAdministrationController
{
    ...
    private function getBaseTemplateVars(): array
    {
        ...
        return [
            ...
            'ad_news_set_active' => Translation::get(languageKey: 'ad_news_set_active'),
            'ad_news_link_url' => Translation::get(languageKey: 'ad_news_link_url'),
            'ad_news_link_title' => Translation::get(languageKey: 'ad_news_link_title'),
            'ad_news_link_target' => Translation::get(languageKey: 'ad_news_link_target'),
            'ad_news_link_window' => Translation::get(languageKey: 'ad_news_link_window'),
            'ad_news_link_faq' => Translation::get(languageKey: 'ad_news_link_faq'),
            'ad_news_link_parent' => Translation::get(languageKey: 'ad_news_link_parent'),
            'selectLanguage' => LanguageHelper::renderSelectLanguage($language, false, [], 'langTo'),
            'ad_news_expiration_window' => Translation::get(languageKey: 'ad_news_expiration_window'),
            'ad_news_from' => Translation::get(languageKey: 'ad_news_from'),
            'ad_news_to' => Translation::get(languageKey: 'ad_news_to'),
            'ad_entry_back' => Translation::get(languageKey: 'ad_entry_back'),
            'ad_menu_news_add' => Translation::get(languageKey: 'ad_menu_news_add'),
            'ad_news_headline' => Translation::get(languageKey: 'ad_news_headline'),
            'ad_news_date' => Translation::get(languageKey: 'ad_news_date'),
            'ad_news_update' => Translation::get(languageKey: 'ad_news_update'),
            'ad_news_delete' => Translation::get(languageKey: 'ad_news_delete'),
            'ad_news_nodata' => Translation::get(languageKey: 'ad_news_nodata'),
            'ad_news_edit' => Translation::get(languageKey: 'ad_news_edit'),
            'ad_news_header' => Translation::get(languageKey: 'ad_news_header'),
            'ad_news_text' => Translation::get(languageKey: 'ad_news_text'),
            'ad_news_allowComments' => Translation::get(languageKey: 'ad_news_allowComments'),
            'msgLanguage' => Translation::get(languageKey: 'msgLanguage'),
            'ad_entry_comment' => Translation::get(languageKey: 'ad_entry_comment'),
            'ad_entry_commentby' => Translation::get(languageKey: 'ad_entry_commentby'),
            'newsCommentDate' => Translation::get(languageKey: 'newsCommentDate'),
            'ad_news_insertfail' => Translation::get(languageKey: 'ad_news_insertfail'),
            'msgNews' => Translation::get(languageKey: 'msgNews'),
            'ad_news_data' => Translation::get(languageKey: 'ad_news_data'),
            'ad_news_del' => Translation::get(languageKey: 'ad_news_del'),
            'ad_news_nodelete' => Translation::get(languageKey: 'ad_news_nodelete'),
            'ad_news_yesdelete' => Translation::get(languageKey: 'ad_news_yesdelete'),
            'ad_news_delsuc' => Translation::get(languageKey: 'ad_news_delsuc'),
            'ad_news_updatesuc' => Translation::get(languageKey: 'ad_news_updatesuc'),
            'msgDeleteNews' => Translation::get(languageKey: 'msgDeleteNews'),
