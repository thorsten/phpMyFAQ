...
$query[] = "INSERT INTO ".$sqltblpre."faqconfig VALUES ('main.titleFAQ', 'phpMyFAQ Codename Poseidon')";
...
$query[] = "INSERT INTO ".$sqltblpre."faqconfig VALUES ('main.useAjaxMenu', 'false')";
