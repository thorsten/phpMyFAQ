...
SBOM_PHP_FILE="${RELEASE_DIR}/phpMyFAQ-${VERSION}.php.sbom.cdx.json"
SBOM_JS_FILE="${RELEASE_DIR}/phpMyFAQ-${VERSION}.js.sbom.cdx.json"
SBOM_COMBINED_FILE="${RELEASE_DIR}/phpMyFAQ-${VERSION}.sbom.cdx.json"
