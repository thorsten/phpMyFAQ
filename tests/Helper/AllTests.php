<?php
/**
 * Test suite for helper related classes
 *
 * PHP Version 5.4
 *
...
require_once 'PMF_Helper_AdministrationTest.php';
 ...
 * @since     2013-12-30
 */
class Helper_AllTests
{
    public static function suite()
    {
        $suite = new PHPUnit_Framework_TestSuite('phpMyFAQ Helper');
