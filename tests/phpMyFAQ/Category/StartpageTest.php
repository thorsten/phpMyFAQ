...
class StartpageTest extends TestCase
{
    ...
    {
        $result = $this->startpage->setUser(10)->setGroups([1, 2])->setLanguage('de');
    ...
    public function testGetCategoriesEmpty(): void
    {
        ...
        $this->databaseMock->expects($this->once())->method('fetchArray')->with('query_result')->willReturn(false);
    ...
    public function testGetCategoriesWithValidLanguage(): void
    {
        ...
        $this->databaseMock->expects($this->once())->method('fetchArray')->willReturn(false);
    ...
    public function testGetCategoriesWithEmptyImage(): void
    {
        ...
        $this->configurationMock->expects($this->once())->method('getDefaultUrl')->willReturn('https://test.com/');

        $this->databaseMock->expects($this->once())->method('escape')->with('fr')->willReturn('fr');
    ...
    public function testGetCategoriesMultipleCategories(): void
    {
        ...
        $this->configurationMock->expects($this->any())->method('getDefaultUrl')->willReturn('https://demo.com/');

        $this->databaseMock->expects($this->once())->method('escape')->willReturn('es');
    ...
    public function testGetCategoriesLanguageEdgeCases(): void
    {
        ...
        $this->databaseMock->expects($this->once())->method('escape')->with('zh-cn')->willReturn('zh-cn');
    ...
    public function testGetCategoriesQueryStructure(): void
    {
        ...
        $this->databaseMock->expects($this->once())->method('escape')->willReturn('en');
