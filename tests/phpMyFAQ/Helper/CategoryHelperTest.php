...
class CategoryHelperTest extends TestCase
{
    ...
    public function testRenderCategoryTreeWithCategories(): void
    {
        ...
        $db->query(
            "INSERT INTO faqdata (id, lang, solution_id, revision_id, active, status, sticky, keywords, thema, content, author, email, comment, updated, date_start, date_end, notes, sticky_order)
             VALUES (9001, 'en', 99001, 0, 'yes', 'published', 0, '', 'Rendered FAQ', 'Content', 'Author', 'author@example.com', 'y', '20260101000000', '00000000000000', '99991231235959', '', NULL)",
        );
