...
final class ImportControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $databasePath = tempnam(sys_get_temp_dir(), 'pmf-admin-import-controller-');
     ...
     * @throws \Exception
     */
    public function testIndexRendersCsvImportFormAndColumnHints(): void
    {
        $controller = new ImportController();
        $controller->setContainer($this->createControllerContainer());

        $request = Request::create('https://localhost/admin/import');
        $request->attributes->set('_route', 'admin.import');
        $response = $controller->index($request);

        self::assertSame(Response::HTTP_OK, $response->getStatusCode());
        self::assertStringContainsString('id="uploadCSVFileForm"', (string) $response->getContent());
        self::assertStringContainsString('id="fileInputCSVUpload"', (string) $response->getContent());
        self::assertStringContainsString('Sticky', (string) $response->getContent());
    }
