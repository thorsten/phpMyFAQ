...
final class PluginControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $databasePath = tempnam(sys_get_temp_dir(), 'pmf-admin-plugin-controller-');
     ...
     * @throws \Exception
     */
    public function testIndexRendersPluginLists(): void
    {
        ...
        $request = Request::create('https://localhost/admin/plugins');
        $request->attributes->set('_route', 'admin.configuration.plugins');
        $response = $controller->index($request);

        self::assertSame(Response::HTTP_OK, $response->getStatusCode());
        self::assertStringContainsString('Example Plugin', (string) $response->getContent());
        self::assertStringContainsString('Broken Plugin', (string) $response->getContent());
        self::assertStringContainsString('Requires older API', (string) $response->getContent());
    }
