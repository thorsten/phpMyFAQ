...
final class ConfigurationControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $databasePath = tempnam(sys_get_temp_dir(), 'pmf-admin-configuration-controller-');
     ...
     * @throws \Exception
     */
    public function testIndexRendersConfigurationShell(): void
    {
        $controller = new ConfigurationController();
        $controller->setContainer($this->createControllerContainer());

        $request = Request::create('https://localhost/admin/configuration');
        $request->attributes->set('_route', 'admin.configuration');
        $response = $controller->index($request);

        self::assertSame(Response::HTTP_OK, $response->getStatusCode());
        self::assertStringContainsString('id="configuration-list"', (string) $response->getContent());
        self::assertStringContainsString('id="save-configuration"', (string) $response->getContent());
        self::assertStringContainsString('id="pmf-admin-configuration-container"', (string) $response->getContent());
    }
