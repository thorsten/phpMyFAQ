...
final class ReportControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $databasePath = tempnam(sys_get_temp_dir(), 'pmf-admin-report-controller-');
     ...
     * @throws \Exception
     */
    public function testIndexRendersReportForm(): void
    {
        $controller = new ReportController();
        $controller->setContainer($this->createControllerContainer());

        $request = Request::create('https://localhost/admin/statistics/report');
        $request->attributes->set('_route', 'admin.statistics.report');
        $response = $controller->index($request);

        self::assertSame(Response::HTTP_OK, $response->getStatusCode());
        self::assertStringContainsString('id="pmf-admin-report-form"', (string) $response->getContent());
        self::assertStringContainsString('id="pmf-admin-create-report"', (string) $response->getContent());
        self::assertStringContainsString('id="category"', (string) $response->getContent());
    }
