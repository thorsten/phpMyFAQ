...
final class OrphanedFaqsControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $databasePath = tempnam(sys_get_temp_dir(), 'pmf-admin-orphaned-faqs-controller-');
    ...
    public function testIndexRendersOrphanedFaqsTable(): void
    {
        ...
        $response = $controller->index(Request::create('https://localhost/admin/orphaned-faqs'));
