...
phpMyFAQ is published under the [Mozilla Public License Version 2.0](https://www.mozilla.org/MPL/2.0/) (MPL).
...
This documentation is licensed under a [Creative Commons License](https://creativecommons.org/licenses/by/2.0/).
