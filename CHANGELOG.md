...
- added official Docker images (Apache and FrankenPHP) published to Docker Hub and GitHub Container Registry, nightly images on GHCR, with headless installation via environment variables (Thorsten)
